   ...
   >
    ${(null===(e=this._config)||void 0===e?void 0:e.disable_menu)?"":B`
      ...
      <div id="presets" class="${null!==this.safety_state||this.displayMessages?"security_msg":""}">
        ...
        `}
        ${(null===(f=this._config)||void 0===f?void 0:f.disable_timed_preset)?"":B`
          <div class="timed-preset-container">
            ${this.timedPresetActive?B`
              ...
              ${(null!==(g=this.timedPresetRemainingTime)&&void 0!==g?g:0)<60?B`
    ...
    <div id="right-lock">
      ${(null===(w=this._config)||void 0===w?void 0:w.allow_lock_toggle)?B`
              <ha-icon-button
