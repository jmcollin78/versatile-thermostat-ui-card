 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;function me(e,t){return(i,o,a)=>{const s=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:n}="object"==typeof o?i:a??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return pe(i,o,{get(){if(t){let t=e.call(this);return void 0===t&&(t=s(this),n.call(this,t)),t}return s(this)}})}return pe(i,o,{get(){return s(this)}})}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;const _o=([[e,t],[i,o]],[a,s])=>[e*a+t*s,i*a+o*s],po=([e,t],[i,o])=>[e+i,t+o],mo=e=>e/180*Math.PI,vo=e=>{const{x:t,y:i,r:o,start:a,end:s,rotate:n=0}=e,r=t,l=i,c=o,d=o,u=mo(a),h=(mo(s)-u)%(2*Math.PI),_=mo(n),p=(e=>[[Math.cos(e),-Math.sin(e)],[Math.sin(e),Math.cos(e)]])(_),[m,v]=po(_o(p,[c*Math.cos(u),d*Math.sin(u)]),[r,l]),[f,g]=po(_o(p,[c*Math.cos(u+h),d*Math.sin(u+h)]),[r,l]),b=h>Math.PI?1:0,y=h>0?1:0;return["M",m,v,"A",c,d,_/(2*Math.PI)*360,b,y,f,g].join(" ")};function fo(){return fo=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var o in i)Object.prototype.hasOwnProperty.call(i,o)&&(e[o]=i[o])}return e},fo.apply(this,arguments)}function go(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}function bo(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}var yo,wo="function"!=typeof Object.assign?function(e){if(null==e)throw new TypeError("Cannot convert undefined or null to object");for(var t=Object(e),i=1;i<arguments.length;i++){var o=arguments[i];if(null!=o)for(var a in o)o.hasOwnProperty(a)&&(t[a]=o[a])}return t}:Object.assign,ko=["","webkit","Moz","MS","ms","o"],$o="undefined"==typeof document?{style:{}}:document.createElement("div"),Ao=Math.round,Co=Math.abs,xo=Date.now;function So(e,t){for(var i,o,a=t[0].toUpperCase()+t.slice(1),s=0;s<ko.length;){if((o=(i=ko[s])?i+a:t)in e)return o;s++}}yo="undefined"==typeof window?{}:window;var Lo=So($o.style,"touchAction"),To=void 0!==Lo;var Mo="compute",Eo="auto",Vo="manipulation",zo="none",Po="pan-x",Ho="pan-y",Do=function(){if(!To)return!1;var e={},t=yo.CSS&&yo.CSS.supports;return["auto","manipulation","pan-y","pan-x","pan-x pan-y","none"].forEach((function(i){return e[i]=!t||yo.CSS.supports("touch-action",i)})),e}(),Oo="ontouchstart"in yo,No=void 0!==So(yo,"PointerEvent"),Ro=Oo&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),jo="touch",Io="mouse",Bo=25,Uo=1,Wo=4,Fo=8,Zo=1,qo=2,Ko=4,Yo=8,Xo=16,Go=qo|Ko,Jo=Yo|Xo,Qo=Go|Jo,ea=["x","y"],ta=["clientX","clientY"];function ia(e,t,i){var o;if(e)if(e.forEach)e.forEach(t,i);else if(void 0!==e.length)for(o=0;o<e.length;)t.call(i,e[o],o,e),o++;else for(o in e)e.hasOwnProperty(o)&&t.call(i,e[o],o,e)}function oa(e,t){return"function"==typeof e?e.apply(t&&t[0]||void 0,t):e}function aa(e,t){return e.indexOf(t)>-1}var sa=function(){function e(e,t){this.manager=e,this.set(t)}var t=e.prototype;return t.set=function(e){e===Mo&&(e=this.compute()),To&&this.manager.element.style&&Do[e]&&(this.manager.element.style[Lo]=e),this.actions=e.toLowerCase().trim()},t.update=function(){this.set(this.manager.options.touchAction)},t.compute=function(){var e=[];return ia(this.manager.recognizers,(function(t){oa(t.options.enable,[t])&&(e=e.concat(t.getTouchAction()))})),function(e){if(aa(e,zo))return zo;var t=aa(e,Po),i=aa(e,Ho);return t&&i?zo:t||i?t?Po:Ho:aa(e,Vo)?Vo:Eo}(e.join(" "))},t.preventDefaults=function(e){var t=e.srcEvent,i=e.offsetDirection;if(this.manager.session.prevented)t.preventDefault();else{var o=this.actions,a=aa(o,zo)&&!Do[zo],s=aa(o,Ho)&&!Do[Ho],n=aa(o,Po)&&!Do[Po];if(a){var r=1===e.pointers.length,l=e.distance<2,c=e.deltaTime<250;if(r&&l&&c)return}if(!n||!s)return a||s&&i&Go||n&&i&Jo?this.preventSrc(t):void 0}},t.preventSrc=function(e){this.manager.session.prevented=!0,e.preventDefault()},e}();function na(e,t){for(;e;){if(e===t)return!0;e=e.parentNode}return!1}function ra(e){var t=e.length;if(1===t)return{x:Ao(e[0].clientX),y:Ao(e[0].clientY)};for(var i=0,o=0,a=0;a<t;)i+=e[a].clientX,o+=e[a].clientY,a++;return{x:Ao(i/t),y:Ao(o/t)}}function la(e){for(var t=[],i=0;i<e.pointers.length;)t[i]={clientX:Ao(e.pointers[i].clientX),clientY:Ao(e.pointers[i].clientY)},i++;return{timeStamp:xo(),pointers:t,center:ra(t),deltaX:e.deltaX,deltaY:e.deltaY}}function ca(e,t,i){i||(i=ea);var o=t[i[0]]-e[i[0]],a=t[i[1]]-e[i[1]];return Math.sqrt(o*o+a*a)}function da(e,t,i){i||(i=ea);var o=t[i[0]]-e[i[0]],a=t[i[1]]-e[i[1]];return 180*Math.atan2(a,o)/Math.PI}function ua(e,t){return e===t?Zo:Co(e)>=Co(t)?e<0?qo:Ko:t<0?Yo:Xo}function ha(e,t,i){return{x:t/e||0,y:i/e||0}}function _a(e,t){var i=e.session,o=t.pointers,a=o.length;i.firstInput||(i.firstInput=la(t)),a>1&&!i.firstMultiple?i.firstMultiple=la(t):1===a&&(i.firstMultiple=!1);var s=i.firstInput,n=i.firstMultiple,r=n?n.center:s.center,l=t.center=ra(o);t.timeStamp=xo(),t.deltaTime=t.timeStamp-s.timeStamp,t.angle=da(r,l),t.distance=ca(r,l),function(e,t){var i=t.center,o=e.offsetDelta||{},a=e.prevDelta||{},s=e.prevInput||{};t.eventType!==Uo&&s.eventType!==Wo||(a=e.prevDelta={x:s.deltaX||0,y:s.deltaY||0},o=e.offsetDelta={x:i.x,y:i.y}),t.deltaX=a.x+(i.x-o.x),t.deltaY=a.y+(i.y-o.y)}(i,t),t.offsetDirection=ua(t.deltaX,t.deltaY);var c,d,u=ha(t.deltaTime,t.deltaX,t.deltaY);t.overallVelocityX=u.x,t.overallVelocityY=u.y,t.overallVelocity=Co(u.x)>Co(u.y)?u.x:u.y,t.scale=n?(c=n.pointers,ca((d=o)[0],d[1],ta)/ca(c[0],c[1],ta)):1,t.rotation=n?function(e,t){return da(t[1],t[0],ta)+da(e[1],e[0],ta)}(n.pointers,o):0,t.maxPointers=i.prevInput?t.pointers.length>i.prevInput.maxPointers?t.pointers.length:i.prevInput.maxPointers:t.pointers.length,function(e,t){var i,o,a,s,n=e.lastInterval||t,r=t.timeStamp-n.timeStamp;if(t.eventType!==Fo&&(r>Bo||void 0===n.velocity)){var l=t.deltaX-n.deltaX,c=t.deltaY-n.deltaY,d=ha(r,l,c);o=d.x,a=d.y,i=Co(d.x)>Co(d.y)?d.x:d.y,s=ua(l,c),e.lastInterval=t}else i=n.velocity,o=n.velocityX,a=n.velocityY,s=n.direction;t.velocity=i,t.velocityX=o,t.velocityY=a,t.direction=s}(i,t);var h,_=e.element,p=t.srcEvent;na(h=p.composedPath?p.composedPath()[0]:p.path?p.path[0]:p.target,_)&&(_=h),t.target=_}function pa(e,t,i){var o=i.pointers.length,a=i.changedPointers.length,s=t&Uo&&o-a==0,n=t&(Wo|Fo)&&o-a==0;i.isFirst=!!s,i.isFinal=!!n,s&&(e.session={}),i.eventType=t,_a(e,i),e.emit("hammer.input",i),e.recognize(i),e.session.prevInput=i}function ma(e){return e.trim().split(/\s+/g)}function va(e,t,i){ia(ma(t),(function(t){e.addEventListener(t,i,!1)}))}function fa(e,t,i){ia(ma(t),(function(t){e.removeEventListener(t,i,!1)}))}function ga(e){var t=e.ownerDocument||e;return t.defaultView||t.parentWindow||window}var ba=function(){function e(e,t){var i=this;this.manager=e,this.callback=t,this.element=e.element,this.target=e.options.inputTarget,this.domHandler=function(t){oa(e.options.enable,[e])&&i.handler(t)},this.init()}var t=e.prototype;return t.handler=function(){},t.init=function(){this.evEl&&va(this.element,this.evEl,this.domHandler),this.evTarget&&va(this.target,this.evTarget,this.domHandler),this.evWin&&va(ga(this.element),this.evWin,this.domHandler)},t.destroy=function(){this.evEl&&fa(this.element,this.evEl,this.domHandler),this.evTarget&&fa(this.target,this.evTarget,this.domHandler),this.evWin&&fa(ga(this.element),this.evWin,this.domHandler)},e}();function ya(e,t,i){if(e.indexOf&&!i)return e.indexOf(t);for(var o=0;o<e.length;){if(i&&e[o][i]==t||!i&&e[o]===t)return o;o++}return-1}var wa={pointerdown:Uo,pointermove:2,pointerup:Wo,pointercancel:Fo,pointerout:Fo},ka={2:jo,3:"pen",4:Io,5:"kinect"},$a="pointerdown",Aa="pointermove pointerup pointercancel";yo.MSPointerEvent&&!yo.PointerEvent&&($a="MSPointerDown",Aa="MSPointerMove MSPointerUp MSPointerCancel");var Ca=function(e){function t(){var i,o=t.prototype;return o.evEl=$a,o.evWin=Aa,(i=e.apply(this,arguments)||this).store=i.manager.session.pointerEvents=[],i}return go(t,e),t.prototype.handler=function(e){var t=this.store,i=!1,o=e.type.toLowerCase().replace("ms",""),a=wa[o],s=ka[e.pointerType]||e.pointerType,n=s===jo,r=ya(t,e.pointerId,"pointerId");a&Uo&&(0===e.button||n)?r<0&&(t.push(e),r=t.length-1):a&(Wo|Fo)&&(i=!0),r<0||(t[r]=e,this.callback(this.manager,a,{pointers:t,changedPointers:[e],pointerType:s,srcEvent:e}),i&&t.splice(r,1))},t}(ba);function xa(e){return Array.prototype.slice.call(e,0)}function Sa(e,t,i){for(var o=[],a=[],s=0;s<e.length;){var n=t?e[s][t]:e[s];ya(a,n)<0&&o.push(e[s]),a[s]=n,s++}return i&&(o=t?o.sort((function(e,i){return e[t]>i[t]})):o.sort()),o}var La={touchstart:Uo,touchmove:2,touchend:Wo,touchcancel:Fo},Ta=function(e){function t(){var i;return t.prototype.evTarget="touchstart touchmove touchend touchcancel",(i=e.apply(this,arguments)||this).targetIds={},i}return go(t,e),t.prototype.handler=function(e){var t=La[e.type],i=Ma.call(this,e,t);i&&this.callback(this.manager,t,{pointers:i[0],changedPointers:i[1],pointerType:jo,srcEvent:e})},t}(ba);function Ma(e,t){var i,o,a=xa(e.touches),s=this.targetIds;if(t&(2|Uo)&&1===a.length)return s[a[0].identifier]=!0,[a,a];var n=xa(e.changedTouches),r=[],l=this.target;if(o=a.filter((function(e){return na(e.target,l)})),t===Uo)for(i=0;i<o.length;)s[o[i].identifier]=!0,i++;for(i=0;i<n.length;)s[n[i].identifier]&&r.push(n[i]),t&(Wo|Fo)&&delete s[n[i].identifier],i++;return r.length?[Sa(o.concat(r),"identifier",!0),r]:void 0}var Ea={mousedown:Uo,mousemove:2,mouseup:Wo},Va=function(e){function t(){var i,o=t.prototype;return o.evEl="mousedown",o.evWin="mousemove mouseup",(i=e.apply(this,arguments)||this).pressed=!1,i}return go(t,e),t.prototype.handler=function(e){var t=Ea[e.type];t&Uo&&0===e.button&&(this.pressed=!0),2&t&&1!==e.which&&(t=Wo),this.pressed&&(t&Wo&&(this.pressed=!1),this.callback(this.manager,t,{pointers:[e],changedPointers:[e],pointerType:Io,srcEvent:e}))},t}(ba),za=2500;function Pa(e){var t=e.changedPointers[0];if(t.identifier===this.primaryTouch){var i={x:t.clientX,y:t.clientY},o=this.lastTouches;this.lastTouches.push(i);setTimeout((function(){var e=o.indexOf(i);e>-1&&o.splice(e,1)}),za)}}function Ha(e,t){e&Uo?(this.primaryTouch=t.changedPointers[0].identifier,Pa.call(this,t)):e&(Wo|Fo)&&Pa.call(this,t)}function Da(e){for(var t=e.srcEvent.clientX,i=e.srcEvent.clientY,o=0;o<this.lastTouches.length;o++){var a=this.lastTouches[o],s=Math.abs(t-a.x),n=Math.abs(i-a.y);if(s<=25&&n<=25)return!0}return!1}var Oa=function(){return function(e){function t(t,i){var o;return(o=e.call(this,t,i)||this).handler=function(e,t,i){var a=i.pointerType===jo,s=i.pointerType===Io;if(!(s&&i.sourceCapabilities&&i.sourceCapabilities.firesTouchEvents)){if(a)Ha.call(bo(bo(o)),t,i);else if(s&&Da.call(bo(bo(o)),i))return;o.callback(e,t,i)}},o.touch=new Ta(o.manager,o.handler),o.mouse=new Va(o.manager,o.handler),o.primaryTouch=null,o.lastTouches=[],o}return go(t,e),t.prototype.destroy=function(){this.touch.destroy(),this.mouse.destroy()},t}(ba)}();function Na(e,t,i){return!!Array.isArray(e)&&(ia(e,i[t],i),!0)}var Ra=32,ja=1;function Ia(e,t){var i=t.manager;return i?i.get(e):e}function Ba(e){return 16&e?"cancel":8&e?"end":4&e?"move":2&e?"start":""}var Ua=function(){function e(e){void 0===e&&(e={}),this.options=fo({enable:!0},e),this.id=ja++,this.manager=null,this.state=1,this.simultaneous={},this.requireFail=[]}var t=e.prototype;return t.set=function(e){return wo(this.options,e),this.manager&&this.manager.touchAction.update(),this},t.recognizeWith=function(e){if(Na(e,"recognizeWith",this))return this;var t=this.simultaneous;return t[(e=Ia(e,this)).id]||(t[e.id]=e,e.recognizeWith(this)),this},t.dropRecognizeWith=function(e){return Na(e,"dropRecognizeWith",this)||(e=Ia(e,this),delete this.simultaneous[e.id]),this},t.requireFailure=function(e){if(Na(e,"requireFailure",this))return this;var t=this.requireFail;return-1===ya(t,e=Ia(e,this))&&(t.push(e),e.requireFailure(this)),this},t.dropRequireFailure=function(e){if(Na(e,"dropRequireFailure",this))return this;e=Ia(e,this);var t=ya(this.requireFail,e);return t>-1&&this.requireFail.splice(t,1),this},t.hasRequireFailures=function(){return this.requireFail.length>0},t.canRecognizeWith=function(e){return!!this.simultaneous[e.id]},t.emit=function(e){var t=this,i=this.state;function o(i){t.manager.emit(i,e)}i<8&&o(t.options.event+Ba(i)),o(t.options.event),e.additionalEvent&&o(e.additionalEvent),i>=8&&o(t.options.event+Ba(i))},t.tryEmit=function(e){if(this.canEmit())return this.emit(e);this.state=Ra},t.canEmit=function(){for(var e=0;e<this.requireFail.length;){if(!(33&this.requireFail[e].state))return!1;e++}return!0},t.recognize=function(e){var t=wo({},e);if(!oa(this.options.enable,[this,t]))return this.reset(),void(this.state=Ra);56&this.state&&(this.state=1),this.state=this.process(t),30&this.state&&this.tryEmit(t)},t.process=function(e){},t.getTouchAction=function(){},t.reset=function(){},e}(),Wa=function(e){function t(t){var i;return void 0===t&&(t={}),(i=e.call(this,fo({event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},t))||this).pTime=!1,i.pCenter=!1,i._timer=null,i._input=null,i.count=0,i}go(t,e);var i=t.prototype;return i.getTouchAction=function(){return[Vo]},i.process=function(e){var t=this,i=this.options,o=e.pointers.length===i.pointers,a=e.distance<i.threshold,s=e.deltaTime<i.time;if(this.reset(),e.eventType&Uo&&0===this.count)return this.failTimeout();if(a&&s&&o){if(e.eventType!==Wo)return this.failTimeout();var n=!this.pTime||e.timeStamp-this.pTime<i.interval,r=!this.pCenter||ca(this.pCenter,e.center)<i.posThreshold;if(this.pTime=e.timeStamp,this.pCenter=e.center,r&&n?this.count+=1:this.count=1,this._input=e,0===this.count%i.taps)return this.hasRequireFailures()?(this._timer=setTimeout((function(){t.state=8,t.tryEmit()}),i.interval),2):8}return Ra},i.failTimeout=function(){var e=this;return this._timer=setTimeout((function(){e.state=Ra}),this.options.interval),Ra},i.reset=function(){clearTimeout(this._timer)},i.emit=function(){8===this.state&&(this._input.tapCount=this.count,this.manager.emit(this.options.event,this._input))},t}(Ua),Fa=function(e){function t(t){return void 0===t&&(t={}),e.call(this,fo({pointers:1},t))||this}go(t,e);var i=t.prototype;return i.attrTest=function(e){var t=this.options.pointers;return 0===t||e.pointers.length===t},i.process=function(e){var t=this.state,i=e.eventType,o=6&t,a=this.attrTest(e);return o&&(i&Fo||!a)?16|t:o||a?i&Wo?8|t:2&t?4|t:2:Ra},t}(Ua);function Za(e){return e===Xo?"down":e===Yo?"up":e===qo?"left":e===Ko?"right":""}var qa=function(e){function t(t){var i;return void 0===t&&(t={}),(i=e.call(this,fo({event:"pan",threshold:10,pointers:1,direction:Qo},t))||this).pX=null,i.pY=null,i}go(t,e);var i=t.prototype;return i.getTouchAction=function(){var e=this.options.direction,t=[];return e&Go&&t.push(Ho),e&Jo&&t.push(Po),t},i.directionTest=function(e){var t=this.options,i=!0,o=e.distance,a=e.direction,s=e.deltaX,n=e.deltaY;return a&t.direction||(t.direction&Go?(a=0===s?Zo:s<0?qo:Ko,i=s!==this.pX,o=Math.abs(e.deltaX)):(a=0===n?Zo:n<0?Yo:Xo,i=n!==this.pY,o=Math.abs(e.deltaY))),e.direction=a,i&&o>t.threshold&&a&t.direction},i.attrTest=function(e){return Fa.prototype.attrTest.call(this,e)&&(2&this.state||!(2&this.state)&&this.directionTest(e))},i.emit=function(t){this.pX=t.deltaX,this.pY=t.deltaY;var i=Za(t.direction);i&&(t.additionalEvent=this.options.event+i),e.prototype.emit.call(this,t)},t}(Fa),Ka=function(e){function t(t){return void 0===t&&(t={}),e.call(this,fo({event:"swipe",threshold:10,velocity:.3,direction:Go|Jo,pointers:1},t))||this}go(t,e);var i=t.prototype;return i.getTouchAction=function(){return qa.prototype.getTouchAction.call(this)},i.attrTest=function(t){var i,o=this.options.direction;return o&(Go|Jo)?i=t.overallVelocity:o&Go?i=t.overallVelocityX:o&Jo&&(i=t.overallVelocityY),e.prototype.attrTest.call(this,t)&&o&t.offsetDirection&&t.distance>this.options.threshold&&t.maxPointers===this.options.pointers&&Co(i)>this.options.velocity&&t.eventType&Wo},i.emit=function(e){var t=Za(e.offsetDirection);t&&this.manager.emit(this.options.event+t,e),this.manager.emit(this.options.event,e)},t}(Fa),Ya=function(e){function t(t){return void 0===t&&(t={}),e.call(this,fo({event:"pinch",threshold:0,pointers:2},t))||this}go(t,e);var i=t.prototype;return i.getTouchAction=function(){return[zo]},i.attrTest=function(t){return e.prototype.attrTest.call(this,t)&&(Math.abs(t.scale-1)>this.options.threshold||2&this.state)},i.emit=function(t){if(1!==t.scale){var i=t.scale<1?"in":"out";t.additionalEvent=this.options.event+i}e.prototype.emit.call(this,t)},t}(Fa),Xa=function(e){function t(t){return void 0===t&&(t={}),e.call(this,fo({event:"rotate",threshold:0,pointers:2},t))||this}go(t,e);var i=t.prototype;return i.getTouchAction=function(){return[zo]},i.attrTest=function(t){return e.prototype.attrTest.call(this,t)&&(Math.abs(t.rotation)>this.options.threshold||2&this.state)},t}(Fa),Ga=function(e){function t(t){var i;return void 0===t&&(t={}),(i=e.call(this,fo({event:"press",pointers:1,time:251,threshold:9},t))||this)._timer=null,i._input=null,i}go(t,e);var i=t.prototype;return i.getTouchAction=function(){return[Eo]},i.process=function(e){var t=this,i=this.options,o=e.pointers.length===i.pointers,a=e.distance<i.threshold,s=e.deltaTime>i.time;if(this._input=e,!a||!o||e.eventType&(Wo|Fo)&&!s)this.reset();else if(e.eventType&Uo)this.reset(),this._timer=setTimeout((function(){t.state=8,t.tryEmit()}),i.time);else if(e.eventType&Wo)return 8;return Ra},i.reset=function(){clearTimeout(this._timer)},i.emit=function(e){8===this.state&&(e&&e.eventType&Wo?this.manager.emit(this.options.event+"up",e):(this._input.timeStamp=xo(),this.manager.emit(this.options.event,this._input)))},t}(Ua),Ja={domEvents:!1,touchAction:Mo,enable:!0,inputTarget:null,inputClass:null,cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}},Qa=[[Xa,{enable:!1}],[Ya,{enable:!1},["rotate"]],[Ka,{direction:Go}],[qa,{direction:Go},["swipe"]],[Wa],[Wa,{event:"doubletap",taps:2},["tap"]],[Ga]];function es(e,t){var i,o=e.element;o.style&&(ia(e.options.cssProps,(function(a,s){i=So(o.style,s),t?(e.oldCssProps[i]=o.style[i],o.style[i]=a):o.style[i]=e.oldCssProps[i]||""})),t||(e.oldCssProps={}))}var ts=function(){function e(e,t){var i,o=this;this.options=wo({},Ja,t||{}),this.options.inputTarget=this.options.inputTarget||e,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=e,this.input=new((i=this).options.inputClass||(No?Ca:Ro?Ta:Oo?Oa:Va))(i,pa),this.touchAction=new sa(this,this.options.touchAction),es(this,!0),ia(this.options.recognizers,(function(e){var t=o.add(new e[0](e[1]));e[2]&&t.recognizeWith(e[2]),e[3]&&t.requireFailure(e[3])}),this)}var t=e.prototype;return t.set=function(e){return wo(this.options,e),e.touchAction&&this.touchAction.update(),e.inputTarget&&(this.input.destroy(),this.input.target=e.inputTarget,this.input.init()),this},t.stop=function(e){this.session.stopped=e?2:1},t.recognize=function(e){var t=this.session;if(!t.stopped){var i;this.touchAction.preventDefaults(e);var o=this.recognizers,a=t.curRecognizer;(!a||a&&8&a.state)&&(t.curRecognizer=null,a=null);for(var s=0;s<o.length;)i=o[s],2===t.stopped||a&&i!==a&&!i.canRecognizeWith(a)?i.reset():i.recognize(e),!a&&14&i.state&&(t.curRecognizer=i,a=i),s++}},t.get=function(e){if(e instanceof Ua)return e;for(var t=this.recognizers,i=0;i<t.length;i++)if(t[i].options.event===e)return t[i];return null},t.add=function(e){if(Na(e,"add",this))return this;var t=this.get(e.options.event);return t&&this.remove(t),this.recognizers.push(e),e.manager=this,this.touchAction.update(),e},t.remove=function(e){if(Na(e,"remove",this))return this;var t=this.get(e);if(e){var i=this.recognizers,o=ya(i,t);-1!==o&&(i.splice(o,1),this.touchAction.update())}return this},t.on=function(e,t){if(void 0===e||void 0===t)return this;var i=this.handlers;return ia(ma(e),(function(e){i[e]=i[e]||[],i[e].push(t)})),this},t.off=function(e,t){if(void 0===e)return this;var i=this.handlers;return ia(ma(e),(function(e){t?i[e]&&i[e].splice(ya(i[e],t),1):delete i[e]})),this},t.emit=function(e,t){this.options.domEvents&&function(e,t){var i=document.createEvent("Event");i.initEvent(e,!0,!0),i.gesture=t,t.target.dispatchEvent(i)}(e,t);var i=this.handlers[e]&&this.handlers[e].slice();if(i&&i.length){t.type=e,t.preventDefault=function(){t.srcEvent.preventDefault()};for(var o=0;o<i.length;)i[o](t),o++}},t.destroy=function(){this.element&&es(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null},e}(),is={touchstart:Uo,touchmove:2,touchend:Wo,touchcancel:Fo},os=function(e){function t(){var i,o=t.prototype;return o.evTarget="touchstart",o.evWin="touchstart touchmove touchend touchcancel",(i=e.apply(this,arguments)||this).started=!1,i}return go(t,e),t.prototype.handler=function(e){var t=is[e.type];if(t===Uo&&(this.started=!0),this.started){var i=as.call(this,e,t);t&(Wo|Fo)&&i[0].length-i[1].length==0&&(this.started=!1),this.callback(this.manager,t,{pointers:i[0],changedPointers:i[1],pointerType:jo,srcEvent:e})}},t}(ba);function as(e,t){var i=xa(e.touches),o=xa(e.changedTouches);return t&(Wo|Fo)&&(i=Sa(i.concat(o),"identifier",!0)),[i,o]}function ss(e,t,i){var o="DEPRECATED METHOD: "+t+"\n"+i+" AT \n";return function(){var t=new Error("get-stack-trace"),i=t&&t.stack?t.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,"{anonymous}()@"):"Unknown Stack Trace",a=window.console&&(window.console.warn||window.console.log);return a&&a.call(window.console,o,i),e.apply(this,arguments)}}var ns=ss((function(e,t,i){for(var o=Object.keys(t),a=0;a<o.length;)(!i||i&&void 0===e[o[a]])&&(e[o[a]]=t[o[a]]),a++;return e}),"extend","Use `assign`."),rs=ss((function(e,t){return ns(e,t,!0)}),"merge","Use `assign`.");function ls(e,t,i){var o,a=t.prototype;(o=e.prototype=Object.create(a)).constructor=e,o._super=a,i&&wo(o,i)}function cs(e,t){return function(){return e.apply(t,arguments)}}(function(){var e=function(e,t){return void 0===t&&(t={}),new ts(e,fo({recognizers:Qa.concat()},t))};return e.VERSION="2.0.17-rc",e.DIRECTION_ALL=Qo,e.DIRECTION_DOWN=Xo,e.DIRECTION_LEFT=qo,e.DIRECTION_RIGHT=Ko,e.DIRECTION_UP=Yo,e.DIRECTION_HORIZONTAL=Go,e.DIRECTION_VERTICAL=Jo,e.DIRECTION_NONE=Zo,e.DIRECTION_DOWN=Xo,e.INPUT_START=Uo,e.INPUT_MOVE=2,e.INPUT_END=Wo,e.INPUT_CANCEL=Fo,e.STATE_POSSIBLE=1,e.STATE_BEGAN=2,e.STATE_CHANGED=4,e.STATE_ENDED=8,e.STATE_RECOGNIZED=8,e.STATE_CANCELLED=16,e.STATE_FAILED=Ra,e.Manager=ts,e.Input=ba,e.TouchAction=sa,e.TouchInput=Ta,e.MouseInput=Va,e.PointerEventInput=Ca,e.TouchMouseInput=Oa,e.SingleTouchInput=os,e.Recognizer=Ua,e.AttrRecognizer=Fa,e.Tap=Wa,e.Pan=qa,e.Swipe=Ka,e.Pinch=Ya,e.Rotate=Xa,e.Press=Ga,e.on=va,e.off=fa,e.each=ia,e.merge=rs,e.extend=ns,e.bindFn=cs,e.assign=wo,e.inherit=ls,e.bindFn=cs,e.prefixed=So,e.toArray=xa,e.inArray=ya,e.uniqueArray=Sa,e.splitStr=ma,e.boolOrFn=oa,e.hasParent=na,e.addEventListeners=va,e.removeEventListeners=fa,e.defaults=wo({},Ja,{preset:Qa}),e})().defaults;
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ds=270;const us=new Set(["ArrowRight","ArrowUp","ArrowLeft","ArrowDown","PageUp","PageDown","Home","End"]);let hs=class extends re{constructor(){super(...arguments),this.disabled=!1,this.step=1,this.min=0,this.max=100,this._localValue=this.value,this._localLow=this.low,this._localHigh=this.high,this._getPercentageFromEvent=e=>{const t=this._slider.getBoundingClientRect(),i=2*(e.center.x-t.left-t.width/2)/t.width,o=2*(e.center.y-t.top-t.height/2)/t.height,[,a]=function(e,t){return[Math.sqrt(e*e+t*t),Math.atan2(t,e)]}(i,o),s=(a/(2*Math.PI)*360+45-135+360)%360-45;return Math.max(Math.min(s/ds,1),0)}}_valueToPercentage(e){return(Di(e,this.min,this.max)-this.min)/(this.max-this.min)}_percentageToValue(e){return(this.max-this.min)*e+this.min}_steppedValue(e){return Math.round(e/this.step)*this.step}_boundedValue(e){var t,i;const o="high"===this._activeSlider?Math.min(null!==(t=this._localLow)&&void 0!==t?t:this.max):this.min,a="low"===this._activeSlider?Math.max(null!==(i=this._localHigh)&&void 0!==i?i:this.min):this.max;return Math.min(Math.max(e,o),a)}firstUpdated(e){super.firstUpdated(e),this._setupListeners()}updated(e){super.updated(e),this._activeSlider||(e.has("value")&&(this._localValue=this.value),e.has("low")&&(this._localLow=this.low),e.has("high")&&(this._localHigh=this.high))}connectedCallback(){super.connectedCallback(),this._setupListeners()}disconnectedCallback(){super.disconnectedCallback()}_findActiveSlider(e){var t,i;if(!this.dual)return"value";const o=Math.max(null!==(t=this._localLow)&&void 0!==t?t:this.min,this.min),a=Math.min(null!==(i=this._localHigh)&&void 0!==i?i:this.max,this.max);if(o>=e)return"low";if(a<=e)return"high";return Math.abs(e-o)<=Math.abs(e-a)?"low":"high"}_setActiveValue(e){switch(this._activeSlider){case"high":this._localHigh=e;break;case"low":this._localLow=e;break;case"value":this._localValue=e}}_getActiveValue(){switch(this._activeSlider){case"high":return this._localHigh;case"low":return this._localLow;case"value":return this._localValue}}_setupListeners(){this._interaction&&!this._mc&&(this._mc=new ts(this._interaction,{inputClass:Oa}),this._mc.add(new qa({direction:Qo,enable:!0,threshold:0})),this._mc.add(new Wa({event:"singletap"})),this._mc.on("pan",(e=>{e.srcEvent.stopPropagation(),e.srcEvent.preventDefault()})),this._mc.on("panstart",(e=>{var t,i;if(this.disabled)return;const o=this._getPercentageFromEvent(e),a=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(a),this._lastSlider=this._activeSlider,null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("#slider"))||void 0===i||i.focus()})),this._mc.on("pancancel",(()=>{this.disabled||(this._activeSlider=void 0)})),this._mc.on("panmove",(e=>{if(this.disabled)return;const t=this._getPercentageFromEvent(e),i=this._percentageToValue(t),o=this._boundedValue(i);this._setActiveValue(o);const a=this._steppedValue(o);this._activeSlider&&Hi(this,`${this._activeSlider}-changing`,{value:a})})),this._mc.on("panend",(e=>{if(this.disabled)return;const t=this._getPercentageFromEvent(e),i=this._percentageToValue(t),o=this._boundedValue(i),a=this._steppedValue(o);this._setActiveValue(a),this._activeSlider&&(Hi(this,`${this._activeSlider}-changing`,{value:void 0}),Hi(this,`${this._activeSlider}-changed`,{value:a})),this._activeSlider=void 0})),this._mc.on("singletap",(e=>{var t,i;if(this.disabled)return;const o=this._getPercentageFromEvent(e),a=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(a);const s=this._boundedValue(a),n=this._steppedValue(s);this._setActiveValue(n),this._activeSlider&&(Hi(this,`${this._activeSlider}-changing`,{value:void 0}),Hi(this,`${this._activeSlider}-changed`,{value:n})),this._lastSlider=this._activeSlider,null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("#slider"))||void 0===i||i.focus(),this._activeSlider=void 0})))}get _tenPercentStep(){return Math.max(this.step,(this.max-this.min)/10)}_handleKeyDown(e){var t,i,o;if(!us.has(e.code))return;e.preventDefault(),this._lastSlider&&(null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById(this._lastSlider))||void 0===i||i.focus()),this._activeSlider=null!==(o=this._lastSlider)&&void 0!==o?o:e.currentTarget.id,this._lastSlider=void 0;const a=this._getActiveValue();switch(e.code){case"ArrowRight":case"ArrowUp":this._setActiveValue(this._boundedValue((null!=a?a:this.min)+this.step));break;case"ArrowLeft":case"ArrowDown":this._setActiveValue(this._boundedValue((null!=a?a:this.min)-this.step));break;case"PageUp":this._setActiveValue(this._steppedValue(this._boundedValue((null!=a?a:this.min)+this._tenPercentStep)));break;case"PageDown":this._setActiveValue(this._steppedValue(this._boundedValue((null!=a?a:this.min)-this._tenPercentStep)));break;case"Home":this._setActiveValue(this._boundedValue(this.min));break;case"End":this._setActiveValue(this._boundedValue(this.max))}Hi(this,`${this._activeSlider}-changing`,{value:this._getActiveValue()}),this._activeSlider=void 0}_handleKeyUp(e){us.has(e.code)&&(this._activeSlider=e.currentTarget.id,e.preventDefault(),Hi(this,`${this._activeSlider}-changing`,{value:void 0}),Hi(this,`${this._activeSlider}-changed`,{value:this._getActiveValue()}),this._activeSlider=void 0)}destroyListeners(){this._mc&&(this._mc.destroy(),this._mc=void 0)}_strokeCircleDashArc(e){return this._strokeDashArc(e,e)}_strokeDashArc(e,t){const i=this._valueToPercentage(e),o=this._valueToPercentage(t),a=290*Math.PI*ds/360,s=Math.max((o-i)*a,0);return[`${s} ${a-s}`,`-${i*a-.5}`]}renderArc(e,t,i){var o,a;if(this.disabled)return Z;const s=vo({x:0,y:0,start:0,end:ds,r:145}),n="end"===i?this.max:this.min,r=null!==(o=this.current)&&void 0!==o?o:n,l=null!=t?t:n,c="end"===i?l<=r:"start"===i&&r<=l,d=c?"end"===i?this._strokeDashArc(l,r):this._strokeDashArc(r,l):this._strokeCircleDashArc(l),u="full"===i?this._strokeDashArc(this.min,this.max):"end"===i?this._strokeDashArc(l,n):this._strokeDashArc(n,l),h=this._strokeCircleDashArc(l),_=null!=this.current&&this.current<=this.max&&this.current>=this.min&&(c||"full"===this.mode)?this._strokeCircleDashArc(this.current):void 0;return W`
      ...
      `}render(){const e=vo({x:0,y:0,start:0,end:ds,r:145}),t=this.dual?this._localLow:this._localValue,i=this._localHigh,o=this.current,a=o?this._strokeCircleDashArc(o):void 0;return U`
        <svg
          id="slider"
          viewBox="0 0 320 320"
          overflow="visible"
   ...
   >
    ${(null===(e=this._config)||void 0===e?void 0:e.disable_menu)?"":U`
          ...
          <div class="content${(null===(i=this._config)||void 0===i?void 0:i.disable_presets)?" no-presets":""} ${0==this.name.length?" noname":""} ${null!==this.safety_state||this.displayMessages?" security_msg":""} ${this._hasWindow?" window_open":""}  ${this.overpowering?" overpowering":""} ${this.presence?" presence":""} ${this.motion?" motion":""}  ${this._hasWindowByPass?" windowByPass":""} " >
            <svg id="main" viewbox="0 0 125 100">
              <g transform="translate(57.5,37) scale(0.35)">
                ...
                `:""}
                ${this._hasWindowByPass||!this._hasWindow||(null===(o=this._config)||void 0===o?void 0:o.disable_window)?"":W`
                ...
                `:""}
                ${this._hasAutoStartStop&&!(null===(r=this._config)||void 0===r?void 0:r.disable_autoStartStop)?W`
      ...
      ${(null===(p=null==this?void 0:this._config)||void 0===p?void 0:p.disable_buttons)?U``:U`
      ...
      ${(null===(m=this._config)||void 0===m?void 0:m.disable_presets)?"":U`
        ...
        ${(null===(v=this._config)||void 0===v?void 0:v.disable_timed_preset)?"":U`
          <div class="timed-preset-container">
            ${this.timedPresetActive?U`
              ...
              ${(null!==(f=this.timedPresetRemainingTime)&&void 0!==f?f:0)<60?U`
              ...
              <ha-icon-button
                ...
                .path=${we}
              ></ha-icon-button>
            `:(null===(g=this._config)||void 0===g?void 0:g.use_manual_duration_input)?U`
              <input
                type="number"
  ...
  `}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._handleKeyDown),this._clearRelockTimeout()}static async getConfigElement(){return await Promise.resolve().then((function(){return Hs})),document.createElement("versatile-thermostat-ui-card-editor")}static async getStubConfig(e){const t=Object.keys(e.states).filter((e=>["climate"].includes(e.split(".")[0]))),i=t.filter((t=>{var i;return null===(i=e.states[t].attributes)||void 0===i?void 0:i.specific_states}));return{type:"custom:versatile-thermostat-ui-card",entity:i[0]||t[0]}}};Ls.styles=n`
      :host {
          display: block;
  ...
  `,e([he({attribute:!1})],Ls.prototype,"hass",void 0),e([he({type:Number})],Ls.prototype,"value",void 0),e([_e()],Ls.prototype,"_selectTargetTemperature",void 0),e([he({type:Number})],Ls.prototype,"current",void 0),e([he({type:Number})],Ls.prototype,"humidity",void 0),e([he({type:Number})],Ls.prototype,"temperature",void 0),e([he({type:Number})],Ls.prototype,"min",void 0),e([he({type:Number})],Ls.prototype,"max",void 0),e([he({type:Number})],Ls.prototype,"step",void 0),e([he({type:Number})],Ls.prototype,"powerPercent",void 0),e([he({type:Number})],Ls.prototype,"meanCyclePower",void 0),e([he({type:Number})],Ls.prototype,"valveOpenPercent",void 0),e([he({type:Number})],Ls.prototype,"devicePower",void 0),e([he({type:Number})],Ls.prototype,"regulatedTargetTemperature",void 0),e([he({type:Boolean})],Ls.prototype,"isOn",void 0),e([he({type:Boolean})],Ls.prototype,"window",void 0),e([he({type:Boolean})],Ls.prototype,"windowByPass",void 0),e([he({type:Boolean})],Ls.prototype,"presence",void 0),e([he({type:Boolean})],Ls.prototype,"motion",void 0),e([he({type:Boolean})],Ls.prototype,"overpowering",void 0),e([he({type:Boolean})],Ls.prototype,"isDeviceActive",void 0),e([he({type:Boolean})],Ls.prototype,"isSleeping",void 0),e([he({type:Boolean})],Ls.prototype,"isRegulated",void 0),e([he({type:Boolean})],Ls.prototype,"isRecalculateScheduled",void 0),e([he({type:String})],Ls.prototype,"windowState",void 0),e([he({type:String})],Ls.prototype,"windowAutoState",void 0),e([he({type:String})],Ls.prototype,"overpoweringState",void 0),e([he({type:String})],Ls.prototype,"presenceState",void 0),e([he({type:String})],Ls.prototype,"motionState",void 0),e([he({type:String})],Ls.prototype,"safetyState",void 0),e([he({type:String})],Ls.prototype,"status",void 0),e([he({type:String})],Ls.prototype,"hvacMode",void 0),e([he({type:String})],Ls.prototype,"hvacAction",void 0),e([he({type:String})],Ls.prototype,"preset",void 0),e([he({type:String})],Ls.prototype,"autoRegulationMode",void 0),e([he({type:String})],Ls.prototype,"currentAutoFanMode",void 0),e([he({type:String})],Ls.prototype,"autoFanMode",void 0),e([he({type:String})],Ls.prototype,"fanMode",void 0),e([he({type:String})],Ls.prototype,"hvacOffReason",void 0),e([he({type:Boolean,reflect:!0})],Ls.prototype,"dragging",void 0),e([he({type:String})],Ls.prototype,"name",void 0),e([_e()],Ls.prototype,"changingHigh",void 0),e([_e()],Ls.prototype,"_hasError",void 0),e([_e()],Ls.prototype,"_config",void 0),e([he({type:String})],Ls.prototype,"theme",void 0),e([_e()],Ls.prototype,"isLocked",void 0),e([_e()],Ls.prototype,"isUserLocked",void 0),e([_e()],Ls.prototype,"isAutomationLocked",void 0),e([_e()],Ls.prototype,"showDigicodeModal",void 0),e([_e()],Ls.prototype,"enteredCode",void 0),e([_e()],Ls.prototype,"codeError",void 0),e([_e()],Ls.prototype,"isLocking",void 0),e([_e()],Ls.prototype,"timedPresetDuration",void 0),e([_e()],Ls.prototype,"timedPresetActive",void 0),e([_e()],Ls.prototype,"timedPresetRemainingTime",void 0),e([_e()],Ls.prototype,"timedPresetPreset",void 0),Ls=e([ce("versatile-thermostat-ui-card")],Ls);const Ts=function(...e){const t="type"===e[0].type,i=e.map((e=>e.schema)),o=Object.assign({},...i);return t?io(o):Qi(o)}(Qi({index:eo(Ji()),view_index:eo(Ji()),view_layout:Ki("any",(()=>!0)),type:to()}),Qi({entity:eo(to()),name:eo(to()),icon:eo(to()),autoStartStopEnableEntity:eo(to()),powerEntity:eo(to())}),Qi({disable_name:eo(Xi()),disable_circle:eo(Xi()),disable_background_color:eo(Xi()),disable_window:eo(Xi()),disable_autoStartStop:eo(Xi()),disable_overpowering:eo(Xi()),disable_heat:eo(Xi()),disable_cool:eo(Xi()),disable_heat_cool:eo(Xi()),disable_auto:eo(Xi()),disable_dry:eo(Xi()),disable_fan_only:eo(Xi()),disable_off:eo(Xi()),disable_sleep:eo(Xi()),disable_safety_warning:eo(Xi()),disable_power_infos:eo(Xi()),disable_auto_fan_infos:eo(Xi()),disable_target_icon:eo(Xi()),set_current_as_main:eo(Xi()),eco_temperature:eo(Ji()),disable_menu:eo(Xi()),disable_buttons:eo(Xi()),allow_lock_toggle:eo(Xi()),lock_relock_delay:eo(Ji()),disable_presets:eo(Xi()),theme:eo(oo([Gi("classic"),Gi("vtherm"),Gi("uncolored"),Gi("gunmalmg")])),disable_timed_preset:eo(Xi()),use_manual_duration_input:eo(Xi())})),Ms=["icon_color","layout","fill_container","primary_info","secondary_info","icon_type","content_info","use_entity_picture","collapsible_controls","icon_animation"],Es=e=>{var t,i;customElements.get("ha-form")&&(customElements.get("hui-action-editor")||((e,t,i,o)=>{const[a,s,n]=e.split(".",3);return Number(a)>t||Number(a)===t&&(void 0===o?Number(s)>=i:Number(s)>i)||void 0!==o&&Number(a)===t&&Number(s)===i&&Number(n)>=o})(e,2022,11))||null===(t=customElements.get("hui-button-card"))||void 0===t||t.getConfigElement(),customElements.get("ha-entity-picker")||null===(i=customElements.get("hui-entities-card"))||void 0===i||i.getConfigElement()},Vs=["theme","autoStartStopEnableEntity","powerEntity","disable_name","disable_window","disable_autoStartStop","disable_overpowering","disable_heat","disable_cool","disable_heat_cool","disable_auto","disable_dry","disable_fan_only","disable_off","disable_sleep","disable_menu","disable_safety_warning","disable_buttons","set_current_as_main","disable_power_infos","disable_auto_fan_infos","disable_target_icon","allow_lock_toggle","lock_relock_delay","disable_presets","disable_timed_preset","use_manual_duration_input"],zs=zi((()=>[{name:"entity",selector:{entity:{domain:["climate"]}}},{name:"name",selector:{text:{}}},{name:"theme",selector:{select:{options:[{value:"classic",label:"Classic"},{value:"vtherm",label:"VTherm"},{value:"uncolored",label:"Uncolored"},{value:"gunmalmg",label:"Gunmalmg"}]}}},{type:"grid",name:"",schema:[{name:"autoStartStopEnableEntity",selector:{entity:{domain:["switch"]}}},{name:"powerEntity",selector:{entity:{domain:["sensor","input_number"]}}}]},{type:"grid",name:"",schema:[{name:"disable_name",selector:{boolean:{}}},{name:"disable_window",selector:{boolean:{}}},{name:"disable_autoStartStop",selector:{boolean:{}}},{name:"disable_overpowering",selector:{boolean:{}}},{name:"disable_heat",selector:{boolean:{}}},{name:"disable_cool",selector:{boolean:{}}},{name:"disable_heat_cool",selector:{boolean:{}}},{name:"disable_auto",selector:{boolean:{}}},{name:"disable_dry",selector:{boolean:{}}},{name:"disable_fan_only",selector:{boolean:{}}},{name:"disable_off",selector:{boolean:{}}},{name:"disable_sleep",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"disable_safety_warning",selector:{boolean:{}}},{name:"disable_buttons",selector:{boolean:{}}},{name:"set_current_as_main",selector:{boolean:{}}},{name:"disable_power_infos",selector:{boolean:{}}},{name:"disable_auto_fan_infos",selector:{boolean:{}}},{name:"disable_target_icon",selector:{boolean:{}}},{name:"allow_lock_toggle",selector:{boolean:{}}},{name:"lock_relock_delay",selector:{number:{min:0,max:3600,unit_of_measurement:"s",mode:"box"}}},{name:"disable_presets",selector:{boolean:{}}},{name:"disable_timed_preset",selector:{boolean:{}}},{name:"use_manual_duration_input",selector:{boolean:{}}}]}]));let Ps=class extends re{constructor(){super(...arguments),this._computeLabel=e=>{const t=(i=this.hass,function(e){var t;let o=Li(e,null!==(t=null==i?void 0:i.locale.language)&&void 0!==t?t:xi);return o||(o=Li(e,xi)),null!=o?o:e});var i;return Ms.includes(e.name)?t(`editor.card.generic.${e.name}`):Vs.includes(e.name)?t(`editor.card.climate.${e.name}`):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)}}connectedCallback(){super.connectedCallback(),Es(this.hass.connection.haVersion)}setConfig(e){Zi(e,Ts),this._config=e}render(){if(!this.hass||!this._config)return U``;const e=zs();return U`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${e}
            ...
            ></ha-form>
        `}_valueChanged(e){const t=e.detail.value;if(!t.theme){const e=!!t.disable_circle,i=!!t.disable_background_color;e?e&&!i?t.theme="vtherm":e&&i&&(t.theme="uncolored"):t.theme="classic"}Hi(this,"config-changed",{config:t}),Hi(this,"hass",{config:t})}};e([_e()],Ps.prototype,"_config",void 0),e([he({attribute:!1})],Ps.prototype,"hass",void 0),Ps=e([ce("versatile-thermostat-ui-card-editor")],Ps);var Hs=Object.freeze({__proto__:null,get ClimateCardEditor(){return Ps}});export{Ls as VersatileThermostatUi,Cs as registerCustomCard};
