 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const fe=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends ve{constructor(e){if(super(e),e.type!==ge||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(void 0===this.it){this.it=new Set,void 0!==e.strings&&(this.st=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!this.st?.has(e)&&this.it.add(e);return this.render(t)}const i=e.element.classList;for(const e of this.it)e in t||(i.remove(e),this.it.delete(e));for(const e in t){const o=!!t[e];o===this.it.has(e)||this.st?.has(e)||(o?(i.add(e),this.it.add(e)):(i.remove(e),this.it.delete(e)))}return W}});var be="M6.59,0.66C8.93,-1.15 11.47,1.06 12.04,4.5C12.47,4.5 12.89,4.62 13.27,4.84C13.79,4.24 14.25,3.42 14.07,2.5C13.65,0.35 16.06,-1.39 18.35,1.58C20.16,3.92 17.95,6.46 14.5,7.03C14.5,7.46 14.39,7.89 14.16,8.27C14.76,8.78 15.58,9.24 16.5,9.06C18.63,8.64 20.38,11.04 17.41,13.34C15.07,15.15 12.53,12.94 11.96,9.5C11.53,9.5 11.11,9.37 10.74,9.15C10.22,9.75 9.75,10.58 9.93,11.5C10.35,13.64 7.94,15.39 5.65,12.42C3.83,10.07 6.05,7.53 9.5,6.97C9.5,6.54 9.63,6.12 9.85,5.74C9.25,5.23 8.43,4.76 7.5,4.94C5.37,5.36 3.62,2.96 6.59,0.66M5,16H7A2,2 0 0,1 9,18V24H7V22H5V24H3V18A2,2 0 0,1 5,16M5,18V20H7V18H5M12.93,16H15L12.07,24H10L12.93,16M18,16H21V18H18V22H21V24H18A2,2 0 0,1 16,22V18A2,2 0 0,1 18,16Z",ye="M19,19H5V5H19M19,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M11,15H13V17H11V15M11,7H13V13H11V7",we="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",ke="M12,16A2,2 0 0,1 14,18A2,2 0 0,1 12,20A2,2 0 0,1 10,18A2,2 0 0,1 12,16M12,10A2,2 0 0,1 14,12A2,2 0 0,1 12,14A2,2 0 0,1 10,12A2,2 0 0,1 12,10M12,4A2,2 0 0,1 14,6A2,2 0 0,1 12,8A2,2 0 0,1 10,6A2,2 0 0,1 12,4Z",$e="M12,11A1,1 0 0,0 11,12A1,1 0 0,0 12,13A1,1 0 0,0 13,12A1,1 0 0,0 12,11M12.5,2C17,2 17.11,5.57 14.75,6.75C13.76,7.24 13.32,8.29 13.13,9.22C13.61,9.42 14.03,9.73 14.35,10.13C18.05,8.13 22.03,8.92 22.03,12.5C22.03,17 18.46,17.1 17.28,14.73C16.78,13.74 15.72,13.3 14.79,13.11C14.59,13.59 14.28,14 13.88,14.34C15.87,18.03 15.08,22 11.5,22C7,22 6.91,18.42 9.27,17.24C10.25,16.75 10.69,15.71 10.89,14.79C10.4,14.59 9.97,14.27 9.65,13.87C5.96,15.85 2,15.07 2,11.5C2,7 5.56,6.89 6.74,9.26C7.24,10.25 8.29,10.68 9.22,10.87C9.41,10.39 9.73,9.97 10.14,9.65C8.15,5.96 8.94,2 12.5,2Z",xe="M5,2V13H8V22L15,10H11L15,2M17,15H19V17H17V15M17,7H19V13H17V7Z",Ae="M8.5 4.5L5.4 9.5L8.5 14.7L5.2 20.5L3.4 19.6L6.1 14.7L3 9.5L6.7 3.6L8.5 4.5M14.7 4.4L11.6 9.5L14.7 14.5L11.4 20.3L9.6 19.4L12.3 14.5L9.2 9.5L12.9 3.5L14.7 4.4M21 4.4L17.9 9.5L21 14.5L17.7 20.3L15.9 19.4L18.6 14.5L15.5 9.5L19.2 3.5L21 4.4",Ce="M12,3L2,12H5V20H19V12H22L12,3M12,8.75A2.25,2.25 0 0,1 14.25,11A2.25,2.25 0 0,1 12,13.25A2.25,2.25 0 0,1 9.75,11A2.25,2.25 0 0,1 12,8.75M12,15C13.5,15 16.5,15.75 16.5,17.25V18H7.5V17.25C7.5,15.75 10.5,15 12,15Z",Se="M13 9H11V7H13V9M13 17H11V11H13V17M5 3H19C20.1 3 21 3.89 21 5V19C21 19.53 20.79 20.04 20.41 20.41C20.04 20.79 19.53 21 19 21H5C4.47 21 3.96 20.79 3.59 20.41C3.21 20.04 3 19.53 3 19V5C3 3.89 3.89 3 5 3M19 19V5H5V19H19Z",Te="M12,17A2,2 0 0,0 14,15C14,13.89 13.1,13 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6A2,2 0 0,1 4,20V10C4,8.89 4.9,8 6,8H7V6A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,3A3,3 0 0,0 9,6V8H15V6A3,3 0 0,0 12,3Z",Le="M18,8A2,2 0 0,1 20,10V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V10A2,2 0 0,1 6,8H15V6A3,3 0 0,0 12,3A3,3 0 0,0 9,6H7A5,5 0 0,1 12,1A5,5 0 0,1 17,6V8H18M12,17A2,2 0 0,0 14,15A2,2 0 0,0 12,13A2,2 0 0,0 10,15A2,2 0 0,0 12,17Z",Me="M12 2C7.04 2 3 6.04 3 11C3 14.91 5.5 18.24 9 19.47V22H11V19.94C11.33 20 11.66 20 12 20S12.67 20 13 19.94V22H15V19.47C18.5 18.23 21 14.9 21 11C21 6.04 16.96 2 12 2M14.25 14L11.25 17L9.75 15.5L11 14.25L9.75 13L12.75 10L14.25 11.5L13 12.75L14.25 14M16 9H8V7H16V9Z",Ve="M10,0.2C9,0.2 8.2,1 8.2,2C8.2,3 9,3.8 10,3.8C11,3.8 11.8,3 11.8,2C11.8,1 11,0.2 10,0.2M15.67,1A7.33,7.33 0 0,0 23,8.33V7A6,6 0 0,1 17,1H15.67M18.33,1C18.33,3.58 20.42,5.67 23,5.67V4.33C21.16,4.33 19.67,2.84 19.67,1H18.33M21,1A2,2 0 0,0 23,3V1H21M7.92,4.03C7.75,4.03 7.58,4.06 7.42,4.11L2,5.8V11H3.8V7.33L5.91,6.67L2,22H3.8L6.67,13.89L9,17V22H10.8V15.59L8.31,11.05L9.04,8.18L10.12,10H15V8.2H11.38L9.38,4.87C9.08,4.37 8.54,4.03 7.92,4.03Z",Ee="M18.73,18C15.4,21.69 9.71,22 6,18.64C2.33,15.31 2.04,9.62 5.37,5.93C6.9,4.25 9,3.2 11.27,3C7.96,6.7 8.27,12.39 12,15.71C13.63,17.19 15.78,18 18,18C18.25,18 18.5,18 18.73,18Z",ze="M17 13V7H19V13H17M17 17V15H19V17H17M13 13V5C13 3.3 11.7 2 10 2S7 3.3 7 5V13C4.8 14.7 4.3 17.8 6 20S10.8 22.7 13 21 15.7 16.2 14 14C13.7 13.6 13.4 13.3 13 13M10 4C10.6 4 11 4.4 11 5V8H9V5C9 4.4 9.4 4 10 4Z",Pe="M12,3.25C12,3.25 6,10 6,14C6,17.32 8.69,20 12,20A6,6 0 0,0 18,14C18,10 12,3.25 12,3.25M14.47,9.97L15.53,11.03L9.53,17.03L8.47,15.97M9.75,10A1.25,1.25 0 0,1 11,11.25A1.25,1.25 0 0,1 9.75,12.5A1.25,1.25 0 0,1 8.5,11.25A1.25,1.25 0 0,1 9.75,10M14.25,14.5A1.25,1.25 0 0,1 15.5,15.75A1.25,1.25 0 0,1 14.25,17A1.25,1.25 0 0,1 13,15.75A1.25,1.25 0 0,1 14.25,14.5Z",He="M21 20V2H3V20H1V23H23V20M19 4V11H17V4M5 4H7V11H5M5 20V13H7V20M9 20V4H15V20M17 20V13H19V20Z",De="M2 4H20V8H18V20H16V8H6V20H4V8H2V4M7 9H15V11H7V9M7 12H15V14H7V12M20 19V17H22V19H20M20 15V10H22V15H20Z";var Oe={version:"version",current:"current"},je={card:{climate:{autoStartStopEnableEntity:"Auto-start/stop entity",powerEntity:"Power consumption entity",theme:"Theme",theme_classic:"Classic",theme_vtherm:"VTherm",theme_uncolored:"Uncolored",theme_gunmalmg:"Gunmalmg",menu_system:"System menu",disable_circle:"Disable circle",disable_background_color:"Disable background color ellipse",disable_window:"Disable window",disable_autoStartStop:"Disable auto-startStop",disable_overpowering:"Disable overpowering",disable_heat:"Disable heat mode",disable_cool:"Disable cool mode",disable_heat_cool:"Disable heat/cool mode",disable_auto:"Disable auto mode",disable_fan_only:"Disable fan only mode",disable_dry:"Disable dry mode",disable_off:"Disable off mode",disable_sleep:"Disable sleep mode",disable_menu:"Disable menu",set_current_as_main:"Exchange target temperature and room temperature",disable_safety_warning:"Disable safety warning",disable_buttons:"Disable plus/minus buttons",disable_power_infos:"Disable power infos",disable_auto_fan_infos:"Disable auto-fan infos",disable_name:"Disable name",disable_target_icon:"Disable the target icon",allow_lock_toggle:"Allow lock/unlock from card",lock_relock_delay:"Auto-relock delay (seconds, 0 = disabled)",disable_presets:"Disable presets",disable_timed_preset:"Disable timed preset duration input",use_manual_duration_input:"Allow manual duration input instead of selector"}}},Ne={window_open:"Window open",window_bypass:"Bypass window activated",night_mode:"Night mode",eco:"Eco",overpowering:"Overpowering detected",none:"Manual",comfort:"Comfort",boost:"Boost",frost:"Frost",power:"Overpowering",activity:"Activity detected",presence:"Presence detected",motion:"Motion detected",undefined:"None",auto_regulation_light:"Light",auto_regulation_medium:"Medium",auto_regulation_strong:"Strong",auto_regulation_slow:"Slow",auto_regulation_expert:"Expert",auto_fan_mode:"Auto-fan",auto_fan_mode_off:"None",auto_fan_none:"None",auto_fan_low:"Low",auto_fan_medium:"Medium",auto_fan_high:"High",auto_fan_boost:"Boost",fan_low:"Low",fan_low_mid:"Low-medium",fan_mid:"Medium",fan_mid_high:"Medium-high",fan_high:"High",fan_mute:"Mute",fan_turbo:"Turbo",fan_none:"None",fan_auto:"Auto",fan_1:"Speed 1",fan_2:"Speed 2",fan_3:"Speed 3",fan_4:"Speed 4",fan_5:"Speed 5",change_message:"Click to change preset",toggle_message:"Click to toggle",auto_start_stop:"Stopped by auto-start/stop",auto_start_stop_enable:"Enable/disable auto-start/stop",auto_start_stop_label:"Auto-start/stop",temp_unavailable:"-",sleep:"Sleeping","New strings for recent edits. Please translate":"-------------------------------------",minutes:"min",room_temp:"Room temp.",outdoor_temp:"Outdoor temp.",safety_warning:"Warning",safety_warning_msg:"Temp. fault",hvac_off_manual:"Turned off manually",hvac_off_auto_start_stop:"Turned off by auto-start/stop",hvac_off_window_detection:"Turned off by window detection",hvac_off_sleep_mode:"Turned off by sleep mode",hvac_off_safety_detection:"Turned off by safety mode",hvac_off_central_mode:"Turned off by central mode",safety_detected:"Safety mode detected",overpowering_detected:"Overpowering detected",target_temp_window_eco:"Target temp.: window eco",target_temp_window_frost:"Target temp.: window frost",target_temp_power:"Target temp.: power",target_temp_central_mode:"Target temp.: central mode",target_temp_activity_detected:"Target temp.: activity detected",target_temp_activity_not_detected:"Target temp.: activity not detected",target_temp_absence_detected:"Target temp.: absence detected",target_temp_timed_preset:"Timed preset active",lock_users_active:"User controls locked",lock_automations_active:"Automation changes locked","messages-button":"Why this state?",recalculation_scheduled:"Underlying update in progress","window-bypass-button":"Toggle window bypass",code_error:"Incorrect code",lock:"Lock",unlock:"Unlock",timed_preset_title:"Duration in minutes (0 = permanent)",timed_preset_active:"Timed preset active",cancel_timed_preset:"Cancel timed preset",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected",increase_temp:"Increase temperature",decrease_temp:"Decrease temperature"},Re={common:Oe,editor:je,extra_states:Ne},Ie=Object.freeze({__proto__:null,common:Oe,default:Re,editor:je,extra_states:Ne}),Ue={version:"Version",current:"Aktuell"},Be={card:{climate:{autoStartStopEnableEntity:"Auto-Start/Stop-Entität",powerEntity:"Entität für den Stromverbrauch",theme:"Thema",theme_classic:"Klassisch",theme_vtherm:"VTherm",theme_uncolored:"Ohne Farbe",theme_gunmalmg:"Gunmalmg",disable_circle:"Kreis deaktivieren",disable_background_color:"Hintergrundfarbe-Ellipse deaktivieren",disable_window:"Fenster deaktivieren",disable_autoStartStop:"Auto-Start/Stop deaktivieren",disable_overpowering:"Überverbrauch deaktivieren",disable_heat:"Heizen deaktivieren",disable_cool:"Kühlen deaktivieren",disable_heat_cool:"Heizen/Kühlen deaktivieren",disable_auto:"Auto deaktivieren",disable_fan_only:"Nur-Lüfter deaktivieren",disable_dry:"Entfeuchten deaktivieren",disable_off:"Aus deaktivieren",disable_menu:"Menü deaktivieren",set_current_as_main:"Zieltemperatur mit aktueller Temperatur tauschen",disable_safety_warning:"Sicherheitsmeldungen deaktivieren",disable_buttons:"Plus/Minus-Buttons deaktivieren",disable_power_infos:"Verbrauchsinformationen deaktivieren",disable_auto_fan_infos:"Auto-Lüfter-Informationen deaktivieren",disable_name:"Name deaktivieren",eco_temperature:"Eco-Temperatur",allow_lock_toggle:"Allow lock/unlock from card"}}},Fe={window_open:"Fenster offen",window_bypass:"Fenster-Bypass aktiviert",night_mode:"Nachtmodus",eco:"Eco",overpowering:"Überverbrauch erkannt",none:"Manuell",comfort:"Komfort",boost:"Boost",frost:"Frostschutz",power:"Lastabwurf",activity:"Aktivität erkannt",presence:"Anwesenheit erkannt",motion:"Bewegung erkannt",auto_regulation_light:"Leicht",auto_regulation_medium:"Mittel",auto_regulation_strong:"Stark",auto_regulation_slow:"Langsam",auto_regulation_expert:"Experte",auto_fan_mode:"Auto-Lüfter",auto_fan_mode_off:"Keine",auto_fan_none:"Keine",auto_fan_low:"Niedrig",auto_fan_medium:"Mittel",auto_fan_high:"Hoch",auto_fan_turbo:"Turbo",fan_low:"Niedrig",fan_low_mid:"Niedrig-mittel",fan_mid:"Mittel",fan_mid_high:"Mittel-hoch",fan_high:"Hoch",fan_mute:"Leise",fan_turbo:"Turbo",fan_none:"Keine",fan_auto:"Auto",change_message:"Klicken zum Ändern des Presets",toggle_message:"Klicken zum Umschalten",auto_start_stop:"Gestoppt durch Auto-Start/Stop",auto_start_stop_enable:"Aktiviert/deaktiviert Auto-Start/Stop",auto_start_stop_label:"Auto-Start/Stop",temp_unavailable:"-",sleep:"Schlafmodus",lock_users_active:"Benutzersteuerung gesperrt",lock_automations_active:"Automatisierungsänderungen gesperrt",lock:"Sperren",unlock:"Entsperren",code_error:"Falscher Code",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected",increase_temp:"Temperatur erhöhen",decrease_temp:"Temperatur verringern"},We={common:Ue,editor:Be,extra_states:Fe},Ze=Object.freeze({__proto__:null,common:Ue,default:We,editor:Be,extra_states:Fe}),Ke={version:"version",current:"Actuelle"},qe={card:{climate:{autoStartStopEnableEntity:"Entité - auto-start/stop",powerEntity:"Entité - puissance consommée",theme:"Thème",theme_classic:"Classique",theme_vtherm:"VTherm",theme_uncolored:"Sans couleur",theme_gunmalmg:"Gunmalmg",menu_system:"Menu système",disable_circle:"Désactiver le cercle",disable_background_color:"Désactiver l'ellipse colorée de fond",disable_window:"Désactiver fenêtre status",disable_autoStartStop:"Désactiver auto-startStop",disable_overpowering:"Désactiver sur-puissance status",disable_heat:"Désactiver mode chauffe",disable_cool:"Désactiver mode clim",disable_heat_cool:"Désactiver mode chauffe/clim",disable_auto:"Désactiver mode auto",disable_fan_only:"Désactiver mode ventilation",disable_dry:"Désactiver mode déshumidification",disable_off:"Désactiver mode arret",disable_sleep:"Désactiver mode endormi",set_current_as_main:"Echanger temperature cible avec temperature locale",disable_safety_warning:"Désactiver sécurité messages",disable_buttons:"Désactiver les boutons +/-",disable_power_infos:"Désactiver les infos de puissance",disable_auto_fan_infos:"Désactiver les infos auto-ventilation",disable_name:"Désactiver le nom",disable_target_icon:"Désactiver l'icône cible",allow_lock_toggle:"Activer le verrouillage/déverrouillage depuis la carte",lock_relock_delay:"Délai de reverrouillage auto (secondes, 0 = désactivé)",disable_presets:"Désactiver les presets",disable_timed_preset:"Désactiver le champ de durée du preset temporisé",use_manual_duration_input:"Permettre la saisie manuelle de la durée"}}},Ge={window_open:"Fenêtre ouverte",window_bypass:"Bypass fenêtre activé",eco:"Eco",overpowering:"Sur-puissance détectée",none:"Manuel",comfort:"Confort",boost:"Boost",frost:"Hors-gel",power:"Délestage",activity:"Activité",presence:"Présence détectée",motion:"Mouvement détecté",auto_regulation_light:"Légère",auto_regulation_medium:"Moyenne",auto_regulation_strong:"Forte",auto_regulation_slow:"Lente",auto_regulation_expert:"Expert",auto_fan_mode:"Auto-fan",auto_fan_mode_off:"Aucun",auto_fan_none:"Aucun",auto_fan_low:"Bas",auto_fan_medium:"Moyen",auto_fan_high:"Haut",auto_fan_turbo:"Turbo",fan_low:"Bas",fan_low_mid:"Bas-moyen",fan_mid:"Moyen",fan_mid_high:"Moyen-haut",fan_high:"Haut",fan_mute:"Silence",fan_turbo:"Turbo",fan_none:"Aucun",fan_auto:"Auto",fan_1:"Vitesse 1",fan_2:"Vitesse 2",fan_3:"Vitesse 3",fan_4:"Vitesse 4",fan_5:"Vitesse 5",change_message:"Clic pour sélectionner le preset",toggle_message:"Clic pour basculer",auto_start_stop:"Stoppé par auto-start/stop",auto_start_stop_enable:"Active/désactive l'auto-start/stop",auto_start_stop_label:"Auto-start/stop",temp_unavailable:"-",sleep:"Endormi","New strings for recent edits. Please translate":"-------------------------------------",minutes:"min",room_temp:"Temp. pièce",outdoor_temp:"Temp. ext.",safety_warning:"Attention",safety_warning_msg:"défaut de temp.",hvac_off_manual:"Eteint manuellement",hvac_off_auto_start_stop:"Eteint par auto-start/stop",hvac_off_window_detection:"Eteint par détection d'ouverture",hvac_off_sleep_mode:"Eteint par le mode endormi",hvac_off_safety_detection:"Eteint par le mode sécurité",hvac_off_central_mode:"Eteint par le mode central",safety_detected:"Mode sécurité détectée",overpowering_detected:"Sur-puissance détectée",target_temp_window_eco:"Temp. cible : fenêtre éco",target_temp_window_frost:"Temp. cible : fenêtre hors-gel",target_temp_power:"Temp. cible : délestage",target_temp_central_mode:"Temp. cible : mode central",target_temp_activity_detected:"Temp. cible : activité détectée",target_temp_activity_not_detected:"Temp. cible : activité non détectée",target_temp_absence_detected:"Temp. cible : absence détectée",target_temp_timed_preset:"Temporisation d'un preset active",lock_users_active:"Verrouillage utilisateurs actif",lock_automations_active:"Verrouillage automations actif","messages-button":"Pourquoi cet état ?",recalculation_scheduled:"Sous-jacent en cours de mise à jour","window-bypass-button":"Basculer le bypass fenêtre",code_error:"Code incorrect",lock:"Verrouiller",unlock:"Déverrouiller",timed_preset_title:"Durée en minutes (0 = permanent)",timed_preset_active:"Preset temporisé actif",cancel_timed_preset:"Annuler le preset temporisé",heating_failure:"Défaut de chauffage détecté",cooling_failure:"Défaut de refroidissement détecté",increase_temp:"Augmenter la température",decrease_temp:"Diminuer la température"},Ye={common:Ke,editor:qe,extra_states:Ge},Xe=Object.freeze({__proto__:null,common:Ke,default:Ye,editor:qe,extra_states:Ge}),Je={version:"Версия",current:"Текущая"},Qe={card:{climate:{autoStartStopEnableEntity:"Сущность автоматического старта/стопа",powerEntity:"Сущность потребления энергии",disable_circle:"Отключить круг",disable_background_color:"Отключить цветной эллипс фона",disable_window:"Отключить окно",disable_autoStartStop:"Отключить автоматический старт/стоп",disable_overpowering:"Отключить перегрузку",disable_heat:"Отключить обогрев",disable_cool:"Отключить охлаждение",disable_heat_cool:"Отключить обогрев/охлаждение",disable_auto:"Отключить авто",disable_fan_only:"Отключить только вентилятор",disable_dry:"Отключить осушение",disable_off:"Отключить режим выключения",disable_sleep:"Отключить спящий режим",disable_menu:"Отключить меню",set_current_as_main:"Поменять местами целевую и текущую температуру",disable_safety_warning:"Отключить сообщения безопасности",disable_buttons:"Отключить кнопки плюс/минус",disable_power_infos:"Отключить информацию о питании",disable_auto_fan_infos:"Отключить информацию автовентилятора",disable_name:"Отключить название",disable_target_icon:"Отключить иконку цели",allow_lock_toggle:"Разрешить блокировку/разблокировку с карты"}}},et={window_open:"Окно открыто",window_bypass:"Обход окна активирован",night_mode:"Ночной режим",eco:"Эко",overpowering:"Обнаружена перегрузка",none:"Ручной",comfort:"Комфорт",boost:"Турбо",frost:"Защита от замерзания",power:"Перегрузка",activity:"Обнаружена активность",presence:"Обнаружено присутствие",motion:"Обнаружено движение",undefined:"Нет",auto_regulation_light:"Легкий",auto_regulation_medium:"Средний",auto_regulation_strong:"Сильный",auto_regulation_slow:"Медленный",auto_regulation_expert:"Экспертный",auto_fan_mode:"Авторежим вентилятора",auto_fan_mode_off:"Нет",auto_fan_none:"Нет",auto_fan_low:"Низкий",auto_fan_medium:"Средний",auto_fan_high:"Высокий",auto_fan_boost:"Турбо",fan_low:"Низкий",fan_low_mid:"Низкий-средний",fan_mid:"Средний",fan_mid_high:"Средний-высокий",fan_high:"Высокий",fan_mute:"Тихий",fan_turbo:"Турбо",fan_none:"Нет",fan_auto:"Авто",change_message:"Клик для смены предустановки",toggle_message:"Клик для переключения",auto_start_stop:"Остановлено авто-старт/стопом",auto_start_stop_enable:"Включить/отключить авто-старт/стоп",auto_start_stop_label:"Авто-старт/стоп",temp_unavailable:"-",sleep:"Сон",minutes:"мин",room_temp:"Температура в помещении",outdoor_temp:"Уличная температура",lock_users_active:"Пользовательское управление заблокировано",lock_automations_active:"Изменения автоматизации заблокированы",code_error:"Неверный код",lock:"Блокировать",unlock:"Разблокировать",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},tt="Тема",it="Классический",ot="VTherm",at="Без цвета",st="Gunmalmg",nt={common:Je,editor:Qe,extra_states:et,theme:tt,theme_classic:it,theme_vtherm:ot,theme_uncolored:at,theme_gunmalmg:st},rt=Object.freeze({__proto__:null,common:Je,default:nt,editor:Qe,extra_states:et,theme:tt,theme_classic:it,theme_gunmalmg:st,theme_uncolored:at,theme_vtherm:ot}),lt={version:"wersja",current:"aktualna"},ct={card:{climate:{allow_lock_toggle:"Pozwól na blokowanie/odblokowanie z karty",autoStartStopEnableEntity:"Encja autoSTART/autoSTOP",powerEntity:"Encja poboru mocy",disable_circle:"Wyłącz koło",disable_background_color:"Wyłącz kolorową elipsę tła",disable_window:"Wyłącz okno",disable_autoStartStop:"Wyłącz autoSTART/autoSTOP",disable_overpowering:"Wyłącz przeciążenie",disable_heat:"Wyłącz tryb grzania",disable_cool:"Wyłącz tryb chłodzenia",disable_heat_cool:"Wyłącz tryb 'grzanie/chłodzenie'",disable_auto:"Wyłącz tryb automatyczny",disable_fan_only:"Wyłącz tryb wentylatora",disable_dry:"Wyłącz tryb osuszania",disable_off:"Wyłącz tryb 'OFF'",disable_sleep:"Wyłącz tryb uśpienia",disable_menu:"Wyłącz menu",set_current_as_main:"Zamień temperaturę docelową z temperaturą pomieszczenia",disable_safety_warning:"Wyłącz ostrzeżenie bezpieczeństwa",disable_buttons:"Wyłącz przyciski +/- (plus/minus)",disable_power_infos:"Wyłącz komunikaty mocowe",disable_auto_fan_infos:"Wyłącz komunikaty autowentylacji",disable_name:"Wyłącz nazwę",disable_target_icon:"Wyłącz ikonę"}}},dt={window_open:"Otwarte okno",window_bypass:"Załączone pomijanie okien",night_mode:"Tryb nocny",eco:"Tryb Eko",overpowering:"Wykryte przeciążenie",none:"Ręczny",theme:"Motyw",theme_classic:"Klasyczny",theme_vtherm:"VTherm",theme_uncolored:"Bez koloru",theme_gunmalmg:"Gunmalmg",comfort:"Komfort",boost:"Boost",frost:"Ochrona przed mrozem",power:"Przeciążenie",activity:"Wykryto aktywność",presence:"Wykryto obecność",motion:"Wykryto ruch",undefined:"Brak",auto_regulation_light:"Słaby",auto_regulation_medium:"Średni",auto_regulation_strong:"Silny",auto_regulation_slow:"Powolny",auto_regulation_expert:"Ekspert",auto_fan_mode:"Autowentylacja",auto_fan_mode_off:"Wyłączony",auto_fan_none:"Brak",auto_fan_low:"Niski",auto_fan_medium:"Średni",auto_fan_high:"Wysoki",auto_fan_boost:"Boost",fan_low:"Niski",fan_low_mid:"Niskośredni",fan_mid:"Średni",fan_mid_high:"Średniowysoki",fan_high:"Wysoki",fan_mute:"Cicho",fan_turbo:"Turbo",fan_none:"Brak",fan_auto:"Auto",change_message:"Kliknij aby zmienić preset",toggle_message:"Kliknij aby przełączyć",auto_start_stop:"Zatrzymany przez autoSTART/autoSTOP",auto_start_stop_enable:"Załącz/wyłącz autoSTART/autoSTOP",auto_start_stop_label:"AutoSTART/autoSTOP",temp_unavailable:"-",sleep:"Uśpienie","New strings for recent edits. Please translate":"-------------------------------------",minutes:"min",room_temp:"Temp. pomieszczenia",outdoor_temp:"Temp. zewnętrzna",safety_warning:"Ostrzeżenie",safety_warning_msg:"Błąd temperatury",hvac_off_manual:"Wyłączony ręcznie",hvac_off_auto_start_stop:"Wyłączony przez autoSTART/autoSTOP",hvac_off_window_detection:"Wyłączony prze otwarcie okna",hvac_off_sleep_mode:"Wyłączony przez tryb uśpienia",hvac_off_safety_detection:"Wyłączony przez tryb bezpieczny",hvac_off_central_mode:"Wyłączony przez tryb główny",safety_detected:"Wykryty tryb bezpieczny",overpowering_detected:"Wykryte przeciążenie",target_temp_window_eco:"Docelowa temp.: Eko okno",target_temp_window_frost:"Docelowa temp.: ochr. przed mrozem okno",target_temp_power:"Docelowa temp.: moc",target_temp_central_mode:"Docelowa temp.: tryb główny",target_temp_activity_detected:"Docelowa temp.: wykryta aktywność",target_temp_activity_not_detected:"Docelowa temp.: brak aktywnści",target_temp_absence_detected:"Docelowa temp.: wykryta nieobecność","messages-button":"Dlaczego taki stan?",recalculation_scheduled:"Aktualizacja urządzeń w toku","window-bypass-button":"Przełącz pomijanie okna",lock_users_active:"Sterowanie użytkownika zablokowane",lock_automations_active:"Zmiany automatyzacji zablokowane",code_error:"Błędny kod",lock:"Zablokuj",unlock:"Odblokuj",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},ht={common:lt,editor:ct,extra_states:dt},ut=Object.freeze({__proto__:null,common:lt,default:ht,editor:ct,extra_states:dt}),mt={version:"verzia",current:"aktuálny"},_t={card:{climate:{disable_window:"Zakázať okno",disable_overpowering:"Zakázať leto",disable_heat:"Zakázať kúrenie",disable_cool:"Zakázať chladenie",disable_heat_cool:"Zakázať kúrenie/chladenie",disable_auto:"Zakázat automatic",disable_fan_only:"Zakázať režim ventilátora",disable_dry:"Zakázať sušenie",disable_off:"Vypnúť",disable_menu:"Zakázať menu",disable_safety_warning:"Zakázať bezpečnostné správy",disable_buttons:"Zakázať plus/mínus tlačidlá",eco_temperature:"Eco teplota",set_current_as_main:"Vymeňte cieľ za miesta s aktuálnou teplotou",allow_lock_toggle:"Povoliť uzamknutie/odomknutie z karty"}}},pt={window_open:"Okno otvorené",night_mode:"Nočný mód",eco:"Eco",overpowering:"Leto",lock_users_active:"Ovládanie používateľa zamknuté",lock_automations_active:"Zmeny automatizácie zamknuté",code_error:"Chybný kód",lock:"Zamknúť",unlock:"Odomknúť",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},gt="Téma",vt="Klasický",ft="VTherm",bt="Bez farby",yt="Gunmalmg",wt={common:mt,editor:_t,extra_states:pt,theme:gt,theme_classic:vt,theme_vtherm:ft,theme_uncolored:bt,theme_gunmalmg:yt},kt={version:"Verzió",current:"Aktuális"},$t={card:{climate:{disable_window:"Ablak kikapcsolás",disable_overpowering:"Nyár kikapcsolás",disable_heat:"Fűtés kikacsolás",disable_cool:"Hűtés kikapcsolás",disable_heat_cool:"Fűtés/Hűtés kikapcsolás",disable_auto:"Auto kikapcsolás",disable_fan_only:"Csak ventillátor kikapcsolás",disable_dry:"Szárítás kikapcsolás",disable_off:"Kikapcsolás inaktiválás",eco_temperature:"Eco hőmérséklet",set_current_as_main:"Aktuális hőmérséklet használata",allow_lock_toggle:"Allow lock/unlock from card"}}},xt={window_open:"Ablak nyitva",night_mode:"Éjszakai mód",eco:"Eco",overpowering:"Nyár",lock_users_active:"Felhasználói vezérlők zárolva",lock_automations_active:"Automatizálási változtatások zárolva",code_error:"Rossz kód",lock:"Zárolás",unlock:"Feloldás",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},At="Téma",Ct="Klasszikus",St="VTherm",Tt="Színtelen",Lt="Gunmalmg",Mt={common:kt,editor:$t,extra_states:xt,theme:At,theme_classic:Ct,theme_vtherm:St,theme_uncolored:Tt,theme_gunmalmg:Lt},Vt={version:"version",current:"nuværende"},Et={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},zt={window_open:"Vindue åben",night_mode:"Nattilstand",eco:"Eco",overpowering:"Overpowering",lock_users_active:"Brugerkontroller låst",lock_automations_active:"Automatiske ændringer låst",code_error:"Forkert kode",lock:"Lås",unlock:"Lås op",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},Pt="Tema",Ht="Klassisk",Dt="VTherm",Ot="Ufarvet",jt="Gunmalmg",Nt={common:Vt,editor:Et,extra_states:zt,theme:Pt,theme_classic:Ht,theme_vtherm:Dt,theme_uncolored:Ot,theme_gunmalmg:jt},Rt={version:"version",current:"Actual"},It={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},Ut={window_open:"Ventana abierta",night_mode:"Modo noche",eco:"Eco",overpowering:"Verano",lock_users_active:"Controles de usuario bloqueados",lock_automations_active:"Cambios de automatización bloqueados",code_error:"Código incorrecto",lock:"Bloquear",unlock:"Desbloquear",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected",increase_temp:"Aumentar la temperatura",decrease_temp:"Disminuir la temperatura"},Bt="Tema",Ft="Clásico",Wt="VTherm",Zt="Sin color",Kt="Gunmalmg",qt={common:Rt,editor:It,extra_states:Ut,theme:Bt,theme_classic:Ft,theme_vtherm:Wt,theme_uncolored:Zt,theme_gunmalmg:Kt},Gt={version:"versiyon",current:"şimdiki"},Yt={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},Xt={window_open:"Pencere açık",night_mode:"Gece modu",eco:"Eco",overpowering:"Yaz",lock_users_active:"Kullanıcı kontrolleri kilitlendi",lock_automations_active:"Otomasyon değişiklikleri kilitlendi",code_error:"Hatalı kod",lock:"Kilitle",unlock:"Kilidi aç",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},Jt="Tema",Qt="Klasik",ei="VTherm",ti="Renksiz",ii="Gunmalmg",oi={common:Gt,editor:Yt,extra_states:Xt,theme:Jt,theme_classic:Qt,theme_vtherm:ei,theme_uncolored:ti,theme_gunmalmg:ii},ai={version:"versione",current:"attuale"},si={card:{climate:{autoStartStopEnableEntity:"Entità di avvio/arresto automatico",powerEntity:"Entità di consumo energetico",disable_circle:"Disabilita cerchio",disable_background_color:"Disabilita ellisse colore di sfondo",disable_window:"Disabilita la finestra",disable_autoStartStop:"Disabilita Avvio/Arresto automatico",disable_overpowering:"Disabilita la sovralimentazione",disable_heat:"Disabilita Riscalda",disable_cool:"Disabilita Raffresca",disable_heat_cool:"Disabilita Riscalda/Raffredda",disable_auto:"Disabilita Automatico",disable_fan_only:"Disabilita Ventilazione",disable_dry:"Disabilita Deumidifica",disable_off:"Disabilita off",disable_sleep:"Disabilita modo riposo",disable_menu:"Disabilita menu",set_current_as_main:"Scambia Setpoint con Temperatura ambiente",disable_safety_warning:"Disabilita i messaggi di sicurezza",disable_buttons:"Disabilita pulsanti Più/Meno",disable_power_infos:"Disabilita Info Potenza",disable_auto_fan_infos:"Disabilita Info auto-fan",disable_name:"Disabilita nome",disable_target_icon:"Disabilita  icona obbiettivo",allow_lock_toggle:"Allow lock/unlock from card",disable_timed_preset:"Disattiva immissione durata preimpostata",use_manual_duration_input:"Consenti l'inserimento manuale della durata invece della selezione",theme:"Tema",theme_classic:"Classico",theme_vtherm:"VTherm",theme_uncolored:"Senza colore",theme_gunmalmg:"Gunmalmg"}}},ni={window_open:"Finestra aperta",window_bypass:"Bypass finestra Attivo",night_mode:"Modalità notte",eco:"Eco",overpowering:"Rilevata Sovrapotenza",none:"Manuale",comfort:"Comfort",boost:"Boost",frost:"Frost",power:"Sovrapotenza",activity:"Rilevata Attività",presence:"Rilevata Presenza",motion:"Rilevato motimento",undefined:"Nulla",auto_regulation_light:"Leggero",auto_regulation_medium:"Medio",auto_regulation_strong:"Forte",auto_regulation_slow:"Lento",auto_regulation_expert:"Esperto",auto_fan_mode:"Auto-fan",auto_fan_mode_off:"Nulla",auto_fan_none:"Nulla",auto_fan_low:"Basso",auto_fan_medium:"Medio",auto_fan_high:"Alto",auto_fan_boost:"Boost",fan_low:"Basso",fan_low_mid:"Medio-basso",fan_mid:"Medio",fan_mid_high:"Medio-alto",fan_high:"Alto",fan_mute:"Silenzioso",fan_turbo:"Turbo",fan_none:"Nulla",fan_auto:"Auto",change_message:"Click per cambio preimpostazione",toggle_message:"Click per commutare",auto_start_stop:"Fermato da auto-start/stop",auto_start_stop_enable:"Abilita/disabilita auto-start/stop",auto_start_stop_label:"Auto-start/stop",temp_unavailable:"-",sleep:"Riposo","New strings for recent edits. Please translate":"-------------------------------------",minutes:"min",room_temp:"Temp. ambiente",outdoor_temp:"Temp. esterna",safety_warning:"Avviso",safety_warning_msg:"Guasto Temp.",hvac_off_manual:"Spento manualmente",hvac_off_auto_start_stop:"Spento da auto-start/stop",hvac_off_window_detection:"Spento da rilevamento finestra",hvac_off_sleep_mode:"Spento da modo notte",hvac_off_safety_detection:"Spento da modalità sicurezza",hvac_off_central_mode:"Spento da modalità centralizzato",safety_detected:"Modalità sicurezza rilavata",overpowering_detected:"Sovrapotenza rilevata",target_temp_window_eco:"Temp. impostata: window eco",target_temp_window_frost:"Temp. impostata: window freddo",target_temp_power:"Temp. impostata: power",target_temp_central_mode:"Temp. impostata: modalità centralizzata",target_temp_activity_detected:"Temp. impostata: rilevata atività",target_temp_activity_not_detected:"Temp. impostata: attività non rilevata",target_temp_absence_detected:"Temp. impostata: assenza rilevata",lock_users_active:"Controlli utente bloccati",lock_automations_active:"Modifiche automazioni bloccate","messages-button":"Perchè questo stato?",recalculation_scheduled:"Aggiornamento sottostanti in corso","window-bypass-button":"Commuta bypass finestra",code_error:"Codice errato",lock:"Blocca",unlock:"Sblocca",timed_preset_title:"Durata in minuti (0 = permanente)",timed_preset_active:"Preimpostazione temporizzata attiva",cancel_timed_preset:"Disattiva Preimpostazione temporizzata",heating_failure:"Rilevato guasto al riscaldamento",cooling_failure:"Rilevato guasto al raffrescamento",increase_temp:"Aumenta la temperatura",decrease_temp:"Diminuisci la temperatura"},ri={common:ai,editor:si,extra_states:ni},li={version:"versão",current:"actual"},ci={card:{climate:{disable_window:"Desactivar Janela",disable_overpowering:"Desactivar Verão",disable_heat:"Desactivar Aquecimento",disable_cool:"Desactivar Arrefecimento",disable_heat_cool:"Desactivar Aquecimento/Arrefecimento",disable_auto:"Desactivar Auto",disable_fan_only:"Desactivar Ventilação",disable_dry:"Desactivar Secagem",disable_off:"Desactivar Off",eco_temperature:"Modo Eco",set_current_as_main:"Mudar para a temperatura local actual",theme:"Tema",theme_classic:"Clássico",theme_vtherm:"VTherm",theme_uncolored:"Sem cor",theme_gunmalmg:"Gunmalmg",allow_lock_toggle:"Allow lock/unlock from card"}}},di={window_open:"Janela Aberta",night_mode:"Modo Noturno",eco:"Eco",overpowering:"Verão",lock_users_active:"Controlos de utilizador bloqueados",lock_automations_active:"Alterações de automação bloqueadas",code_error:"Código incorreto",lock:"Bloquear",unlock:"Desbloquear",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},hi={common:li,editor:ci,extra_states:di},ui={version:"版本",current:"当前"},mi={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},_i={window_open:"窗户打开",night_mode:"夜间模式",eco:"节能",overpowering:"夏季",lock_users_active:"用户控制已锁定",lock_automations_active:"自动化更改已锁定",code_error:"代码错误",lock:"锁定",unlock:"解锁",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},pi="VTherm",gi="Gunmalmg",vi={common:ui,editor:mi,extra_states:_i,theme:"主题",theme_classic:"经典",theme_vtherm:pi,theme_uncolored:"无颜色",theme_gunmalmg:gi},fi={version:"версія",current:"поточний"},bi={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},yi={window_open:"Вікно відчинено",night_mode:"Нічний режим",eco:"Економія",overpowering:"Літо",lock_users_active:"Керування користувача заблоковано",lock_automations_active:"Зміни автоматизації заблоковані",code_error:"Невірний код",lock:"Блокувати",unlock:"Розблокувати",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},wi="Тема",ki="Класичний",$i="VTherm",xi="Без кольору",Ai="Gunmalmg",Ci={common:fi,editor:bi,extra_states:yi,theme:wi,theme_classic:ki,theme_vtherm:$i,theme_uncolored:xi,theme_gunmalmg:Ai},Si={version:"έκδοση",current:"τρέχουσα"},Ti={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},Li={window_open:"Παράθυρο ανοικτό",night_mode:"Λειτουργία νυκτός",eco:"Εξοικονόμηση",overpowering:"Καλοκαίρι",lock_users_active:"Έλεγχοι χρήστη κλειδωμένοι",lock_automations_active:"Αλλαγές αυτοματισμών κλειδωμένες",code_error:"Λάθος κωδικός",lock:"Κλείδωμα",unlock:"Ξεκλείδωμα",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},Mi="Θέμα",Vi="Κλασικό",Ei="VTherm",zi="Χωρίς χρώμα",Pi="Gunmalmg",Hi={common:Si,editor:Ti,extra_states:Li,theme:Mi,theme_classic:Vi,theme_vtherm:Ei,theme_uncolored:zi,theme_gunmalmg:Pi},Di={version:"versie",current:"huidig"},Oi={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},ji={window_open:"Raam open",night_mode:"Nacht modus",eco:"Eco",overpowering:"Zomer",lock_users_active:"Gebruikersbediening vergrendeld",lock_automations_active:"Automatisatie wijzigingen vergrendeld",code_error:"Foute code",lock:"Vergrendelen",unlock:"Ontgrendelen",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},Ni="Thema",Ri="Classic",Ii="VTherm",Ui="Ongekleurd",Bi="Gunmalmg",Fi={common:Di,editor:Oi,extra_states:ji,theme:Ni,theme_classic:Ri,theme_vtherm:Ii,theme_uncolored:Ui,theme_gunmalmg:Bi},Wi={version:"versjon",current:"nåværende"},Zi={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},Ki={window_open:"Vindu åpent",night_mode:"Nattmodus",eco:"Eco",overpowering:"Sommer",lock_users_active:"Brukerkontroller låst",lock_automations_active:"Automatiseringsendringer låst",code_error:"Feil kode",lock:"Lås",unlock:"Lås opp",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},qi="Tema",Gi="Klassisk",Yi="VTherm",Xi="Uten farge",Ji="Gunmalmg",Qi={common:Wi,editor:Zi,extra_states:Ki,theme:qi,theme_classic:Gi,theme_vtherm:Yi,theme_uncolored:Xi,theme_gunmalmg:Ji},eo={version:"verze",current:"aktuální"},to={card:{climate:{disable_window:"Zakázat okno",disable_overpowering:"Zakázat léto",disable_heat:"Zakázat topení",disable_cool:"Zakázat chlazení",disable_heat_cool:"Zakázat topení/chlazení",disable_auto:"Zakázať automatic",disable_fan_only:"Zakázat pouze ventilátor",disable_dry:"Zakázat sušení",disable_off:"Zakázat vypnuto",disable_menu:"Zakázat menu",disable_safety_warning:"Zakázat bezpečnostní oznámení",disable_buttons:"Zakázat tlačítka plus/minus",eco_temperature:"Eco teplota",set_current_as_main:"Prohodit místa cílovoé a aktáalní teploty",allow_lock_toggle:"Allow lock/unlock from card"}}},io={window_open:"okno otevřeno",night_mode:"Noční režim",eco:"Eco",overpowering:"Léto",lock_users_active:"Uživatelské ovládání zamčeno",lock_automations_active:"Změny automatizace zamčeny",code_error:"Chybný kód",lock:"Zamknout",unlock:"Odemknout",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},oo="Téma",ao="Klasické",so="VTherm",no="Bez barvy",ro="Gunmalmg",lo={common:eo,editor:to,extra_states:io,theme:oo,theme_classic:ao,theme_vtherm:so,theme_uncolored:no,theme_gunmalmg:ro},co={version:"različica",current:"trenutno"},ho={card:{climate:{allow_lock_toggle:"Dovoli zaklepanje/odklepanje iz kartice"}}},uo={window_open:"Okno odprto",night_mode:"Nočni način",eco:"Eko",overpowering:"Poletje",lock_users_active:"Uporabniške kontrole zaklenjene",lock_automations_active:"Spremembe avtomatizacije zaklenjene",code_error:"Napačna koda",lock:"Zakleni",unlock:"Odkleni",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},mo="Tema",_o="Klasična",po="VTherm",go="Brez barve",vo="Gunmalmg",fo={common:co,editor:ho,extra_states:uo,theme:mo,theme_classic:_o,theme_vtherm:po,theme_uncolored:go,theme_gunmalmg:vo},bo={version:"version",current:"Nuvarande"},yo={window_open:"Fönster öppet",night_mode:"Nattläge",eco:"Eco",overpowering:"Sommar",lock_users_active:"Användarkontroller låsta",lock_automations_active:"Automationsändringar låsta",code_error:"Fel kod",lock:"Lås",unlock:"Lås upp",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},wo="Tema",ko="Klassisk",$o="VTherm",xo="Omdfärgad",Ao="Gunmalmg",Co={common:bo,extra_states:yo,theme:wo,theme_classic:ko,theme_vtherm:$o,theme_uncolored:xo,theme_gunmalmg:Ao},So={version:"версия",currrent:"текущий"},To={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},Lo={window_open:"Отворен прозорец",night_mode:"Нощен режим",eco:"Екологичен режим",overpowering:"Лято",lock_users_active:"Потребителските контроли са заключени",lock_automations_active:"Промените от автоматизации са заключени",code_error:"Грешен код",lock:"Заключване",unlock:"Отключване",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},Mo="Тема",Vo="Класически",Eo="VTherm",zo="Без цвят",Po="Gunmalmg",Ho={common:So,editor:To,extra_states:Lo,theme:Mo,theme_classic:Vo,theme_vtherm:Eo,theme_uncolored:zo,theme_gunmalmg:Po},Do={version:"version",current:"Nykyinen"},Oo={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},jo={window_open:"Ikkuna auki",night_mode:"Yötila",eco:"Eco",overpowering:"Kesä",lock_users_active:"Käyttäjän säädöt lukittu",lock_automations_active:"Automaation muutokset lukittu",code_error:"Virheellinen koodi",lock:"Lukitse",unlock:"Avaa lukitus",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},No="Teema",Ro="Klassinen",Io="VTherm",Uo="Väritön",Bo="Gunmalmg",Fo={common:Do,editor:Oo,extra_states:jo,theme:No,theme_classic:Ro,theme_vtherm:Io,theme_uncolored:Uo,theme_gunmalmg:Bo},Wo={version:"versiune",current:"curent"},Zo={card:{climate:{allow_lock_toggle:"Permite blocarea/deblocarea din card"}}},Ko={window_open:"Fereastră deschisă",night_mode:"Mod noapte",eco:"Eco",overpowering:"Vară",lock_users_active:"Comenzi utilizator blocate",lock_automations_active:"Modificări automatizări blocate",code_error:"Cod incorect",lock:"Blocare",unlock:"Deblocare",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},qo="Temă",Go="Clasic",Yo="VTherm",Xo="Fără culoare",Jo="Gunmalmg",Qo={common:Wo,editor:Zo,extra_states:Ko,theme:qo,theme_classic:Go,theme_vtherm:Yo,theme_uncolored:Xo,theme_gunmalmg:Jo},ea={version:"versió",current:"Actual"},ta={card:{climate:{allow_lock_toggle:"Allow lock/unlock from card"}}},ia={window_open:"Finestra oberta",night_mode:"Mode nocturn",eco:"Eco",overpowering:"Estiu",lock_users_active:"Controls d'usuari bloquejats",lock_automations_active:"Canvis d'automatització bloquejats",code_error:"Codi incorrecte",lock:"Bloquejar",unlock:"Desbloquejar",heating_failure:"Heating failure detected",cooling_failure:"Cooling failure detected"},oa="Tema",aa="Clàssic",sa="VTherm",na="Sense color",ra="Gunmalmg",la={common:ea,editor:ta,extra_states:ia,theme:oa,theme_classic:aa,theme_vtherm:sa,theme_uncolored:na,theme_gunmalmg:ra};const ca={en:Ie,de:Ze,fr:Xe,ru:rt,sk:Object.freeze({__proto__:null,common:mt,default:wt,editor:_t,extra_states:pt,theme:gt,theme_classic:vt,theme_gunmalmg:yt,theme_uncolored:bt,theme_vtherm:ft}),hu:Object.freeze({__proto__:null,common:kt,default:Mt,editor:$t,extra_states:xt,theme:At,theme_classic:Ct,theme_gunmalmg:Lt,theme_uncolored:Tt,theme_vtherm:St}),pl:ut,da:Object.freeze({__proto__:null,common:Vt,default:Nt,editor:Et,extra_states:zt,theme:Pt,theme_classic:Ht,theme_gunmalmg:jt,theme_uncolored:Ot,theme_vtherm:Dt}),es:Object.freeze({__proto__:null,common:Rt,default:qt,editor:It,extra_states:Ut,theme:Bt,theme_classic:Ft,theme_gunmalmg:Kt,theme_uncolored:Zt,theme_vtherm:Wt}),tr:Object.freeze({__proto__:null,common:Gt,default:oi,editor:Yt,extra_states:Xt,theme:Jt,theme_classic:Qt,theme_gunmalmg:ii,theme_uncolored:ti,theme_vtherm:ei}),it:Object.freeze({__proto__:null,common:ai,default:ri,editor:si,extra_states:ni}),pt:Object.freeze({__proto__:null,common:li,default:hi,editor:ci,extra_states:di}),cn:Object.freeze({__proto__:null,common:ui,default:vi,editor:mi,extra_states:_i,theme:"主题",theme_classic:"经典",theme_gunmalmg:gi,theme_uncolored:"无颜色",theme_vtherm:pi}),uk:Object.freeze({__proto__:null,common:fi,default:Ci,editor:bi,extra_states:yi,theme:wi,theme_classic:ki,theme_gunmalmg:Ai,theme_uncolored:xi,theme_vtherm:$i}),el:Object.freeze({__proto__:null,common:Si,default:Hi,editor:Ti,extra_states:Li,theme:Mi,theme_classic:Vi,theme_gunmalmg:Pi,theme_uncolored:zi,theme_vtherm:Ei}),nl:Object.freeze({__proto__:null,common:Di,default:Fi,editor:Oi,extra_states:ji,theme:Ni,theme_classic:Ri,theme_gunmalmg:Bi,theme_uncolored:Ui,theme_vtherm:Ii}),no:Object.freeze({__proto__:null,common:Wi,default:Qi,editor:Zi,extra_states:Ki,theme:qi,theme_classic:Gi,theme_gunmalmg:Ji,theme_uncolored:Xi,theme_vtherm:Yi}),cs:Object.freeze({__proto__:null,common:eo,default:lo,editor:to,extra_states:io,theme:oo,theme_classic:ao,theme_gunmalmg:ro,theme_uncolored:no,theme_vtherm:so}),sl:Object.freeze({__proto__:null,common:co,default:fo,editor:ho,extra_states:uo,theme:mo,theme_classic:_o,theme_gunmalmg:vo,theme_uncolored:go,theme_vtherm:po}),sv:Object.freeze({__proto__:null,common:bo,default:Co,extra_states:yo,theme:wo,theme_classic:ko,theme_gunmalmg:Ao,theme_uncolored:xo,theme_vtherm:$o}),bg:Object.freeze({__proto__:null,common:So,default:Ho,editor:To,extra_states:Lo,theme:Mo,theme_classic:Vo,theme_gunmalmg:Po,theme_uncolored:zo,theme_vtherm:Eo}),fi:Object.freeze({__proto__:null,common:Do,default:Fo,editor:Oo,extra_states:jo,theme:No,theme_classic:Ro,theme_gunmalmg:Bo,theme_uncolored:Uo,theme_vtherm:Io}),ro:Object.freeze({__proto__:null,common:Wo,default:Qo,editor:Zo,extra_states:Ko,theme:qo,theme_classic:Go,theme_gunmalmg:Jo,theme_uncolored:Xo,theme_vtherm:Yo}),ca:Object.freeze({__proto__:null,common:ea,default:la,editor:ta,extra_states:ia,theme:oa,theme_classic:aa,theme_gunmalmg:ra,theme_uncolored:na,theme_vtherm:sa})},da="en";function ha({hass:e,string:t,search:i="",replace:o=""}){var a;const s=null!==(a=null==e?void 0:e.locale.language)&&void 0!==a?a:da;let n;try{n=t.split(".").reduce(((e,t)=>e[t]),ca[s])}catch(e){n=t.split(".").reduce(((e,t)=>e[t]),ca.en)}return void 0===n&&(n=t.split(".").reduce(((e,t)=>e[t]),ca.en)),""!==i&&""!==o&&(n=n.replace(i,o)),n}function ua(e,t){try{return e.split(".").reduce(((e,t)=>e[t]),ca[t])}catch(e){return}}function ma(e){return function(t){var i;let o=ua(t,null!==(i=null==e?void 0:e.locale.language)&&void 0!==i?i:da);return o||(o=ua(t,da)),null!=o?o:t}}var _a,pa,ga=Number.isNaN||function(e){return"number"==typeof e&&e!=e};function va(e,t){if(e.length!==t.length)return!1;for(var i=0;i<e.length;i++)if(o=e[i],a=t[i],!(o===a||ga(o)&&ga(a)))return!1;var o,a;return!0}function fa(e,t){void 0===t&&(t=va);var i=null;function o(){for(var o=[],a=0;a<arguments.length;a++)o[a]=arguments[a];if(i&&i.lastThis===this&&t(o,i.lastArgs))return i.lastResult;var s=e.apply(this,o);return i={lastResult:s,lastArgs:o,lastThis:this},s}return o.clear=function(){i=null},o}fa((e=>new Intl.DateTimeFormat(e.language,{weekday:"long",month:"long",day:"numeric"}))),fa((e=>new Intl.DateTimeFormat(e.language,{year:"numeric",month:"long",day:"numeric"}))),fa((e=>new Intl.DateTimeFormat(e.language,{year:"numeric",month:"numeric",day:"numeric"}))),fa((e=>new Intl.DateTimeFormat(e.language,{day:"numeric",month:"short"}))),fa((e=>new Intl.DateTimeFormat(e.language,{month:"long",year:"numeric"}))),fa((e=>new Intl.DateTimeFormat(e.language,{month:"long"}))),fa((e=>new Intl.DateTimeFormat(e.language,{year:"numeric"}))),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(_a||(_a={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(pa||(pa={}));const ba=fa((e=>{if(e.time_format===pa.language||e.time_format===pa.system){const t=e.time_format===pa.language?e.language:void 0,i=(new Date).toLocaleString(t);return i.includes("AM")||i.includes("PM")}return e.time_format===pa.am_pm}));fa((e=>new Intl.DateTimeFormat("en"!==e.language||ba(e)?e.language:"en-u-hc-h23",{year:"numeric",month:"long",day:"numeric",hour:ba(e)?"numeric":"2-digit",minute:"2-digit",hour12:ba(e)}))),fa((e=>new Intl.DateTimeFormat("en"!==e.language||ba(e)?e.language:"en-u-hc-h23",{year:"numeric",month:"long",day:"numeric",hour:ba(e)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hour12:ba(e)}))),fa((e=>new Intl.DateTimeFormat("en"!==e.language||ba(e)?e.language:"en-u-hc-h23",{year:"numeric",month:"numeric",day:"numeric",hour:"numeric",minute:"2-digit",hour12:ba(e)}))),fa((e=>new Intl.DateTimeFormat("en"!==e.language||ba(e)?e.language:"en-u-hc-h23",{hour:"numeric",minute:"2-digit",hour12:ba(e)}))),fa((e=>new Intl.DateTimeFormat("en"!==e.language||ba(e)?e.language:"en-u-hc-h23",{hour:ba(e)?"numeric":"2-digit",minute:"2-digit",second:"2-digit",hour12:ba(e)}))),fa((e=>new Intl.DateTimeFormat("en"!==e.language||ba(e)?e.language:"en-u-hc-h23",{weekday:"long",hour:ba(e)?"numeric":"2-digit",minute:"2-digit",hour12:ba(e)})));const ya=(e,t,i,o)=>{o=o||{},i=null==i?{}:i;const a=new Event(t,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});return a.detail=i,e.dispatchEvent(a),a},wa=(e,t,i)=>Math.min(Math.max(e,t),i),ka=(e,t,i)=>{const o=t?(e=>{switch(e.number_format){case _a.comma_decimal:return["en-US","en"];case _a.decimal_comma:return["de","es","it"];case _a.space_comma:return["fr","sv","cs"];case _a.system:return;default:return e.language}})(t):void 0;if(Number.isNaN=Number.isNaN||function e(t){return"number"==typeof t&&e(t)},(null==t?void 0:t.number_format)!==_a.none&&!Number.isNaN(Number(e))&&Intl)try{return new Intl.NumberFormat(o,$a(e,i)).format(Number(e))}catch(t){return console.error(t),new Intl.NumberFormat(void 0,$a(e,i)).format(Number(e))}return"string"==typeof e?e:`${((e,t=2)=>Math.round(e*10**t)/10**t)(e,null==i?void 0:i.maximumFractionDigits).toString()}${"currency"===(null==i?void 0:i.style)?` ${i.currency}`:""}`},$a=(e,t)=>{const i=Object.assign({maximumFractionDigits:2},t);if("string"!=typeof e)return i;if(!t||!t.minimumFractionDigits&&!t.maximumFractionDigits){const t=e.indexOf(".")>-1?e.split(".")[1].length:0;i.minimumFractionDigits=t,i.maximumFractionDigits=t}return i};class xa extends TypeError{constructor(e,t){let i;const{message:o,explanation:a,...s}=e,{path:n}=e,r=0===n.length?o:`At path: ${n.join(".")} -- ${o}`;super(a??r),null!=a&&(this.cause=r),Object.assign(this,s),this.name=this.constructor.name,this.failures=()=>i??(i=[e,...t()])}}function Aa(e){return"object"==typeof e&&null!=e}function Ca(e){return"symbol"==typeof e?e.toString():"string"==typeof e?JSON.stringify(e):`${e}`}function Sa(e,t,i,o){if(!0===e)return;!1===e?e={}:"string"==typeof e&&(e={message:e});const{path:a,branch:s}=t,{type:n}=i,{refinement:r,message:l=`Expected a value of type \`${n}\`${r?` with refinement \`${r}\``:""}, but received: \`${Ca(o)}\``}=e;return{value:o,type:n,refinement:r,key:a[a.length-1],path:a,branch:s,...e,message:l}}function*Ta(e,t,i,o){(function(e){return Aa(e)&&"function"==typeof e[Symbol.iterator]})(e)||(e=[e]);for(const a of e){const e=Sa(a,t,i,o);e&&(yield e)}}function*La(e,t,i={}){const{path:o=[],branch:a=[e],coerce:s=!1,mask:n=!1}=i,r={path:o,branch:a};if(s&&(e=t.coercer(e,r),n&&"type"!==t.type&&Aa(t.schema)&&Aa(e)&&!Array.isArray(e)))for(const i in e)void 0===t.schema[i]&&delete e[i];let l="valid";for(const o of t.validator(e,r))o.explanation=i.message,l="not_valid",yield[o,void 0];for(let[c,d,h]of t.entries(e,r)){const t=La(d,h,{path:void 0===c?o:[...o,c],branch:void 0===c?a:[...a,d],coerce:s,mask:n,message:i.message});for(const i of t)i[0]?(l=null!=i[0].refinement?"not_refined":"not_valid",yield[i[0],void 0]):s&&(d=i[1],void 0===c?e=d:e instanceof Map?e.set(c,d):e instanceof Set?e.add(d):Aa(e)&&(void 0!==d||c in e)&&(e[c]=d))}if("not_valid"!==l)for(const o of t.refiner(e,r))o.explanation=i.message,l="not_refined",yield[o,void 0];"valid"===l&&(yield[void 0,e])}class Ma{constructor(e){const{type:t,schema:i,validator:o,refiner:a,coercer:s=(e=>e),entries:n=function*(){}}=e;this.type=t,this.schema=i,this.entries=n,this.coercer=s,this.validator=o?(e,t)=>Ta(o(e,t),t,this,e):()=>[],this.refiner=a?(e,t)=>Ta(a(e,t),t,this,e):()=>[]}assert(e,t){return Va(e,this,t)}create(e,t){return function(e,t,i){const o=Ea(e,t,{coerce:!0,message:i});if(o[0])throw o[0];return o[1]}(e,this,t)}is(e){return function(e,t){const i=Ea(e,t);return!i[0]}(e,this)}mask(e,t){return function(e,t,i){const o=Ea(e,t,{coerce:!0,mask:!0,message:i});if(o[0])throw o[0];return o[1]}(e,this,t)}validate(e,t={}){return Ea(e,this,t)}}function Va(e,t,i){const o=Ea(e,t,{message:i});if(o[0])throw o[0]}function Ea(e,t,i={}){const o=La(e,t,i),a=function(e){const{done:t,value:i}=e.next();return t?void 0:i}(o);if(a[0]){const e=new xa(a[0],(function*(){for(const e of o)e[0]&&(yield e[0])}));return[e,void 0]}return[void 0,a[1]]}function za(e,t){return new Ma({type:e,schema:null,validator:t})}function Pa(e){return new Ma({type:"array",schema:e,*entries(t){if(e&&Array.isArray(t))for(const[i,o]of t.entries())yield[i,o,e]},coercer:e=>Array.isArray(e)?e.slice():e,validator:e=>Array.isArray(e)||`Expected an array value, but received: ${Ca(e)}`})}function Ha(){return za("boolean",(e=>"boolean"==typeof e))}function Da(e){const t=Ca(e),i=typeof e;return new Ma({type:"literal",schema:"string"===i||"number"===i||"boolean"===i?e:null,validator:i=>i===e||`Expected the literal \`${t}\`, but received: ${Ca(i)}`})}function Oa(){return za("number",(e=>"number"==typeof e&&!isNaN(e)||`Expected a number, but received: ${Ca(e)}`))}function ja(e){const t=e?Object.keys(e):[],i=za("never",(()=>!1));return new Ma({type:"object",schema:e||null,*entries(o){if(e&&Aa(o)){const a=new Set(Object.keys(o));for(const i of t)a.delete(i),yield[i,o[i],e[i]];for(const e of a)yield[e,o[e],i]}},validator:e=>Aa(e)||`Expected an object, but received: ${Ca(e)}`,coercer:e=>Aa(e)?{...e}:e})}function Na(e){return new Ma({...e,validator:(t,i)=>void 0===t||e.validator(t,i),refiner:(t,i)=>void 0===t||e.refiner(t,i)})}function Ra(){return za("string",(e=>"string"==typeof e||`Expected a string, but received: ${Ca(e)}`))}function Ia(e){const t=Object.keys(e);return new Ma({type:"type",schema:e,*entries(i){if(Aa(i))for(const o of t)yield[o,i[o],e[o]]},validator:e=>Aa(e)||`Expected an object, but received: ${Ca(e)}`,coercer:e=>Aa(e)?{...e}:e})}function Ua(e){const t=e.map((e=>e.type)).join(" | ");return new Ma({type:"union",schema:null,coercer(t){for(const i of e){const[e,o]=i.validate(t,{coerce:!0});if(!e)return o}return t},validator(i,o){const a=[];for(const t of e){const[...e]=La(i,t,o),[s]=e;if(!s[0])return[];for(const[t]of e)t&&a.push(t)}return[`Expected the value to satisfy a union of \`${t}\`, but received: ${Ca(i)}`,...a]}})}const Ba=ja({user:Ra()}),Fa=Ua([Ha(),ja({text:Na(Ra()),excemptions:Na(Pa(Ba))})]),Wa=ja({action:Da("url"),url_path:Ra(),confirmation:Na(Fa)}),Za=ja({action:Da("call-service"),service:Ra(),service_data:Na(ja()),data:Na(ja()),target:Na(ja({entity_id:Na(Ua([Ra(),Pa(Ra())])),device_id:Na(Ua([Ra(),Pa(Ra())])),area_id:Na(Ua([Ra(),Pa(Ra())]))})),confirmation:Na(Fa)}),Ka=ja({action:Da("navigate"),navigation_path:Ra(),confirmation:Na(Fa)}),qa=Ia({action:Da("fire-dom-event")}),Ga=ja({action:function(e){const t={},i=e.map((e=>Ca(e))).join();for(const i of e)t[i]=i;return new Ma({type:"enums",schema:t,validator:t=>e.includes(t)||`Expected one of \`${i}\`, but received: ${Ca(t)}`})}(["none","toggle","more-info","call-service","url","navigate"]),confirmation:Na(Fa)});var Ya;Ya=e=>{if(e&&"object"==typeof e&&"action"in e)switch(e.action){case"call-service":return Za;case"fire-dom-event":return qa;case"navigate":return Ka;case"url":return Wa}return Ga},new Ma({type:"dynamic",schema:null,*entries(e,t){const i=Ya(e,t);yield*i.entries(e,t)},validator:(e,t)=>Ya(e,t).validator(e,t),coercer:(e,t)=>Ya(e,t).coercer(e,t),refiner:(e,t)=>Ya(e,t).refiner(e,t)}),n`
...
`;const Xa=([[e,t],[i,o]],[a,s])=>[e*a+t*s,i*a+o*s],Ja=([e,t],[i,o])=>[e+i,t+o],Qa=e=>e/180*Math.PI,es=e=>{const{x:t,y:i,r:o,start:a,end:s,rotate:n=0}=e,r=t,l=i,c=o,d=o,h=Qa(a),u=(Qa(s)-h)%(2*Math.PI),m=Qa(n),_=(e=>[[Math.cos(e),-Math.sin(e)],[Math.sin(e),Math.cos(e)]])(m),[p,g]=Ja(Xa(_,[c*Math.cos(h),d*Math.sin(h)]),[r,l]),[v,f]=Ja(Xa(_,[c*Math.cos(h+u),d*Math.sin(h+u)]),[r,l]),b=u>Math.PI?1:0,y=u>0?1:0;return["M",p,g,"A",c,d,m/(2*Math.PI)*360,b,y,v,f].join(" ")};function ts(){return ts=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var o in i)Object.prototype.hasOwnProperty.call(i,o)&&(e[o]=i[o])}return e},ts.apply(this,arguments)}function is(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}function os(e){if(void 0===e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return e}var as,ss="function"!=typeof Object.assign?function(e){if(null==e)throw new TypeError("Cannot convert undefined or null to object");for(var t=Object(e),i=1;i<arguments.length;i++){var o=arguments[i];if(null!=o)for(var a in o)o.hasOwnProperty(a)&&(t[a]=o[a])}return t}:Object.assign,ns=["","webkit","Moz","MS","ms","o"],rs="undefined"==typeof document?{style:{}}:document.createElement("div"),ls=Math.round,cs=Math.abs,ds=Date.now;function hs(e,t){for(var i,o,a=t[0].toUpperCase()+t.slice(1),s=0;s<ns.length;){if((o=(i=ns[s])?i+a:t)in e)return o;s++}}as="undefined"==typeof window?{}:window;var us=hs(rs.style,"touchAction"),ms=void 0!==us;var _s="compute",ps="auto",gs="manipulation",vs="none",fs="pan-x",bs="pan-y",ys=function(){if(!ms)return!1;var e={},t=as.CSS&&as.CSS.supports;return["auto","manipulation","pan-y","pan-x","pan-x pan-y","none"].forEach((function(i){return e[i]=!t||as.CSS.supports("touch-action",i)})),e}(),ws="ontouchstart"in as,ks=void 0!==hs(as,"PointerEvent"),$s=ws&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),xs="touch",As="mouse",Cs=25,Ss=1,Ts=4,Ls=8,Ms=1,Vs=2,Es=4,zs=8,Ps=16,Hs=Vs|Es,Ds=zs|Ps,Os=Hs|Ds,js=["x","y"],Ns=["clientX","clientY"];function Rs(e,t,i){var o;if(e)if(e.forEach)e.forEach(t,i);else if(void 0!==e.length)for(o=0;o<e.length;)t.call(i,e[o],o,e),o++;else for(o in e)e.hasOwnProperty(o)&&t.call(i,e[o],o,e)}function Is(e,t){return"function"==typeof e?e.apply(t&&t[0]||void 0,t):e}function Us(e,t){return e.indexOf(t)>-1}var Bs=function(){function e(e,t){this.manager=e,this.set(t)}var t=e.prototype;return t.set=function(e){e===_s&&(e=this.compute()),ms&&this.manager.element.style&&ys[e]&&(this.manager.element.style[us]=e),this.actions=e.toLowerCase().trim()},t.update=function(){this.set(this.manager.options.touchAction)},t.compute=function(){var e=[];return Rs(this.manager.recognizers,(function(t){Is(t.options.enable,[t])&&(e=e.concat(t.getTouchAction()))})),function(e){if(Us(e,vs))return vs;var t=Us(e,fs),i=Us(e,bs);return t&&i?vs:t||i?t?fs:bs:Us(e,gs)?gs:ps}(e.join(" "))},t.preventDefaults=function(e){var t=e.srcEvent,i=e.offsetDirection;if(this.manager.session.prevented)t.preventDefault();else{var o=this.actions,a=Us(o,vs)&&!ys[vs],s=Us(o,bs)&&!ys[bs],n=Us(o,fs)&&!ys[fs];if(a){var r=1===e.pointers.length,l=e.distance<2,c=e.deltaTime<250;if(r&&l&&c)return}if(!n||!s)return a||s&&i&Hs||n&&i&Ds?this.preventSrc(t):void 0}},t.preventSrc=function(e){this.manager.session.prevented=!0,e.preventDefault()},e}();function Fs(e,t){for(;e;){if(e===t)return!0;e=e.parentNode}return!1}function Ws(e){var t=e.length;if(1===t)return{x:ls(e[0].clientX),y:ls(e[0].clientY)};for(var i=0,o=0,a=0;a<t;)i+=e[a].clientX,o+=e[a].clientY,a++;return{x:ls(i/t),y:ls(o/t)}}function Zs(e){for(var t=[],i=0;i<e.pointers.length;)t[i]={clientX:ls(e.pointers[i].clientX),clientY:ls(e.pointers[i].clientY)},i++;return{timeStamp:ds(),pointers:t,center:Ws(t),deltaX:e.deltaX,deltaY:e.deltaY}}function Ks(e,t,i){i||(i=js);var o=t[i[0]]-e[i[0]],a=t[i[1]]-e[i[1]];return Math.sqrt(o*o+a*a)}function qs(e,t,i){i||(i=js);var o=t[i[0]]-e[i[0]],a=t[i[1]]-e[i[1]];return 180*Math.atan2(a,o)/Math.PI}function Gs(e,t){return e===t?Ms:cs(e)>=cs(t)?e<0?Vs:Es:t<0?zs:Ps}function Ys(e,t,i){return{x:t/e||0,y:i/e||0}}function Xs(e,t){var i=e.session,o=t.pointers,a=o.length;i.firstInput||(i.firstInput=Zs(t)),a>1&&!i.firstMultiple?i.firstMultiple=Zs(t):1===a&&(i.firstMultiple=!1);var s=i.firstInput,n=i.firstMultiple,r=n?n.center:s.center,l=t.center=Ws(o);t.timeStamp=ds(),t.deltaTime=t.timeStamp-s.timeStamp,t.angle=qs(r,l),t.distance=Ks(r,l),function(e,t){var i=t.center,o=e.offsetDelta||{},a=e.prevDelta||{},s=e.prevInput||{};t.eventType!==Ss&&s.eventType!==Ts||(a=e.prevDelta={x:s.deltaX||0,y:s.deltaY||0},o=e.offsetDelta={x:i.x,y:i.y}),t.deltaX=a.x+(i.x-o.x),t.deltaY=a.y+(i.y-o.y)}(i,t),t.offsetDirection=Gs(t.deltaX,t.deltaY);var c,d,h=Ys(t.deltaTime,t.deltaX,t.deltaY);t.overallVelocityX=h.x,t.overallVelocityY=h.y,t.overallVelocity=cs(h.x)>cs(h.y)?h.x:h.y,t.scale=n?(c=n.pointers,Ks((d=o)[0],d[1],Ns)/Ks(c[0],c[1],Ns)):1,t.rotation=n?function(e,t){return qs(t[1],t[0],Ns)+qs(e[1],e[0],Ns)}(n.pointers,o):0,t.maxPointers=i.prevInput?t.pointers.length>i.prevInput.maxPointers?t.pointers.length:i.prevInput.maxPointers:t.pointers.length,function(e,t){var i,o,a,s,n=e.lastInterval||t,r=t.timeStamp-n.timeStamp;if(t.eventType!==Ls&&(r>Cs||void 0===n.velocity)){var l=t.deltaX-n.deltaX,c=t.deltaY-n.deltaY,d=Ys(r,l,c);o=d.x,a=d.y,i=cs(d.x)>cs(d.y)?d.x:d.y,s=Gs(l,c),e.lastInterval=t}else i=n.velocity,o=n.velocityX,a=n.velocityY,s=n.direction;t.velocity=i,t.velocityX=o,t.velocityY=a,t.direction=s}(i,t);var u,m=e.element,_=t.srcEvent;Fs(u=_.composedPath?_.composedPath()[0]:_.path?_.path[0]:_.target,m)&&(m=u),t.target=m}function Js(e,t,i){var o=i.pointers.length,a=i.changedPointers.length,s=t&Ss&&o-a==0,n=t&(Ts|Ls)&&o-a==0;i.isFirst=!!s,i.isFinal=!!n,s&&(e.session={}),i.eventType=t,Xs(e,i),e.emit("hammer.input",i),e.recognize(i),e.session.prevInput=i}function Qs(e){return e.trim().split(/\s+/g)}function en(e,t,i){Rs(Qs(t),(function(t){e.addEventListener(t,i,!1)}))}function tn(e,t,i){Rs(Qs(t),(function(t){e.removeEventListener(t,i,!1)}))}function on(e){var t=e.ownerDocument||e;return t.defaultView||t.parentWindow||window}var an=function(){function e(e,t){var i=this;this.manager=e,this.callback=t,this.element=e.element,this.target=e.options.inputTarget,this.domHandler=function(t){Is(e.options.enable,[e])&&i.handler(t)},this.init()}var t=e.prototype;return t.handler=function(){},t.init=function(){this.evEl&&en(this.element,this.evEl,this.domHandler),this.evTarget&&en(this.target,this.evTarget,this.domHandler),this.evWin&&en(on(this.element),this.evWin,this.domHandler)},t.destroy=function(){this.evEl&&tn(this.element,this.evEl,this.domHandler),this.evTarget&&tn(this.target,this.evTarget,this.domHandler),this.evWin&&tn(on(this.element),this.evWin,this.domHandler)},e}();function sn(e,t,i){if(e.indexOf&&!i)return e.indexOf(t);for(var o=0;o<e.length;){if(i&&e[o][i]==t||!i&&e[o]===t)return o;o++}return-1}var nn={pointerdown:Ss,pointermove:2,pointerup:Ts,pointercancel:Ls,pointerout:Ls},rn={2:xs,3:"pen",4:As,5:"kinect"},ln="pointerdown",cn="pointermove pointerup pointercancel";as.MSPointerEvent&&!as.PointerEvent&&(ln="MSPointerDown",cn="MSPointerMove MSPointerUp MSPointerCancel");var dn=function(e){function t(){var i,o=t.prototype;return o.evEl=ln,o.evWin=cn,(i=e.apply(this,arguments)||this).store=i.manager.session.pointerEvents=[],i}return is(t,e),t.prototype.handler=function(e){var t=this.store,i=!1,o=e.type.toLowerCase().replace("ms",""),a=nn[o],s=rn[e.pointerType]||e.pointerType,n=s===xs,r=sn(t,e.pointerId,"pointerId");a&Ss&&(0===e.button||n)?r<0&&(t.push(e),r=t.length-1):a&(Ts|Ls)&&(i=!0),r<0||(t[r]=e,this.callback(this.manager,a,{pointers:t,changedPointers:[e],pointerType:s,srcEvent:e}),i&&t.splice(r,1))},t}(an);function hn(e){return Array.prototype.slice.call(e,0)}function un(e,t,i){for(var o=[],a=[],s=0;s<e.length;){var n=t?e[s][t]:e[s];sn(a,n)<0&&o.push(e[s]),a[s]=n,s++}return i&&(o=t?o.sort((function(e,i){return e[t]>i[t]})):o.sort()),o}var mn={touchstart:Ss,touchmove:2,touchend:Ts,touchcancel:Ls},_n=function(e){function t(){var i;return t.prototype.evTarget="touchstart touchmove touchend touchcancel",(i=e.apply(this,arguments)||this).targetIds={},i}return is(t,e),t.prototype.handler=function(e){var t=mn[e.type],i=pn.call(this,e,t);i&&this.callback(this.manager,t,{pointers:i[0],changedPointers:i[1],pointerType:xs,srcEvent:e})},t}(an);function pn(e,t){var i,o,a=hn(e.touches),s=this.targetIds;if(t&(2|Ss)&&1===a.length)return s[a[0].identifier]=!0,[a,a];var n=hn(e.changedTouches),r=[],l=this.target;if(o=a.filter((function(e){return Fs(e.target,l)})),t===Ss)for(i=0;i<o.length;)s[o[i].identifier]=!0,i++;for(i=0;i<n.length;)s[n[i].identifier]&&r.push(n[i]),t&(Ts|Ls)&&delete s[n[i].identifier],i++;return r.length?[un(o.concat(r),"identifier",!0),r]:void 0}var gn={mousedown:Ss,mousemove:2,mouseup:Ts},vn=function(e){function t(){var i,o=t.prototype;return o.evEl="mousedown",o.evWin="mousemove mouseup",(i=e.apply(this,arguments)||this).pressed=!1,i}return is(t,e),t.prototype.handler=function(e){var t=gn[e.type];t&Ss&&0===e.button&&(this.pressed=!0),2&t&&1!==e.which&&(t=Ts),this.pressed&&(t&Ts&&(this.pressed=!1),this.callback(this.manager,t,{pointers:[e],changedPointers:[e],pointerType:As,srcEvent:e}))},t}(an),fn=2500;function bn(e){var t=e.changedPointers[0];if(t.identifier===this.primaryTouch){var i={x:t.clientX,y:t.clientY},o=this.lastTouches;this.lastTouches.push(i);setTimeout((function(){var e=o.indexOf(i);e>-1&&o.splice(e,1)}),fn)}}function yn(e,t){e&Ss?(this.primaryTouch=t.changedPointers[0].identifier,bn.call(this,t)):e&(Ts|Ls)&&bn.call(this,t)}function wn(e){for(var t=e.srcEvent.clientX,i=e.srcEvent.clientY,o=0;o<this.lastTouches.length;o++){var a=this.lastTouches[o],s=Math.abs(t-a.x),n=Math.abs(i-a.y);if(s<=25&&n<=25)return!0}return!1}var kn=function(){return function(e){function t(t,i){var o;return(o=e.call(this,t,i)||this).handler=function(e,t,i){var a=i.pointerType===xs,s=i.pointerType===As;if(!(s&&i.sourceCapabilities&&i.sourceCapabilities.firesTouchEvents)){if(a)yn.call(os(os(o)),t,i);else if(s&&wn.call(os(os(o)),i))return;o.callback(e,t,i)}},o.touch=new _n(o.manager,o.handler),o.mouse=new vn(o.manager,o.handler),o.primaryTouch=null,o.lastTouches=[],o}return is(t,e),t.prototype.destroy=function(){this.touch.destroy(),this.mouse.destroy()},t}(an)}();function $n(e,t,i){return!!Array.isArray(e)&&(Rs(e,i[t],i),!0)}var xn=32,An=1;function Cn(e,t){var i=t.manager;return i?i.get(e):e}function Sn(e){return 16&e?"cancel":8&e?"end":4&e?"move":2&e?"start":""}var Tn=function(){function e(e){void 0===e&&(e={}),this.options=ts({enable:!0},e),this.id=An++,this.manager=null,this.state=1,this.simultaneous={},this.requireFail=[]}var t=e.prototype;return t.set=function(e){return ss(this.options,e),this.manager&&this.manager.touchAction.update(),this},t.recognizeWith=function(e){if($n(e,"recognizeWith",this))return this;var t=this.simultaneous;return t[(e=Cn(e,this)).id]||(t[e.id]=e,e.recognizeWith(this)),this},t.dropRecognizeWith=function(e){return $n(e,"dropRecognizeWith",this)||(e=Cn(e,this),delete this.simultaneous[e.id]),this},t.requireFailure=function(e){if($n(e,"requireFailure",this))return this;var t=this.requireFail;return-1===sn(t,e=Cn(e,this))&&(t.push(e),e.requireFailure(this)),this},t.dropRequireFailure=function(e){if($n(e,"dropRequireFailure",this))return this;e=Cn(e,this);var t=sn(this.requireFail,e);return t>-1&&this.requireFail.splice(t,1),this},t.hasRequireFailures=function(){return this.requireFail.length>0},t.canRecognizeWith=function(e){return!!this.simultaneous[e.id]},t.emit=function(e){var t=this,i=this.state;function o(i){t.manager.emit(i,e)}i<8&&o(t.options.event+Sn(i)),o(t.options.event),e.additionalEvent&&o(e.additionalEvent),i>=8&&o(t.options.event+Sn(i))},t.tryEmit=function(e){if(this.canEmit())return this.emit(e);this.state=xn},t.canEmit=function(){for(var e=0;e<this.requireFail.length;){if(!(33&this.requireFail[e].state))return!1;e++}return!0},t.recognize=function(e){var t=ss({},e);if(!Is(this.options.enable,[this,t]))return this.reset(),void(this.state=xn);56&this.state&&(this.state=1),this.state=this.process(t),30&this.state&&this.tryEmit(t)},t.process=function(e){},t.getTouchAction=function(){},t.reset=function(){},e}(),Ln=function(e){function t(t){var i;return void 0===t&&(t={}),(i=e.call(this,ts({event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},t))||this).pTime=!1,i.pCenter=!1,i._timer=null,i._input=null,i.count=0,i}is(t,e);var i=t.prototype;return i.getTouchAction=function(){return[gs]},i.process=function(e){var t=this,i=this.options,o=e.pointers.length===i.pointers,a=e.distance<i.threshold,s=e.deltaTime<i.time;if(this.reset(),e.eventType&Ss&&0===this.count)return this.failTimeout();if(a&&s&&o){if(e.eventType!==Ts)return this.failTimeout();var n=!this.pTime||e.timeStamp-this.pTime<i.interval,r=!this.pCenter||Ks(this.pCenter,e.center)<i.posThreshold;if(this.pTime=e.timeStamp,this.pCenter=e.center,r&&n?this.count+=1:this.count=1,this._input=e,0===this.count%i.taps)return this.hasRequireFailures()?(this._timer=setTimeout((function(){t.state=8,t.tryEmit()}),i.interval),2):8}return xn},i.failTimeout=function(){var e=this;return this._timer=setTimeout((function(){e.state=xn}),this.options.interval),xn},i.reset=function(){clearTimeout(this._timer)},i.emit=function(){8===this.state&&(this._input.tapCount=this.count,this.manager.emit(this.options.event,this._input))},t}(Tn),Mn=function(e){function t(t){return void 0===t&&(t={}),e.call(this,ts({pointers:1},t))||this}is(t,e);var i=t.prototype;return i.attrTest=function(e){var t=this.options.pointers;return 0===t||e.pointers.length===t},i.process=function(e){var t=this.state,i=e.eventType,o=6&t,a=this.attrTest(e);return o&&(i&Ls||!a)?16|t:o||a?i&Ts?8|t:2&t?4|t:2:xn},t}(Tn);function Vn(e){return e===Ps?"down":e===zs?"up":e===Vs?"left":e===Es?"right":""}var En=function(e){function t(t){var i;return void 0===t&&(t={}),(i=e.call(this,ts({event:"pan",threshold:10,pointers:1,direction:Os},t))||this).pX=null,i.pY=null,i}is(t,e);var i=t.prototype;return i.getTouchAction=function(){var e=this.options.direction,t=[];return e&Hs&&t.push(bs),e&Ds&&t.push(fs),t},i.directionTest=function(e){var t=this.options,i=!0,o=e.distance,a=e.direction,s=e.deltaX,n=e.deltaY;return a&t.direction||(t.direction&Hs?(a=0===s?Ms:s<0?Vs:Es,i=s!==this.pX,o=Math.abs(e.deltaX)):(a=0===n?Ms:n<0?zs:Ps,i=n!==this.pY,o=Math.abs(e.deltaY))),e.direction=a,i&&o>t.threshold&&a&t.direction},i.attrTest=function(e){return Mn.prototype.attrTest.call(this,e)&&(2&this.state||!(2&this.state)&&this.directionTest(e))},i.emit=function(t){this.pX=t.deltaX,this.pY=t.deltaY;var i=Vn(t.direction);i&&(t.additionalEvent=this.options.event+i),e.prototype.emit.call(this,t)},t}(Mn),zn=function(e){function t(t){return void 0===t&&(t={}),e.call(this,ts({event:"swipe",threshold:10,velocity:.3,direction:Hs|Ds,pointers:1},t))||this}is(t,e);var i=t.prototype;return i.getTouchAction=function(){return En.prototype.getTouchAction.call(this)},i.attrTest=function(t){var i,o=this.options.direction;return o&(Hs|Ds)?i=t.overallVelocity:o&Hs?i=t.overallVelocityX:o&Ds&&(i=t.overallVelocityY),e.prototype.attrTest.call(this,t)&&o&t.offsetDirection&&t.distance>this.options.threshold&&t.maxPointers===this.options.pointers&&cs(i)>this.options.velocity&&t.eventType&Ts},i.emit=function(e){var t=Vn(e.offsetDirection);t&&this.manager.emit(this.options.event+t,e),this.manager.emit(this.options.event,e)},t}(Mn),Pn=function(e){function t(t){return void 0===t&&(t={}),e.call(this,ts({event:"pinch",threshold:0,pointers:2},t))||this}is(t,e);var i=t.prototype;return i.getTouchAction=function(){return[vs]},i.attrTest=function(t){return e.prototype.attrTest.call(this,t)&&(Math.abs(t.scale-1)>this.options.threshold||2&this.state)},i.emit=function(t){if(1!==t.scale){var i=t.scale<1?"in":"out";t.additionalEvent=this.options.event+i}e.prototype.emit.call(this,t)},t}(Mn),Hn=function(e){function t(t){return void 0===t&&(t={}),e.call(this,ts({event:"rotate",threshold:0,pointers:2},t))||this}is(t,e);var i=t.prototype;return i.getTouchAction=function(){return[vs]},i.attrTest=function(t){return e.prototype.attrTest.call(this,t)&&(Math.abs(t.rotation)>this.options.threshold||2&this.state)},t}(Mn),Dn=function(e){function t(t){var i;return void 0===t&&(t={}),(i=e.call(this,ts({event:"press",pointers:1,time:251,threshold:9},t))||this)._timer=null,i._input=null,i}is(t,e);var i=t.prototype;return i.getTouchAction=function(){return[ps]},i.process=function(e){var t=this,i=this.options,o=e.pointers.length===i.pointers,a=e.distance<i.threshold,s=e.deltaTime>i.time;if(this._input=e,!a||!o||e.eventType&(Ts|Ls)&&!s)this.reset();else if(e.eventType&Ss)this.reset(),this._timer=setTimeout((function(){t.state=8,t.tryEmit()}),i.time);else if(e.eventType&Ts)return 8;return xn},i.reset=function(){clearTimeout(this._timer)},i.emit=function(e){8===this.state&&(e&&e.eventType&Ts?this.manager.emit(this.options.event+"up",e):(this._input.timeStamp=ds(),this.manager.emit(this.options.event,this._input)))},t}(Tn),On={domEvents:!1,touchAction:_s,enable:!0,inputTarget:null,inputClass:null,cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}},jn=[[Hn,{enable:!1}],[Pn,{enable:!1},["rotate"]],[zn,{direction:Hs}],[En,{direction:Hs},["swipe"]],[Ln],[Ln,{event:"doubletap",taps:2},["tap"]],[Dn]];function Nn(e,t){var i,o=e.element;o.style&&(Rs(e.options.cssProps,(function(a,s){i=hs(o.style,s),t?(e.oldCssProps[i]=o.style[i],o.style[i]=a):o.style[i]=e.oldCssProps[i]||""})),t||(e.oldCssProps={}))}var Rn=function(){function e(e,t){var i,o=this;this.options=ss({},On,t||{}),this.options.inputTarget=this.options.inputTarget||e,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=e,this.input=new((i=this).options.inputClass||(ks?dn:$s?_n:ws?kn:vn))(i,Js),this.touchAction=new Bs(this,this.options.touchAction),Nn(this,!0),Rs(this.options.recognizers,(function(e){var t=o.add(new e[0](e[1]));e[2]&&t.recognizeWith(e[2]),e[3]&&t.requireFailure(e[3])}),this)}var t=e.prototype;return t.set=function(e){return ss(this.options,e),e.touchAction&&this.touchAction.update(),e.inputTarget&&(this.input.destroy(),this.input.target=e.inputTarget,this.input.init()),this},t.stop=function(e){this.session.stopped=e?2:1},t.recognize=function(e){var t=this.session;if(!t.stopped){var i;this.touchAction.preventDefaults(e);var o=this.recognizers,a=t.curRecognizer;(!a||a&&8&a.state)&&(t.curRecognizer=null,a=null);for(var s=0;s<o.length;)i=o[s],2===t.stopped||a&&i!==a&&!i.canRecognizeWith(a)?i.reset():i.recognize(e),!a&&14&i.state&&(t.curRecognizer=i,a=i),s++}},t.get=function(e){if(e instanceof Tn)return e;for(var t=this.recognizers,i=0;i<t.length;i++)if(t[i].options.event===e)return t[i];return null},t.add=function(e){if($n(e,"add",this))return this;var t=this.get(e.options.event);return t&&this.remove(t),this.recognizers.push(e),e.manager=this,this.touchAction.update(),e},t.remove=function(e){if($n(e,"remove",this))return this;var t=this.get(e);if(e){var i=this.recognizers,o=sn(i,t);-1!==o&&(i.splice(o,1),this.touchAction.update())}return this},t.on=function(e,t){if(void 0===e||void 0===t)return this;var i=this.handlers;return Rs(Qs(e),(function(e){i[e]=i[e]||[],i[e].push(t)})),this},t.off=function(e,t){if(void 0===e)return this;var i=this.handlers;return Rs(Qs(e),(function(e){t?i[e]&&i[e].splice(sn(i[e],t),1):delete i[e]})),this},t.emit=function(e,t){this.options.domEvents&&function(e,t){var i=document.createEvent("Event");i.initEvent(e,!0,!0),i.gesture=t,t.target.dispatchEvent(i)}(e,t);var i=this.handlers[e]&&this.handlers[e].slice();if(i&&i.length){t.type=e,t.preventDefault=function(){t.srcEvent.preventDefault()};for(var o=0;o<i.length;)i[o](t),o++}},t.destroy=function(){this.element&&Nn(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null},e}(),In={touchstart:Ss,touchmove:2,touchend:Ts,touchcancel:Ls},Un=function(e){function t(){var i,o=t.prototype;return o.evTarget="touchstart",o.evWin="touchstart touchmove touchend touchcancel",(i=e.apply(this,arguments)||this).started=!1,i}return is(t,e),t.prototype.handler=function(e){var t=In[e.type];if(t===Ss&&(this.started=!0),this.started){var i=Bn.call(this,e,t);t&(Ts|Ls)&&i[0].length-i[1].length==0&&(this.started=!1),this.callback(this.manager,t,{pointers:i[0],changedPointers:i[1],pointerType:xs,srcEvent:e})}},t}(an);function Bn(e,t){var i=hn(e.touches),o=hn(e.changedTouches);return t&(Ts|Ls)&&(i=un(i.concat(o),"identifier",!0)),[i,o]}function Fn(e,t,i){var o="DEPRECATED METHOD: "+t+"\n"+i+" AT \n";return function(){var t=new Error("get-stack-trace"),i=t&&t.stack?t.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,"{anonymous}()@"):"Unknown Stack Trace",a=window.console&&(window.console.warn||window.console.log);return a&&a.call(window.console,o,i),e.apply(this,arguments)}}var Wn=Fn((function(e,t,i){for(var o=Object.keys(t),a=0;a<o.length;)(!i||i&&void 0===e[o[a]])&&(e[o[a]]=t[o[a]]),a++;return e}),"extend","Use `assign`."),Zn=Fn((function(e,t){return Wn(e,t,!0)}),"merge","Use `assign`.");function Kn(e,t,i){var o,a=t.prototype;(o=e.prototype=Object.create(a)).constructor=e,o._super=a,i&&ss(o,i)}function qn(e,t){return function(){return e.apply(t,arguments)}}(function(){var e=function(e,t){return void 0===t&&(t={}),new Rn(e,ts({recognizers:jn.concat()},t))};return e.VERSION="2.0.17-rc",e.DIRECTION_ALL=Os,e.DIRECTION_DOWN=Ps,e.DIRECTION_LEFT=Vs,e.DIRECTION_RIGHT=Es,e.DIRECTION_UP=zs,e.DIRECTION_HORIZONTAL=Hs,e.DIRECTION_VERTICAL=Ds,e.DIRECTION_NONE=Ms,e.DIRECTION_DOWN=Ps,e.INPUT_START=Ss,e.INPUT_MOVE=2,e.INPUT_END=Ts,e.INPUT_CANCEL=Ls,e.STATE_POSSIBLE=1,e.STATE_BEGAN=2,e.STATE_CHANGED=4,e.STATE_ENDED=8,e.STATE_RECOGNIZED=8,e.STATE_CANCELLED=16,e.STATE_FAILED=xn,e.Manager=Rn,e.Input=an,e.TouchAction=Bs,e.TouchInput=_n,e.MouseInput=vn,e.PointerEventInput=dn,e.TouchMouseInput=kn,e.SingleTouchInput=Un,e.Recognizer=Tn,e.AttrRecognizer=Mn,e.Tap=Ln,e.Pan=En,e.Swipe=zn,e.Pinch=Pn,e.Rotate=Hn,e.Press=Dn,e.on=en,e.off=tn,e.each=Rs,e.merge=Zn,e.extend=Wn,e.bindFn=qn,e.assign=ss,e.inherit=Kn,e.bindFn=qn,e.prefixed=hs,e.toArray=hn,e.inArray=sn,e.uniqueArray=un,e.splitStr=Qs,e.boolOrFn=Is,e.hasParent=Fs,e.addEventListeners=en,e.removeEventListeners=tn,e.defaults=ss({},On,{preset:jn}),e})().defaults;
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Gn=270;const Yn=new Set(["ArrowRight","ArrowUp","ArrowLeft","ArrowDown","PageUp","PageDown","Home","End"]);let Xn=class extends re{constructor(){super(...arguments),this.disabled=!1,this.step=1,this.min=0,this.max=100,this._localValue=this.value,this._localLow=this.low,this._localHigh=this.high,this._getPercentageFromEvent=e=>{const t=this._slider.getBoundingClientRect(),i=2*(e.center.x-t.left-t.width/2)/t.width,o=2*(e.center.y-t.top-t.height/2)/t.height,[,a]=function(e,t){return[Math.sqrt(e*e+t*t),Math.atan2(t,e)]}(i,o),s=(a/(2*Math.PI)*360+45-135+360)%360-45;return Math.max(Math.min(s/Gn,1),0)}}_valueToPercentage(e){return(wa(e,this.min,this.max)-this.min)/(this.max-this.min)}_percentageToValue(e){return(this.max-this.min)*e+this.min}_steppedValue(e){return Math.round(e/this.step)*this.step}_boundedValue(e){var t,i;const o="high"===this._activeSlider?Math.min(null!==(t=this._localLow)&&void 0!==t?t:this.max):this.min,a="low"===this._activeSlider?Math.max(null!==(i=this._localHigh)&&void 0!==i?i:this.min):this.max;return Math.min(Math.max(e,o),a)}firstUpdated(e){super.firstUpdated(e),this._setupListeners()}updated(e){super.updated(e),this._activeSlider||(e.has("value")&&(this._localValue=this.value),e.has("low")&&(this._localLow=this.low),e.has("high")&&(this._localHigh=this.high))}connectedCallback(){super.connectedCallback(),this._setupListeners()}disconnectedCallback(){super.disconnectedCallback()}_findActiveSlider(e){var t,i;if(!this.dual)return"value";const o=Math.max(null!==(t=this._localLow)&&void 0!==t?t:this.min,this.min),a=Math.min(null!==(i=this._localHigh)&&void 0!==i?i:this.max,this.max);if(o>=e)return"low";if(a<=e)return"high";return Math.abs(e-o)<=Math.abs(e-a)?"low":"high"}_setActiveValue(e){switch(this._activeSlider){case"high":this._localHigh=e;break;case"low":this._localLow=e;break;case"value":this._localValue=e}}_getActiveValue(){switch(this._activeSlider){case"high":return this._localHigh;case"low":return this._localLow;case"value":return this._localValue}}_setupListeners(){this._interaction&&!this._mc&&(this._mc=new Rn(this._interaction,{inputClass:kn}),this._mc.add(new En({direction:Os,enable:!0,threshold:0})),this._mc.add(new Ln({event:"singletap"})),this._mc.on("pan",(e=>{e.srcEvent.stopPropagation(),e.srcEvent.preventDefault()})),this._mc.on("panstart",(e=>{var t,i;if(this.disabled)return;const o=this._getPercentageFromEvent(e),a=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(a),this._lastSlider=this._activeSlider,null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("#slider"))||void 0===i||i.focus()})),this._mc.on("pancancel",(()=>{this.disabled||(this._activeSlider=void 0)})),this._mc.on("panmove",(e=>{if(this.disabled)return;const t=this._getPercentageFromEvent(e),i=this._percentageToValue(t),o=this._boundedValue(i);this._setActiveValue(o);const a=this._steppedValue(o);this._activeSlider&&ya(this,`${this._activeSlider}-changing`,{value:a})})),this._mc.on("panend",(e=>{if(this.disabled)return;const t=this._getPercentageFromEvent(e),i=this._percentageToValue(t),o=this._boundedValue(i),a=this._steppedValue(o);this._setActiveValue(a),this._activeSlider&&(ya(this,`${this._activeSlider}-changing`,{value:void 0}),ya(this,`${this._activeSlider}-changed`,{value:a})),this._activeSlider=void 0})),this._mc.on("singletap",(e=>{var t,i;if(this.disabled)return;const o=this._getPercentageFromEvent(e),a=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(a);const s=this._boundedValue(a),n=this._steppedValue(s);this._setActiveValue(n),this._activeSlider&&(ya(this,`${this._activeSlider}-changing`,{value:void 0}),ya(this,`${this._activeSlider}-changed`,{value:n})),this._lastSlider=this._activeSlider,null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("#slider"))||void 0===i||i.focus(),this._activeSlider=void 0})))}get _tenPercentStep(){return Math.max(this.step,(this.max-this.min)/10)}_handleKeyDown(e){var t,i,o;if(!Yn.has(e.code))return;e.preventDefault(),this._lastSlider&&(null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById(this._lastSlider))||void 0===i||i.focus()),this._activeSlider=null!==(o=this._lastSlider)&&void 0!==o?o:e.currentTarget.id,this._lastSlider=void 0;const a=this._getActiveValue();switch(e.code){case"ArrowRight":case"ArrowUp":this._setActiveValue(this._boundedValue((null!=a?a:this.min)+this.step));break;case"ArrowLeft":case"ArrowDown":this._setActiveValue(this._boundedValue((null!=a?a:this.min)-this.step));break;case"PageUp":this._setActiveValue(this._steppedValue(this._boundedValue((null!=a?a:this.min)+this._tenPercentStep)));break;case"PageDown":this._setActiveValue(this._steppedValue(this._boundedValue((null!=a?a:this.min)-this._tenPercentStep)));break;case"Home":this._setActiveValue(this._boundedValue(this.min));break;case"End":this._setActiveValue(this._boundedValue(this.max))}ya(this,`${this._activeSlider}-changing`,{value:this._getActiveValue()}),this._activeSlider=void 0}_handleKeyUp(e){Yn.has(e.code)&&(this._activeSlider=e.currentTarget.id,e.preventDefault(),ya(this,`${this._activeSlider}-changing`,{value:void 0}),ya(this,`${this._activeSlider}-changed`,{value:this._getActiveValue()}),this._activeSlider=void 0)}destroyListeners(){this._mc&&(this._mc.destroy(),this._mc=void 0)}_strokeCircleDashArc(e){return this._strokeDashArc(e,e)}_strokeDashArc(e,t){const i=this._valueToPercentage(e),o=this._valueToPercentage(t),a=290*Math.PI*Gn/360,s=Math.max((o-i)*a,0);return[`${s} ${a-s}`,`-${i*a-.5}`]}renderArc(e,t,i){var o,a;if(this.disabled)return Z;const s=es({x:0,y:0,start:0,end:Gn,r:145}),n="end"===i?this.max:this.min,r=null!==(o=this.current)&&void 0!==o?o:n,l=null!=t?t:n,c="end"===i?l<=r:"start"===i&&r<=l,d=c?"end"===i?this._strokeDashArc(l,r):this._strokeDashArc(r,l):this._strokeCircleDashArc(l),h="full"===i?this._strokeDashArc(this.min,this.max):"end"===i?this._strokeDashArc(l,n):this._strokeDashArc(n,l),u=this._strokeCircleDashArc(l),m=null!=this.current&&this.current<=this.max&&this.current>=this.min&&(c||"full"===this.mode)?this._strokeCircleDashArc(this.current):void 0;return F`
      ...
      `}render(){const e=es({x:0,y:0,start:0,end:Gn,r:145}),t=this.dual?this._localLow:this._localValue,i=this._localHigh,o=this.current,a=o?this._strokeCircleDashArc(o):void 0;return B`
        <svg
          id="slider"
          viewBox="0 0 320 320"
          overflow="visible"
      ...
      `}};e([ue({type:Boolean,reflect:!0})],Xn.prototype,"disabled",void 0),e([ue({type:Boolean})],Xn.prototype,"dual",void 0),e([ue({type:String})],Xn.prototype,"mode",void 0),e([ue({type:Boolean})],Xn.prototype,"inactive",void 0),e([ue({type:String})],Xn.prototype,"label",void 0),e([ue({type:String,attribute:"low-label"})],Xn.prototype,"lowLabel",void 0),e([ue({type:String,attribute:"high-label"})],Xn.prototype,"highLabel",void 0),e([ue({type:Number})],Xn.prototype,"value",void 0),e([ue({type:Number})],Xn.prototype,"low",void 0),e([ue({type:Number})],Xn.prototype,"high",void 0),e([ue({type:Number})],Xn.prototype,"current",void 0),e([ue({type:Number})],Xn.prototype,"step",void 0),e([ue({type:Number})],Xn.prototype,"min",void 0),e([ue({type:Number})],Xn.prototype,"max",void 0),e([me()],Xn.prototype,"_localValue",void 0),e([me()],Xn.prototype,"_localLow",void 0),e([me()],Xn.prototype,"_localHigh",void 0),e([me()],Xn.prototype,"_activeSlider",void 0),e([me()],Xn.prototype,"_lastSlider",void 0),e([pe("#slider")],Xn.prototype,"_slider",void 0),e([pe("#interaction")],Xn.prototype,"_interaction",void 0),Xn=e([ce("vt-ha-control-circular-slider")],Xn);const Jn=n`
...
`,er={auto:"M18,11V12.5C21.19,12.5 23.09,16.05 21.33,18.71L20.24,17.62C21.06,15.96 19.85,14 18,14V15.5L15.75,13.25L18,11M18,22V20.5C14.81,20.5 12.91,16.95 14.67,14.29L15.76,15.38C14.94,17.04 16.15,19 18,19V17.5L20.25,19.75L18,22M19,3H18V1H16V3H8V1H6V3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H14C13.36,20.45 12.86,19.77 12.5,19H5V8H19V10.59C19.71,10.7 20.39,10.94 21,11.31V5A2,2 0 0,0 19,3Z",heat_cool:"M12,6V9L16,5L12,1V4A8,8 0 0,0 4,12C4,13.57 4.46,15.03 5.24,16.26L6.7,14.8C6.25,13.97 6,13 6,12A6,6 0 0,1 12,6M18.76,7.74L17.3,9.2C17.74,10.04 18,11 18,12A6,6 0 0,1 12,18V15L8,19L12,23V20A8,8 0 0,0 20,12C20,10.43 19.54,8.97 18.76,7.74Z",heat:"M17.66 11.2C17.43 10.9 17.15 10.64 16.89 10.38C16.22 9.78 15.46 9.35 14.82 8.72C13.33 7.26 13 4.85 13.95 3C13 3.23 12.17 3.75 11.46 4.32C8.87 6.4 7.85 10.07 9.07 13.22C9.11 13.32 9.15 13.42 9.15 13.55C9.15 13.77 9 13.97 8.8 14.05C8.57 14.15 8.33 14.09 8.14 13.93C8.08 13.88 8.04 13.83 8 13.76C6.87 12.33 6.69 10.28 7.45 8.64C5.78 10 4.87 12.3 5 14.47C5.06 14.97 5.12 15.47 5.29 15.97C5.43 16.57 5.7 17.17 6 17.7C7.08 19.43 8.95 20.67 10.96 20.92C13.1 21.19 15.39 20.8 17.03 19.32C18.86 17.66 19.5 15 18.56 12.72L18.43 12.46C18.22 12 17.66 11.2 17.66 11.2M14.5 17.5C14.22 17.74 13.76 18 13.4 18.1C12.28 18.5 11.16 17.94 10.5 17.28C11.69 17 12.4 16.12 12.61 15.23C12.78 14.43 12.46 13.77 12.33 13C12.21 12.26 12.23 11.63 12.5 10.94C12.69 11.32 12.89 11.7 13.13 12C13.9 13 15.11 13.44 15.37 14.8C15.41 14.94 15.43 15.08 15.43 15.23C15.46 16.05 15.1 16.95 14.5 17.5H14.5Z",cool:"M20.79,13.95L18.46,14.57L16.46,13.44V10.56L18.46,9.43L20.79,10.05L21.31,8.12L19.54,7.65L20,5.88L18.07,5.36L17.45,7.69L15.45,8.82L13,7.38V5.12L14.71,3.41L13.29,2L12,3.29L10.71,2L9.29,3.41L11,5.12V7.38L8.5,8.82L6.5,7.69L5.92,5.36L4,5.88L4.47,7.65L2.7,8.12L3.22,10.05L5.55,9.43L7.55,10.56V13.45L5.55,14.58L3.22,13.96L2.7,15.89L4.47,16.36L4,18.12L5.93,18.64L6.55,16.31L8.55,15.18L11,16.62V18.88L9.29,20.59L10.71,22L12,20.71L13.29,22L14.7,20.59L13,18.88V16.62L15.5,15.17L17.5,16.3L18.12,18.63L20,18.12L19.53,16.35L21.3,15.88L20.79,13.95M9.5,10.56L12,9.11L14.5,10.56V13.44L12,14.89L9.5,13.44V10.56Z",off:"M16.56,5.44L15.11,6.89C16.84,7.94 18,9.83 18,12A6,6 0 0,1 12,18A6,6 0 0,1 6,12C6,9.83 7.16,7.94 8.88,6.88L7.44,5.44C5.36,6.88 4,9.28 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12C20,9.28 18.64,6.88 16.56,5.44M13,3H11V13H13",fan_only:$e,dry:Pe,window_open:He,windowBypass:De,presence:Ce,motion:Ve,eco:"M17,8C8,10 5.9,16.17 3.82,21.34L5.71,22L6.66,19.7C7.14,19.87 7.64,20 8,20C19,20 22,3 22,3C21,5 14,5.25 9,6.25C4,7.25 2,11.5 2,13.5C2,15.5 3.75,17.25 3.75,17.25C7,8 17,8 17,8Z",comfort:"M12.5 7C12.5 5.89 13.39 5 14.5 5H18C19.1 5 20 5.9 20 7V9.16C18.84 9.57 18 10.67 18 11.97V14H12.5V7M6 11.96V14H11.5V7C11.5 5.89 10.61 5 9.5 5H6C4.9 5 4 5.9 4 7V9.15C5.16 9.56 6 10.67 6 11.96M20.66 10.03C19.68 10.19 19 11.12 19 12.12V15H5V12C5 10.9 4.11 10 3 10S1 10.9 1 12V17C1 18.1 1.9 19 3 19V21H5V19H19V21H21V19C22.1 19 23 18.1 23 17V12C23 10.79 21.91 9.82 20.66 10.03Z",boost:"M13.13 22.19L11.5 18.36C13.07 17.78 14.54 17 15.9 16.09L13.13 22.19M5.64 12.5L1.81 10.87L7.91 8.1C7 9.46 6.22 10.93 5.64 12.5M21.61 2.39C21.61 2.39 16.66 .269 11 5.93C8.81 8.12 7.5 10.53 6.65 12.64C6.37 13.39 6.56 14.21 7.11 14.77L9.24 16.89C9.79 17.45 10.61 17.63 11.36 17.35C13.5 16.53 15.88 15.19 18.07 13C23.73 7.34 21.61 2.39 21.61 2.39M14.54 9.46C13.76 8.68 13.76 7.41 14.54 6.63S16.59 5.85 17.37 6.63C18.14 7.41 18.15 8.68 17.37 9.46C16.59 10.24 15.32 10.24 14.54 9.46M8.88 16.53L7.47 15.12L8.88 16.53M6.24 22L9.88 18.36C9.54 18.27 9.21 18.12 8.91 17.91L4.83 22H6.24M2 22H3.41L8.18 17.24L6.76 15.83L2 20.59V22M2 19.17L6.09 15.09C5.88 14.79 5.73 14.47 5.64 14.12L2 17.76V19.17Z",frost:"M14.46 9.41L11 7.38V5.12L12.71 3.41L11.29 2L10 3.29L8.71 2L7.29 3.41L9 5.12V7.38L6.5 8.82L4.5 7.69L3.92 5.36L2 5.88L2.47 7.65L.7 8.12L1.22 10.05L3.55 9.43L5.55 10.56V13.45L3.55 14.58L1.22 13.96L.7 15.89L2.47 16.36L2 18.12L3.93 18.64L4.55 16.31L6.55 15.18L9 16.62V18.88L7.29 20.59L8.71 22L10 20.71L11.29 22L12.7 20.59L11 18.88V16.62L14.46 14.61M7.5 10.56L10 9.11L12.5 10.56V13.44L10 14.89L7.5 13.44M19 5C17.89 5 17 5.89 17 7V13.76C16.36 14.33 16 15.15 16 16C16 17.66 17.34 19 19 19S22 17.66 22 16C22 15.15 21.64 14.33 21 13.77V7C21 5.89 20.11 5 19 5M19 6C19.55 6 20 6.45 20 7V8H18V7C18 6.45 18.45 6 19 6",activity:Ve,power:"M12 3L2 12H5V20H19V12H22L12 3M11.5 18V14H9L12.5 7V11H15L11.5 18Z",flashAlert:xe,temperature:"M15 13V5A3 3 0 0 0 9 5V13A5 5 0 1 0 15 13M12 4A1 1 0 0 1 13 5V8H11V5A1 1 0 0 1 12 4Z",humidity:Pe,ok:be,thermometerAlert:ze,none:"M23 17C23 20.31 20.31 23 17 23V21.5C19.5 21.5 21.5 19.5 21.5 17H23M1 7C1 3.69 3.69 1 7 1V2.5C4.5 2.5 2.5 4.5 2.5 7H1M8 4.32L3.41 8.92C.19 12.14 .19 17.37 3.41 20.59S11.86 23.81 15.08 20.59L22.15 13.5C22.64 13.03 22.64 12.24 22.15 11.75C21.66 11.26 20.87 11.26 20.38 11.75L15.96 16.17L15.25 15.46L21.79 8.92C22.28 8.43 22.28 7.64 21.79 7.15S20.5 6.66 20 7.15L14.19 13L13.5 12.27L20.37 5.38C20.86 4.89 20.86 4.1 20.37 3.61S19.09 3.12 18.6 3.61L11.71 10.5L11 9.8L16.5 4.32C17 3.83 17 3.04 16.5 2.55S15.22 2.06 14.73 2.55L7.11 10.17C8.33 11.74 8.22 14 6.78 15.45L6.07 14.74C7.24 13.57 7.24 11.67 6.07 10.5L5.72 10.15L9.79 6.08C10.28 5.59 10.28 4.8 9.79 4.31C9.29 3.83 8.5 3.83 8 4.32Z",auto_regulation_mode:Me,power_percent:Me,mean_power_cycle:"M7,2V13H10V22L17,10H13L17,2H7Z",valve_open_percent:"M22 13V21H20V19H16.58C15.81 20.76 14.05 22 12 22S8.19 20.76 7.42 19H4V21H2V13H4V15H7.43C7.93 13.85 8.85 12.93 10 12.42V11H8V9H16V11H14V12.42C15.15 12.93 16.07 13.85 16.57 15H20V13H22M17 2H7C6.45 2 6 2.45 6 3S6.45 4 7 4H10V5H11V8H13V5H14V4H17C17.55 4 18 3.55 18 3S17.55 2 17 2Z",regulated_target_temperature:"M12 14C11.7 13.6 11.4 13.3 11 13V5C11 3.3 9.7 2 8 2S5 3.3 5 5V13C2.8 14.7 2.3 17.8 4 20S8.8 22.7 11 21 13.7 16.2 12 14M9 8H7V5C7 4.5 7.5 4 8 4S9 4.5 9 5V8M18 3H16L12.8 12H14.7L15.4 10H18.6L19.3 12H21.2L18 3M15.8 8.7L17 5L18.2 8.7H15.8Z",auto_fan_mode:"M12.5 2C8.93 2 8.14 5.96 10.13 9.65C9.72 9.97 9.4 10.39 9.21 10.87C8.28 10.68 7.23 10.25 6.73 9.26C5.56 6.89 2 7 2 11.5C2 15.07 5.95 15.85 9.64 13.87C9.96 14.27 10.39 14.59 10.88 14.79C10.68 15.71 10.24 16.75 9.26 17.24C6.9 18.42 7 22 11.5 22C12.31 22 13 21.78 13.5 21.41C13.19 20.67 13 19.86 13 19C13 17.59 13.5 16.3 14.3 15.28C14.17 14.97 14.03 14.65 13.86 14.34C14.26 14 14.57 13.59 14.77 13.11C15.26 13.21 15.78 13.39 16.25 13.67C17.07 13.25 18 13 19 13C20.05 13 21.03 13.27 21.89 13.74C21.95 13.37 22 12.96 22 12.5C22 8.92 18.03 8.13 14.33 10.13C14 9.73 13.59 9.42 13.11 9.22C13.3 8.29 13.74 7.24 14.73 6.75C17.09 5.57 17 2 12.5 2M12 11C12.54 11 13 11.45 13 12C13 12.55 12.54 13 12 13C11.43 13 11 12.55 11 12C11 11.45 11.43 11 12 11M18 15C16.89 15 16 15.9 16 17V23H18V21H20V23H22V17C22 15.9 21.1 15 20 15M18 17H20V19H18Z",auto_fan_mode_off:"M12.5,2C9.64,2 8.57,4.55 9.29,7.47L15,13.16C15.87,13.37 16.81,13.81 17.28,14.73C18.46,17.1 22.03,17 22.03,12.5C22.03,8.92 18.05,8.13 14.35,10.13C14.03,9.73 13.61,9.42 13.13,9.22C13.32,8.29 13.76,7.24 14.75,6.75C17.11,5.57 17,2 12.5,2M3.28,4L2,5.27L4.47,7.73C3.22,7.74 2,8.87 2,11.5C2,15.07 5.96,15.85 9.65,13.87C9.97,14.27 10.4,14.59 10.89,14.79C10.69,15.71 10.25,16.75 9.27,17.24C6.91,18.42 7,22 11.5,22C13.8,22 14.94,20.36 14.94,18.21L18.73,22L20,20.72L3.28,4Z",fan_mode:$e,power_sleep:Ee,sleep:"M23,12H17V10L20.39,6H17V4H23V6L19.62,10H23V12M15,16H9V14L12.39,10H9V8H15V10L11.62,14H15V16M7,20H1V18L4.39,14H1V12H7V14L3.62,18H7V20Z"},tr="none",ir="off",or="sleep",ar="auto_fan_none",sr="cooling",nr="heating",rr={auto_fan_none:"None",auto_fan_low:"Low",auto_fan_medium:"Medium",auto_fan_high:"High",auto_fan_turbo:"Turbo"},lr="classic",cr="vtherm",dr="uncolored",hr="gunmalmg";function ur(e){const t=window;t.customCards=t.customCards||[],t.customCards.push(Object.assign(Object.assign({},e),{preview:!0}))}function mr(e){const t=(new Date).getTime()-e.getTime();return Math.floor(t/6e4)}function _r(e,t){const i=Math.round(e*t)/t;return parseFloat(i.toFixed(t))}console.info("%c  VersatileThermostatUI-CARD \n%c  version: 2.3.0    ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),ur({type:"versatile-thermostat-ui-card",name:"Versatile Thermostat Climate Card",description:"Card for climate entity"});let pr=class extends re{_highChanged(e){if(this.isUserLocked)return;const t=e.detail.value;if(isNaN(t))return;const i=e.type.replace("-changed","");this.value=Object.assign(Object.assign({},this.value),{[i]:t}),this._selectTargetTemperature=i,this._callService(i)}_highChanging(e){if(this.isUserLocked)return;const t=e.detail.value;if(isNaN(t))return;const i=e.type.replace("-changing","");this.value=Object.assign(Object.assign({},this.value),{[i]:t}),this._selectTargetTemperature=i,this._updateDisplay(),this._vibrate(20)}_callService(e){this.isUserLocked||("high"!==e&&"low"!==e?this.hass.callService("climate","set_temperature",{entity_id:this.stateObj.entity_id,temperature:this.value.value}):this.hass.callService("climate","set_temperature",{entity_id:this.stateObj.entity_id,target_temp_low:this.value.low,target_temp_high:this.value.high}))}_handleButton(e){var t;if(this.isUserLocked)return;const i=e.currentTarget.target,o=e.currentTarget.step,a="high"===i?this.max:this.min;let s=null!==(t=this.value[i])&&void 0!==t?t:a;s+=o,s=wa(s,this.min,this.max),"high"===i&&null!=this.value.low&&(s=wa(s,this.value.low,this.max)),"low"===i&&null!=this.value.high&&(s=wa(s,this.min,this.value.high)),this.value=Object.assign(Object.assign({},this.value),{[i]:s}),this._updateDisplay(),this._vibrate(40),this._debouncedCallService(i)}_handleTempUp(){var e;if(this.isUserLocked)return;const t=this.step||.5;let i="number"==typeof(null===(e=this.value)||void 0===e?void 0:e.value)?this.value.value:this.min;i+=t,i=Math.min(i,this.max),this.value=Object.assign(Object.assign({},this.value),{value:i}),this._callService("value")}_handleTempDown(){var e;if(this.isUserLocked)return;const t=this.step||.5;let i="number"==typeof(null===(e=this.value)||void 0===e?void 0:e.value)?this.value.value:this.min;i-=t,i=Math.max(i,this.min),this.value=Object.assign(Object.assign({},this.value),{value:i}),this._callService("value")}_handleSelectTemp(e){if(this.isUserLocked)return;const t=e.currentTarget.target;this._selectTargetTemperature=t,this._updateDisplay(),this._vibrate(40)}setConfig(e){var t;this._config=Object.assign({tap_action:{action:"toggle"},hold_action:{action:"more-info"}},e);const i=this._config&&this._config.theme?this._config.theme:"";this.theme=i,this.theme?this.setAttribute("theme",this.theme):this.effectiveDisableCircle?this.effectiveDisableCircle&&!this.effectiveDisableBackgroundColor?this.setAttribute("theme","vtherm"):this.effectiveDisableCircle&&this.effectiveDisableBackgroundColor&&this.setAttribute("theme","uncolored"):this.setAttribute("theme","classic"),this._config&&this._config.theme===hr?(this._originalConfigOptions||(this._originalConfigOptions={disable_circle:this._config.disable_circle,disable_background_color:this._config.disable_background_color,disable_buttons:this._config.disable_buttons,disable_power_infos:this._config.disable_power_infos,disable_auto_fan_infos:this._config.disable_auto_fan_infos,disable_target_icon:this._config.disable_target_icon,disable_window:this._config.disable_window,disable_overpowering:this._config.disable_overpowering,allow_lock_toggle:this._config.allow_lock_toggle,disable_presets:this._config.disable_presets}),this._config.disable_circle=!0,this._config.disable_background_color=!0,this._config.disable_buttons=!0,this._config.disable_power_infos=!0,this._config.disable_auto_fan_infos=!0,this._config.disable_target_icon=!0,this._config.disable_window=!0,this._config.disable_overpowering=!0,this._config.disable_presets=null!==(t=this._config.disable_presets)&&void 0!==t&&t):this._originalConfigOptions&&(Object.assign(this._config,this._originalConfigOptions),this._originalConfigOptions=void 0,this._config=Object.assign({},this._config),this.willUpdate(new Map([["_config",void 0]])),this.requestUpdate()),this._config&&this._config.theme&&this.setAttribute("theme",this._config.theme)}_applyThemeOverrides(e){var t;this._config||(this._config={}),e===hr?(this._originalConfigOptions||(this._originalConfigOptions={disable_circle:this._config.disable_circle,disable_background_color:this._config.disable_background_color,disable_buttons:this._config.disable_buttons,disable_power_infos:this._config.disable_power_infos,disable_auto_fan_infos:this._config.disable_auto_fan_infos,disable_target_icon:this._config.disable_target_icon,disable_window:this._config.disable_window,disable_overpowering:this._config.disable_overpowering,allow_lock_toggle:this._config.allow_lock_toggle,disable_presets:this._config.disable_presets}),this._config.disable_circle=!0,this._config.disable_background_color=!0,this._config.disable_buttons=!0,this._config.disable_power_infos=!0,this._config.disable_auto_fan_infos=!0,this._config.disable_target_icon=!0,this._config.disable_window=!0,this._config.disable_overpowering=!0,this._config.disable_presets=null!==(t=this._config.disable_presets)&&void 0!==t&&t):this._originalConfigOptions&&(Object.assign(this._config,this._originalConfigOptions),this._originalConfigOptions=void 0,this._config=Object.assign({},this._config),this.willUpdate(new Map([["_config",void 0]])),this.requestUpdate())}get effectiveDisableCircle(){var e;const t=this._config&&this._config.theme?this._config.theme:void 0;return t!==lr&&(t===cr||(t===dr||(t===hr||!!(null===(e=this._config)||void 0===e?void 0:e.disable_circle))))}get effectiveDisableBackgroundColor(){var e;const t=this._config&&this._config.theme?this._config.theme:void 0;return t!==lr&&(t!==cr&&(t===dr||(t===hr||!!(null===(e=this._config)||void 0===e?void 0:e.disable_background_color))))}getCardSize(){return 1}_vibrate(e){try{navigator.vibrate(e)}catch(e){}}_toggleThemeMenu(){this._showThemeMenu=!this._showThemeMenu}_closeThemeMenu(){this._showThemeMenu=!1}_applyTheme(e){this._config||(this._config={}),this._config.theme=e,ya(this,"config-changed",{config:this._config}),this._closeThemeMenu(),this.setAttribute("theme",e),this._applyThemeOverrides(e)}async _menuLockToggle(){var e;if((null===(e=this._config)||void 0===e?void 0:e.entity)&&this.hass&&this.stateObj){if(this._hasLockCode)return this.isLocking=!this._isLocked,this.showDigicodeModal=!0,void(this.enteredCode="");try{this._isLocked?this._isLockConfigured?(await this.hass.callService("versatile_thermostat","unlock",{entity_id:this._config.entity}),this._startRelockTimeout()):(this._isLocked=this.isUserLocked=!1,this.requestUpdate(),this._startRelockTimeout()):this._isLockConfigured?await this.hass.callService("versatile_thermostat","lock",{entity_id:this._config.entity}):(this._isLocked=this.isUserLocked=!0,this.requestUpdate())}catch(e){console.error(e)}}}_menuCancelTimedPreset(){this.timedPresetActive&&this._handleCancelTimedPreset()}firstUpdated(e){this._init=!1}shouldUpdate(e){return void 0!==e.has("_config")&&void 0!==e.get("_config")&&(this._hasOverpowering=!1,this._hasWindow=!1,this._hasWindowByPass=!1,this._hasMotion=!1,this._hasPresence=!1,this._hasAutoStartStop=!1,this._isAutoStartStopEnabled=!1,this.humidity=0),void 0!==e.get("hass")&&(this._init=!1),!0}updated(e){var t,i;super.updated(e),this._firstRender=!1,e.has("showDigicodeModal")&&(this.showDigicodeModal?window.addEventListener("keydown",this._handleKeyDown):window.removeEventListener("keydown",this._handleKeyDown)),null===(i=null===(t=null==this?void 0:this.shadowRoot)||void 0===t?void 0:t.querySelector(".security"))||void 0===i||i.addEventListener("click",(()=>{var e,t,i,o;null===(t=null===(e=null==this?void 0:this.shadowRoot)||void 0===e?void 0:e.querySelector(".security"))||void 0===t||t.remove(),null===(o=null===(i=null==this?void 0:this.shadowRoot)||void 0===i?void 0:i.querySelector(".content"))||void 0===o||o.classList.remove("security_msg"),this._vibrate(2)}))}_willUpdatePower(){let e,t,i;this._externalPowerInfos=[],this._config.powerEntity&&(console.log(`There is a powerEntity ${this._config.powerEntity}`),e=this.hass.states[this._config.powerEntity],t=Number(e.state),i=e.attributes.unit_of_measurement,console.log(`Power found ${t} ${i} for ${name}`)),t&&(console.log("J'ai pushé du power"),this._externalPowerInfos.push({name:"mean_power_cycle",value:t,unit:i,class:"vt-power-color"}))}willUpdate(e){var t,i,o,a,s,n,r,l,c,d,h,u,m,_,p,g,v,f,b,y,w,k,$,x,A,C,S,T,L,M,V,E,z,P,H,D,O,j,N,R,I,U,B,F,W,Z,K,q,G,Y,X,J;if(!this.hass||!this._config||!e.has("hass")&&!e.has("_config"))return;const Q=this._config.entity;this._willUpdatePower();const ee=this.hass.states[Q];if(!ee)return void console.log("No state");const te=e.get("hass");if(!te||te.states[Q]!==ee){if(!this._config||!this.hass||!this._config.entity)return void console.log("No change return");console.log("Something may have change"),this.stateObj=ee;const e=this.stateObj.attributes,Q=this.stateObj.state;this._isLockConfigured=!0===(null==e?void 0:e.is_lock_configured),(null==e?void 0:e.lock_manager)&&(this._isLocked=(null===(t=null==e?void 0:e.lock_manager)||void 0===t?void 0:t.is_locked)||!1),this.isUserLocked=this._isLocked&&(!this._isLockConfigured||(null===(i=null==e?void 0:e.lock_manager)||void 0===i?void 0:i.lock_users)||!1),this.isAutomationLocked=this._isLocked&&((null===(o=null==e?void 0:e.lock_manager)||void 0===o?void 0:o.lock_automations)||!1),this._hasLockCode=!0===(null===(a=null==e?void 0:e.lock_manager)||void 0===a?void 0:a.lock_code),console.log(`Lock states. isConfigured:${this._isLockConfigured} isLocked=${this._isLocked} isUserLocked=${this.isUserLocked} isAutomationLocked=${this.isAutomationLocked} hasLockCode=${this._hasLockCode}`),this.name="",this.hvacMode=Q||ir,this.hvacAction=null==e?void 0:e.hvac_action,this.preset=null==e?void 0:e.preset_mode,this.modes=(null==e?void 0:e.hvac_modes)?Object.values(e.hvac_modes):[],this.presets=e.preset_modes?Object.values(e.preset_modes):[],this.isSleeping=!0===(null===(s=null==e?void 0:e.specific_states)||void 0===s?void 0:s.is_sleeping),this.powerPercent=(null===(n=null==e?void 0:e.vtherm_over_switch)||void 0===n?void 0:n.power_percent)||(null===(l=null===(r=null==e?void 0:e.vtherm_over_climate)||void 0===r?void 0:r.valve_regulation)||void 0===l?void 0:l.power_percent)||0,void 0===(null===(c=null==e?void 0:e.specific_states)||void 0===c?void 0:c.is_device_active)?(this.isDeviceActive=this.hvacAction==nr||this.hvacAction==sr,console.log(`is_device_active not found value=${this.isDeviceActive}`)):(this.isDeviceActive=!0===(null===(d=null==e?void 0:e.specific_states)||void 0===d?void 0:d.is_device_active),console.log(`is_device_active found value=${this.isDeviceActive}`)),this.temperature=null==e?void 0:e.temperature,this.step=(null===(h=null==e?void 0:e.configuration)||void 0===h?void 0:h.target_temperature_step)||.5,this.min=(null==e?void 0:e.min_temp)||7,this.max=(null==e?void 0:e.max_temp)||35,this.current=(null==e?void 0:e.current_temperature)||0,this.windowState=null===(u=null==e?void 0:e.window_manager)||void 0===u?void 0:u.window_state,this.windowAutoState=null===(m=null==e?void 0:e.window_manager)||void 0===m?void 0:m.window_auto_state,this.humidity=(null==e?void 0:e.humidity)?parseFloat(e.humidity):0,this.overpoweringState=(null===(_=null==e?void 0:e.power_manager)||void 0===_?void 0:_.overpowering_state)||"off",this.presenceState=(null===(p=null==e?void 0:e.presence_manager)||void 0===p?void 0:p.presence_state)||"off",this.motionState=(null===(g=null==e?void 0:e.motion_manager)||void 0===g?void 0:g.motion_state)||"off",this._hasWindowByPass=!0===(null===(v=null==e?void 0:e.window_manager)||void 0===v?void 0:v.is_window_bypass),this.safetyState=(null===(f=null==e?void 0:e.safety_manager)||void 0===f?void 0:f.safety_state)||"off",this.meanCyclePower=(null===(b=null==e?void 0:e.power_manager)||void 0===b?void 0:b.mean_cycle_power)||0,this.valveOpenPercent=(null===(y=null==e?void 0:e.vtherm_over_valve)||void 0===y?void 0:y.valve_open_percent)||(null===(k=null===(w=null==e?void 0:e.vtherm_over_climate_valve)||void 0===w?void 0:w.valve_regulation)||void 0===k?void 0:k.valve_open_percent)||0,this.devicePower=(null===($=null==e?void 0:e.power_manager)||void 0===$?void 0:$.device_power)||0,this.isRegulated=!0===(null===(x=null==e?void 0:e.vtherm_over_climate)||void 0===x?void 0:x.is_regulated),this.regulatedTargetTemperature=(null===(C=null===(A=null==e?void 0:e.vtherm_over_climate)||void 0===A?void 0:A.regulation)||void 0===C?void 0:C.regulated_target_temperature)||null,this.autoRegulationMode=(null===(T=null===(S=null==e?void 0:e.vtherm_over_climate)||void 0===S?void 0:S.regulation)||void 0===T?void 0:T.auto_regulation_mode)||null,this.currentAutoFanMode=(null===(L=null==e?void 0:e.vtherm_over_climate)||void 0===L?void 0:L.current_auto_fan_mode)||null,this.autoFanMode=(null===(M=null==e?void 0:e.vtherm_over_climate)||void 0===M?void 0:M.auto_fan_mode)||null,this.fanMode=(null==e?void 0:e.fan_mode)||null,this.hvacOffReason=(null===(V=null==e?void 0:e.specific_states)||void 0===V?void 0:V.hvac_off_reason)||null,this.isRecalculateScheduled=(null===(E=null==e?void 0:e.specific_states)||void 0===E?void 0:E.is_recalculate_scheduled)||null,this.isOn=!0===(null===(z=null==e?void 0:e.specific_states)||void 0===z?void 0:z.is_on),this.timedPresetActive=!0===(null===(P=null==e?void 0:e.timed_preset_manager)||void 0===P?void 0:P.is_active),this.timedPresetRemainingTime=(null===(H=null==e?void 0:e.timed_preset_manager)||void 0===H?void 0:H.remaining_time_min)||null,this.timedPresetPreset=(null===(D=null==e?void 0:e.timed_preset_manager)||void 0===D?void 0:D.preset)||null;const te=(null===(O=null==e?void 0:e.requested_state)||void 0===O?void 0:O.hvac_mode)||null;let ie=(null===(j=null==e?void 0:e.specific_states)||void 0===j?void 0:j.messages)||[];ie&&!Array.isArray(ie)&&(ie=[ie]);const oe=1==(null===(N=null==e?void 0:e.vtherm_over_climate_valve)||void 0===N?void 0:N.have_valve_regulation);if((null===(R=this._config)||void 0===R?void 0:R.disable_name)||(this.name=this._config.name?this._config.name:e.friendly_name),this.hvacMode==ir&&!0===this.isSleeping&&(this.hvacMode=or),console.log(`Mode is ${this.hvacMode}`),!0===(null==e?void 0:e.is_over_switch)&&this.powerPercent>0&&(this.hvacAction="heat"==te?nr:sr,console.log(`After hvac_action patch ${this.hvacAction}`)),console.log(`Modes are ${this.modes}`),this.modes.length>1&&this.modes.includes(ir)&&this.modes.sort(((e,t)=>"off"===e?1:"off"===t?-1:e.localeCompare(t))),console.log(`After sort modes are ${this.modes}`),this.presets.length>0&&(this.presets=this.presets.filter((e=>e!=tr&&("cool"!=Q||"frost"!=e)))),this.value={value:(null==e?void 0:e.temperature)||0,low:(null==e?void 0:e.target_temp_low)||null,high:(null==e?void 0:e.target_temp_high)||null},"on"===this.windowState||"on"===this.windowAutoState?this._hasWindow=!0:this._hasWindow=!1,"on"===this.overpoweringState?(this._hasOverpowering=!0,this.overpowering=!0):(this._hasOverpowering=!1,this.overpowering=!1),"on"===this.presenceState?(this._hasPresence=!0,this.presence=!0):(this._hasPresence=!1,this.presence=!1),"on"===this.motionState?(this._hasMotion=!0,this.motion=!0):(this._hasMotion=!1,this.motion=!1),"on"!==this.safetyState||(null===(I=null==this?void 0:this._config)||void 0===I?void 0:I.disable_safety_warning))this.safety_state=null;else{if(this.safety_state=[],this.safety_state.push({name:ha({hass:this.hass,string:"extra_states.safety_warning"}),security_msg:ha({hass:this.hass,string:"extra_states.safety_warning_msg"})}),null===(U=e.specific_states)||void 0===U?void 0:U.last_temperature_datetime){let t=mr(new Date(null===(B=e.specific_states)||void 0===B?void 0:B.last_temperature_datetime));t>0&&this.safety_state.push({name:ha({hass:this.hass,string:"extra_states.room_temp"}),security_msg:t+" "+ha({hass:this.hass,string:"extra_states.minutes"})})}if(null===(F=e.specific_states)||void 0===F?void 0:F.last_ext_temperature_datetime){let t=mr(new Date(null===(W=e.specific_states)||void 0===W?void 0:W.last_ext_temperature_datetime));t>0&&this.safety_state.push({name:ha({hass:this.hass,string:"extra_states.outdoor_temp"}),security_msg:t+" "+ha({hass:this.hass,string:"extra_states.minutes"})})}}if(console.log(`Brut messages=${ie}`),this.messages=[],this._hasError=!1,this.safety_state)for(const e of this.safety_state)this.messages.push(`${e.name}: ${e.security_msg}`),this._hasError=!0;for(const e of ie)this.messages.push(ha({hass:this.hass,string:`extra_states.${e}`}));const ae=null==e?void 0:e.heating_failure_detection_manager,se="on"===(null==ae?void 0:ae.heating_failure_state),ne="on"===(null==ae?void 0:ae.cooling_failure_state);if(se&&(this.messages.push(ha({hass:this.hass,string:"extra_states.heating_failure"})),this._hasError=!0),ne&&(this.messages.push(ha({hass:this.hass,string:"extra_states.cooling_failure"})),this._hasError=!0),console.log(`Messages=${JSON.stringify(this.messages)}`),this.powerInfos=[],console.log(`MeanCyclePower=${this.meanCyclePower} PowerPercent=${this.powerPercent} ValveOpenPercent=${this.valveOpenPercent} DevicePower=${this.devicePower}`),(null===(Z=this._config)||void 0===Z?void 0:Z.disable_power_infos)||!this.isOn&&!oe?console.log(`No power to disply is_on=${this.isOn} or disabled`):((null==e?void 0:e.is_over_switch)&&(this.meanCyclePower&&!(null===(K=this._config)||void 0===K?void 0:K.powerEntity)&&this.powerInfos.push({name:"mean_power_cycle",value:_r(this.meanCyclePower,1),unit:this.meanCyclePower<7?"kW":"W",class:"vt-power-color"}),this.powerInfos.push({name:"power_percent",value:this.powerPercent,unit:"%",class:"vt-power-color"})),((null==e?void 0:e.is_over_valve)||oe)&&(this.meanCyclePower&&!(null===(q=this._config)||void 0===q?void 0:q.powerEntity)&&this.powerInfos.push({name:"mean_power_cycle",value:_r(this.meanCyclePower,1),unit:this.meanCyclePower<7?"kW":"W",class:"vt-power-color"}),this.powerInfos.push({name:"valve_open_percent",value:this.valveOpenPercent,unit:"%",class:"vt-power-color"})),(null==e?void 0:e.is_over_climate)&&!oe&&(this.devicePower&&!(null===(G=this._config)||void 0===G?void 0:G.powerEntity)&&this.powerInfos.push({name:"mean_power_cycle",value:this.devicePower,unit:this.devicePower<7?"kW":"W",class:"vt-power-color"}),this.isRegulated&&(this.powerInfos.push({name:"regulated_target_temperature",value:this.regulatedTargetTemperature,unit:null===(Y=null==e?void 0:e.configuration)||void 0===Y?void 0:Y.temperature_unit,class:"vt-temp-color"}),this.powerInfos.push({name:"auto_regulation_mode",value:ha({hass:this.hass,string:`extra_states.${this.autoRegulationMode}`}),unit:"",class:"vt-label-color"})))),this.autoFanInfos=[],!(null===(X=null==this?void 0:this._config)||void 0===X?void 0:X.disable_auto_fan_infos)&&(null==e?void 0:e.is_over_climate)&&!oe){const e=this.currentAutoFanMode!=ar?"auto_fan_mode":"auto_fan_mode_off";console.log(`VersatileThermostat UI : auto_fan icon name ${e}`),this.autoFanInfos.push({name:e,value:ha({hass:this.hass,string:`extra_states.${this.currentAutoFanMode}`}),unit:"",class:"vt-label-color"}),this.fanMode&&this.autoFanInfos.push({name:"fan_mode",value:ha({hass:this.hass,string:`extra_states.fan_${this.fanMode}`}),unit:"",class:"vt-label-color"})}this._hasAutoStartStop="hvac_off_auto_start_stop"===this.hvacOffReason,this._isAutoStartStopConfigured=!0===(null==e?void 0:e.is_auto_start_stop_configured),this._isAutoStartStopEnabled=!0===(null===(J=null==e?void 0:e.auto_start_stop_manager)||void 0===J?void 0:J.auto_start_stop_enable),console.log(`_isAutoStartStopConfigured=${this._isAutoStartStopConfigured} _isAutoStartStopEnabled=${this._isAutoStartStopEnabled} hvac_off_reason=${this.hvacOffReason}`),this._updateDisplay()}}_updateDisplay(){var e;(null===(e=null==this?void 0:this._config)||void 0===e?void 0:e.set_current_as_main)?(this._display_bottom=this._getCurrentSetpoint(),this._display_top=this.current):(this._display_bottom=this.current,this._display_top=this._getCurrentSetpoint())}_handleAction(e){this.isUserLocked||(e.currentTarget.mode===or?this.hass.callService("versatile_thermostat","set_hvac_mode_sleep",{entity_id:this._config.entity}):this.hass.callService("climate","set_hvac_mode",{entity_id:this._config.entity,hvac_mode:e.currentTarget.mode}))}_handleDisplayMessages(){this.displayMessages=!this.displayMessages,this.requestUpdate(),this._vibrate(40)}_handlePreset(e){if(this.isUserLocked)return;this.last_target_temperature=this.temperature;const t=e.currentTarget.preset;this.timedPresetDuration&&this.timedPresetDuration>0?(this.hass.callService("versatile_thermostat","set_timed_preset",{entity_id:this._config.entity,preset:t,duration_minutes:this.timedPresetDuration}),this.timedPresetDuration=null):this.hass.callService("climate","set_preset_mode",{entity_id:this._config.entity,preset_mode:t})}_formatRemainingTime(e){if(null===e||e<=0)return"0";if(e<60)return`${e}`;const t=Math.floor(e/60),i=e%60;return 0===i?`${t}h`:`${t}h${i}`}_handleTimedPresetDurationChange(e){const t=e.target,i=t.value?parseInt(t.value,10):null;this.timedPresetDuration=i&&i>0?i:null}_handleTimedPresetSelectChange(e){const t=e.target,i=t.value?parseInt(t.value,10):null;this.timedPresetDuration=i&&i>0?i:null}_handleCancelTimedPreset(){this.isUserLocked||(console.info("VersatileThermostatUI-CARD canceling timed preset"),this.hass.callService("versatile_thermostat","cancel_timed_preset",{entity_id:this._config.entity}))}_handleClickAutoFanInfo(){if(this.isUserLocked)return;let e=ar;this.currentAutoFanMode==ar&&(e=this.autoFanMode);const t=rr[e];console.info(`VersatileThermostatUI-CARD changing auto_fan_mode to ${e} (mapped=$${t}`),t?this.hass.callService("versatile_thermostat","set_auto_fan_mode",{entity_id:this._config.entity,auto_fan_mode:t}):console.warn(`VersatileThermostatUI-CARD: auto_fan_mode ${e} has no mapping, aborting change.`)}_handleClickAutoStartStopEnable(){if(this.isUserLocked)return;let e=!this._isAutoStartStopEnabled;console.info(`VersatileThermostatUI-CARD changing auto_start_stop_enable to ${e}`),this.hass.callService("switch","toggle",{entity_id:this._config.autoStartStopEnableEntity})}_handleToggleWindowByPass(){if(this.isUserLocked)return;console.log(`_handleToggleWindowByPass called. Current windowByPass is ${this._hasWindowByPass}`);let e=!this._hasWindowByPass;console.info(`VersatileThermostatUI-CARD changing windowByPass to ${e}`),this.hass.callService("versatile_thermostat","set_window_bypass",{entity_id:this._config.entity,window_bypass:e})}_getCurrentSetpoint(){var e,t,i,o,a,s,n,r;return null!==(null===(e=null==this?void 0:this.value)||void 0===e?void 0:e.high)&&null!==(null===(t=null==this?void 0:this.value)||void 0===t?void 0:t.low)?((null===(i=null==this?void 0:this.value)||void 0===i?void 0:i.low)||0)>=this.current?(null===(o=null==this?void 0:this.value)||void 0===o?void 0:o.low)||0:((null===(a=null==this?void 0:this.value)||void 0===a?void 0:a.high)||0)<=this.current?(null===(s=null==this?void 0:this.value)||void 0===s?void 0:s.high)||0:(null===(n=null==this?void 0:this.value)||void 0===n?void 0:n.low)||0:(null===(r=null==this?void 0:this.value)||void 0===r?void 0:r.value)||0}_renderHVACAction(){return this.hvacAction&&"off"!==this.hvacAction&&"idle"!==this.hvacAction?"heating"===this.hvacAction?F`<path class="status ${this.isDeviceActive?"active":""}"  transform="translate(5,-4) scale(0.25)" fill="#9d9d9d"  d="${Ae}" />`:"cooling"===this.hvacAction||"cool"==this.hvacMode?F`<path class="status cooler ${this.isDeviceActive?"active":""}"  transform="translate(5,-4) scale(0.25)" fill="#9d9d9d"  d="${be}" />`:F`<path class="status" transform="translate(5,-4) scale(0.25)" fill="#9d9d9d"  d="${we}" />`:B``}_renderHVACActionBadge(){return this.hvacAction&&"off"!==this.hvacAction&&"idle"!==this.hvacAction?"heating"===this.hvacAction?F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="${Ae}"/></svg>`:"cooling"===this.hvacAction?F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="${be}"/></svg>`:F`<svg viewBox="0 0 24 24" aria-hidden="true"><path d="${ye}"/></svg>`:B``}_renderIcon(e,t,i){if(!er[e])return B``;const o=this.hass.localize(`component.climate.state._.${e}`)||ha({hass:this.hass,string:`extra_states.${e}`});return B`
      <div class="hvac-badge-container">
        <ha-icon-button
          ...
          .label=${o}
        ></ha-icon-button>
        ${(()=>{if(this.theme!==hr)return B``;let e="";return this.hvacAction&&"off"!==this.hvacAction&&"idle"!==this.hvacAction?(e="heating"===this.hvacAction?"heating":"cooling"===this.hvacAction?"cooling":"warning",B`<div class="hvac-badge ${e}">${this._renderHVACActionBadge()}</div>`):B``})()}
      </div>
    `}async _cycleHvacMode(){var e;if(!(null===(e=this._config)||void 0===e?void 0:e.entity)||!this.hass)return;const t=Array.isArray(this.modes)&&this.modes.length>0?this.modes:[];if(0===t.length)return;const i=this.hvacMode||"";let o=t.indexOf(i);-1===o&&(o=0);const a=t[(o+1)%t.length];try{a===or?await this.hass.callService("versatile_thermostat","set_hvac_mode_sleep",{entity_id:this._config.entity}):await this.hass.callService("climate","set_hvac_mode",{entity_id:this._config.entity,hvac_mode:a})}catch(e){console.error(e)}}_renderMessagesButton(){const e=ha({hass:this.hass,string:"extra_states.messages-button"});return B`
      <ha-icon-button
        title="${e}"
        class="messages-button ${this._hasError?"error":""}"
        @click=${this._handleDisplayMessages}
        tabindex="0"
        .path=${this._hasError?ye:Se}
        .label=${e}
      >
      </ha-icon-button>
    `}_renderRecalculateScheduledButton(){const e=ha({hass:this.hass,string:"extra_states.recalculation_scheduled"});return B`
      <ha-icon-button
        title="${e}"
    ...
    `}_renderWindowByPassButton(){const e=ha({hass:this.hass,string:"extra_states.window-bypass-button"});return B`
      <ha-icon-button
        title="${e}"
    ...
    `}_renderPreset(e,t){const i=(this.hass.localize(`component.climate.state._.${e}`)||ha({hass:this.hass,string:`extra_states.${e}`}))+"\n"+ha({hass:this.hass,string:"extra_states.change_message"});return B`
    ...
    `}_renderPowerInfo(e){const t=this.hass.localize(`component.climate.state._.${e.name}`)||ha({hass:this.hass,string:`extra_states.${e.name}`});return B`
    ...
    `}_renderAutoFanInfo(e){const t=(this.hass.localize(`component.climate.state._.${e.name}`)||ha({hass:this.hass,string:`extra_states.${e.name}`}))+"\n"+ha({hass:this.hass,string:"extra_states.toggle_message"});return B`
      <div class="left-info-label">
        <span>
          <ha-icon-button
            title="${t}"
    ...
    `}_renderAutoStartStopEnable(){const e=ha({hass:this.hass,string:"extra_states.auto_start_stop_enable"}),t=ha({hass:this.hass,string:"extra_states.auto_start_stop_label"}),i=this._isAutoStartStopEnabled?"checked":"";return console.log(`checked=${i}`),B`
      ...
      ${e._showThemeMenu?B`
        ...
        <div class="theme-menu">
          <div class="theme-menu-header">
            <div class="theme-menu-title" @click=${()=>{e._handleMoreInfo(),e._closeThemeMenu()}}>${ha({hass:e.hass,string:"editor.card.climate.menu_system"})}</div>
          </div>
          <div class="theme-menu-item" style="border-top:1px solid var(--divider-color, #e0e0e0);"></div>
          

          <div class="theme-menu-item" @click=${()=>e._applyTheme("classic")}>${ha({hass:e.hass,string:"editor.card.climate.theme_classic"})}</div>
          <div class="theme-menu-item" @click=${()=>e._applyTheme("vtherm")}>${ha({hass:e.hass,string:"editor.card.climate.theme_vtherm"})}</div>
          <div class="theme-menu-item" @click=${()=>e._applyTheme("uncolored")}>${ha({hass:e.hass,string:"editor.card.climate.theme_uncolored"})}</div>

          <div class="theme-menu-item" style="border-top:1px solid var(--divider-color, #e0e0e0);"></div>
          ${e.timedPresetActive?B`
            <div class="theme-menu-item" @click=${()=>{e._menuCancelTimedPreset(),e._closeThemeMenu()}}>
              ${ha({hass:e.hass,string:"extra_states.cancel_timed_preset"})}
            </div>
          `:""}
          <div class="theme-menu-item" @click=${()=>{e._handleTempUp(),e._closeThemeMenu()}}>
              ${ha({hass:e.hass,string:"extra_states.increase_temp"})||"+ Température"}
          </div>
          <div class="theme-menu-item" @click=${()=>{e._handleTempDown(),e._closeThemeMenu()}}>
              ${ha({hass:e.hass,string:"extra_states.decrease_temp"})||"- Température"}
          </div>
        </div>
      `:""}
   ...
   >
    ${(null===(t=this._config)||void 0===t?void 0:t.disable_menu)?"":B`
      ...
      ${this._showThemeMenu?B`
        ...
        <div class="theme-menu">
          <div class="theme-menu-header">
            <div class="theme-menu-title" @click=${()=>{this._handleMoreInfo(),this._closeThemeMenu()}}>${ha({hass:this.hass,string:"editor.card.climate.menu_system"})}</div>
          </div>
          <div class="theme-menu-item" style="border-top:1px solid var(--divider-color, #e0e0e0);"></div>
          ${""}
          ${(null===(i=this._config)||void 0===i?void 0:i.theme)===hr?B`
            <div class="theme-menu-item" @click=${()=>{this._menuLockToggle(),this._closeThemeMenu()}}>
              ${this._isLocked?ha({hass:this.hass,string:"extra_states.unlock"}):ha({hass:this.hass,string:"extra_states.lock"})}
            </div>
            ${this.timedPresetActive?B`
              <div class="theme-menu-item" @click=${()=>{this._menuCancelTimedPreset(),this._closeThemeMenu()}}>
                ${ha({hass:this.hass,string:"extra_states.cancel_timed_preset"})}
              </div>
            `:""}
          `:""}
          <div class="theme-menu-item" @click=${()=>this._applyTheme("classic")}>${ha({hass:this.hass,string:"editor.card.climate.theme_classic"})}</div>
          <div class="theme-menu-item" @click=${()=>this._applyTheme("vtherm")}>${ha({hass:this.hass,string:"editor.card.climate.theme_vtherm"})}</div>
          <div class="theme-menu-item" @click=${()=>this._applyTheme("uncolored")}>${ha({hass:this.hass,string:"editor.card.climate.theme_uncolored"})}</div>
          <div class="theme-menu-item" @click=${()=>this._applyTheme("gunmalmg")}>${ha({hass:this.hass,string:"editor.card.climate.theme_gunmalmg"})}</div>
        </div>
      `:""}
      `}
      ...
      ${this.messages.length>0&&this.displayMessages?B`
        <div class="messages">
          <ha-icon-button class="alert" .path=${this._hasError?ye:Se}>
          </ha-icon-button>
          ...
          <div class="content${(null===(a=this._config)||void 0===a?void 0:a.disable_presets)?" no-presets":""} ${0==this.name.length?" noname":""} ${null!==this.safety_state||this.displayMessages?" security_msg":""} ${this._hasWindow?" window_open":""}  ${this.overpowering?" overpowering":""} ${this.presence?" presence":""} ${this.motion?" motion":""}  ${this._hasWindowByPass?" windowByPass":""} " >
            <svg id="main" viewbox="0 0 125 100">
              <g transform="translate(57.5,37) scale(0.35)">
                ...
                `:""}
                ${this._hasPresence&&(null===(c=this._config)||void 0===c?void 0:c.theme)!==hr?F`
                ...
                ${this._hasAutoStartStop&&!(null===(d=this._config)||void 0===d?void 0:d.disable_autoStartStop)?F`
                  <path class="auto-start-stop" transform="${this._hasAutoStartStop&&!(null===(h=this._config)||void 0===h?void 0:h.disable_autoStartStop)?"translate(25.25,0)":""}" id="autoStartStop" d=${Ee}/>
                `:""}
                ${this._hasMotion&&(null===(u=this._config)||void 0===u?void 0:u.theme)!==hr?F`
                  <path class="motion ${this.motion?"active":""}" transform="${this._hasMotion?"translate(50.25,0)":""}" id="motion" d=${Ve} />
                `:""}
              </g>
      ...
      <div id="presets" class="${null!==this.safety_state||this.displayMessages?"security_msg":""}">
        ...
        ${(null===(y=this._config)||void 0===y?void 0:y.disable_timed_preset)?"":B`
          <div class="timed-preset-container">
            ${this.timedPresetActive?B`
              <span class="timed-preset-remaining" title="${ha({hass:this.hass,string:"extra_states.timed_preset_active"})}">
                ${this._formatRemainingTime(this.timedPresetRemainingTime)}
              </span>
              ${(null!==(w=this.timedPresetRemainingTime)&&void 0!==w?w:0)<60?B`
                <span class="timed-preset-label">${ha({hass:this.hass,string:"extra_states.minutes"})}</span>
              `:""}
              <ha-icon-button
                class="timed-preset-cancel"
                @click=${this._handleCancelTimedPreset}
                title="${ha({hass:this.hass,string:"extra_states.cancel_timed_preset"})}"
                .path=${we}
              ></ha-icon-button>
            `:(null===(k=this._config)||void 0===k?void 0:k.use_manual_duration_input)?B`
              <input
                ...
                min="0"
                max="1440"
                title="${ha({hass:this.hass,string:"extra_states.timed_preset_title"})}"
              />
              <span class="timed-preset-label">${ha({hass:this.hass,string:"extra_states.minutes"})}</span>
            `:B`
              <select
              ...
              >
                ...
                <option value="15" ?selected=${15===this.timedPresetDuration}>15 ${ha({hass:this.hass,string:"extra_states.minutes"})}</option>
                <option value="30" ?selected=${30===this.timedPresetDuration}>30 ${ha({hass:this.hass,string:"extra_states.minutes"})}</option>
    ...
    <div id="right-lock">
      ${(null===(A=this._config)||void 0===A?void 0:A.allow_lock_toggle)?B`
              <ha-icon-button
                class="lock-icon ${this._isLocked?"locked":"unlocked"}"
                .path=${this._isLocked?Te:Le}
    ...
    >
      <div class="dialog-content">
        <h2 class="dialog-title">
          ${this.isLocking?ha({hass:this.hass,string:"extra_states.lock"}):ha({hass:this.hass,string:"extra_states.unlock"})} ${this.name}
        </h2>
        ...
        <div class="error-message ${this.codeError?"visible":""}">
          ${ha({hass:this.hass,string:"extra_states.code_error"})}
        </div>
  ...
  `}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._handleKeyDown),this._clearRelockTimeout()}static async getConfigElement(){return await Promise.resolve().then((function(){return kr})),document.createElement("versatile-thermostat-ui-card-editor")}static async getStubConfig(e){const t=Object.keys(e.states).filter((e=>["climate"].includes(e.split(".")[0]))),i=t.filter((t=>{var i;return null===(i=e.states[t].attributes)||void 0===i?void 0:i.specific_states}));return{type:"custom:versatile-thermostat-ui-card",entity:i[0]||t[0]}}};pr.styles=[n`
      :host {
          display: block;
  ...
  `,Jn,Qn],pr.additionalThemeStyles=[Qn],e([ue({attribute:!1})],pr.prototype,"hass",void 0),e([ue({type:Number})],pr.prototype,"value",void 0),e([me()],pr.prototype,"_selectTargetTemperature",void 0),e([ue({type:Number})],pr.prototype,"current",void 0),e([ue({type:Number})],pr.prototype,"humidity",void 0),e([ue({type:Number})],pr.prototype,"temperature",void 0),e([ue({type:Number})],pr.prototype,"min",void 0),e([ue({type:Number})],pr.prototype,"max",void 0),e([ue({type:Number})],pr.prototype,"step",void 0),e([ue({type:Number})],pr.prototype,"powerPercent",void 0),e([ue({type:Number})],pr.prototype,"meanCyclePower",void 0),e([ue({type:Number})],pr.prototype,"valveOpenPercent",void 0),e([ue({type:Number})],pr.prototype,"devicePower",void 0),e([ue({type:Number})],pr.prototype,"regulatedTargetTemperature",void 0),e([ue({type:Boolean})],pr.prototype,"isOn",void 0),e([ue({type:Boolean})],pr.prototype,"window",void 0),e([ue({type:Boolean})],pr.prototype,"windowByPass",void 0),e([ue({type:Boolean})],pr.prototype,"presence",void 0),e([ue({type:Boolean})],pr.prototype,"motion",void 0),e([ue({type:Boolean})],pr.prototype,"overpowering",void 0),e([ue({type:Boolean})],pr.prototype,"isDeviceActive",void 0),e([ue({type:Boolean})],pr.prototype,"isSleeping",void 0),e([ue({type:Boolean})],pr.prototype,"isRegulated",void 0),e([ue({type:Boolean})],pr.prototype,"isRecalculateScheduled",void 0),e([ue({type:String})],pr.prototype,"windowState",void 0),e([ue({type:String})],pr.prototype,"windowAutoState",void 0),e([ue({type:String})],pr.prototype,"overpoweringState",void 0),e([ue({type:String})],pr.prototype,"presenceState",void 0),e([ue({type:String})],pr.prototype,"motionState",void 0),e([ue({type:String})],pr.prototype,"safetyState",void 0),e([ue({type:String})],pr.prototype,"status",void 0),e([ue({type:String})],pr.prototype,"hvacMode",void 0),e([ue({type:String})],pr.prototype,"hvacAction",void 0),e([ue({type:String})],pr.prototype,"preset",void 0),e([ue({type:String})],pr.prototype,"autoRegulationMode",void 0),e([ue({type:String})],pr.prototype,"currentAutoFanMode",void 0),e([ue({type:String})],pr.prototype,"autoFanMode",void 0),e([ue({type:String})],pr.prototype,"fanMode",void 0),e([ue({type:String})],pr.prototype,"hvacOffReason",void 0),e([ue({type:Boolean,reflect:!0})],pr.prototype,"dragging",void 0),e([ue({type:String})],pr.prototype,"name",void 0),e([me()],pr.prototype,"changingHigh",void 0),e([me()],pr.prototype,"_hasError",void 0),e([me()],pr.prototype,"_config",void 0),e([me()],pr.prototype,"_showThemeMenu",void 0),e([ue({type:String})],pr.prototype,"theme",void 0),e([me()],pr.prototype,"isLocked",void 0),e([me()],pr.prototype,"isUserLocked",void 0),e([me()],pr.prototype,"isAutomationLocked",void 0),e([me()],pr.prototype,"showDigicodeModal",void 0),e([me()],pr.prototype,"enteredCode",void 0),e([me()],pr.prototype,"codeError",void 0),e([me()],pr.prototype,"isLocking",void 0),e([me()],pr.prototype,"timedPresetDuration",void 0),e([me()],pr.prototype,"timedPresetActive",void 0),e([me()],pr.prototype,"timedPresetRemainingTime",void 0),e([me()],pr.prototype,"timedPresetPreset",void 0),pr=e([ce("versatile-thermostat-ui-card")],pr);const gr=function(...e){const t="type"===e[0].type,i=e.map((e=>e.schema)),o=Object.assign({},...i);return t?Ia(o):ja(o)}(ja({index:Na(Oa()),view_index:Na(Oa()),view_layout:za("any",(()=>!0)),type:Ra()}),ja({entity:Na(Ra()),name:Na(Ra()),icon:Na(Ra()),autoStartStopEnableEntity:Na(Ra()),powerEntity:Na(Ra())}),ja({disable_name:Na(Ha()),disable_circle:Na(Ha()),disable_background_color:Na(Ha()),disable_window:Na(Ha()),disable_autoStartStop:Na(Ha()),disable_overpowering:Na(Ha()),disable_heat:Na(Ha()),disable_cool:Na(Ha()),disable_heat_cool:Na(Ha()),disable_auto:Na(Ha()),disable_dry:Na(Ha()),disable_fan_only:Na(Ha()),disable_off:Na(Ha()),disable_sleep:Na(Ha()),disable_safety_warning:Na(Ha()),disable_power_infos:Na(Ha()),disable_auto_fan_infos:Na(Ha()),disable_target_icon:Na(Ha()),set_current_as_main:Na(Ha()),eco_temperature:Na(Oa()),disable_menu:Na(Ha()),disable_buttons:Na(Ha()),allow_lock_toggle:Na(Ha()),lock_relock_delay:Na(Oa()),disable_presets:Na(Ha()),theme:Na(Ua([Da("classic"),Da("vtherm"),Da("uncolored"),Da("gunmalmg")])),disable_timed_preset:Na(Ha()),use_manual_duration_input:Na(Ha())})),vr=["icon_color","layout","fill_container","primary_info","secondary_info","icon_type","content_info","use_entity_picture","collapsible_controls","icon_animation"],fr=e=>{var t,i;customElements.get("ha-form")&&(customElements.get("hui-action-editor")||((e,t,i,o)=>{const[a,s,n]=e.split(".",3);return Number(a)>t||Number(a)===t&&(void 0===o?Number(s)>=i:Number(s)>i)||void 0!==o&&Number(a)===t&&Number(s)===i&&Number(n)>=o})(e,2022,11))||null===(t=customElements.get("hui-button-card"))||void 0===t||t.getConfigElement(),customElements.get("ha-entity-picker")||null===(i=customElements.get("hui-entities-card"))||void 0===i||i.getConfigElement()},br=["theme","autoStartStopEnableEntity","powerEntity","disable_name","disable_window","disable_autoStartStop","disable_overpowering","disable_heat","disable_cool","disable_heat_cool","disable_auto","disable_dry","disable_fan_only","disable_off","disable_sleep","disable_menu","disable_safety_warning","disable_buttons","set_current_as_main","disable_power_infos","disable_auto_fan_infos","disable_target_icon","allow_lock_toggle","lock_relock_delay","disable_presets","disable_timed_preset","use_manual_duration_input"],yr=fa((e=>[{name:"entity",selector:{entity:{domain:["climate"]}}},{name:"name",selector:{text:{}}},{name:"theme",selector:{select:{options:e}}},{type:"grid",name:"",schema:[{name:"autoStartStopEnableEntity",selector:{entity:{domain:["switch"]}}},{name:"powerEntity",selector:{entity:{domain:["sensor","input_number"]}}}]},{type:"grid",name:"",schema:[{name:"disable_name",selector:{boolean:{}}},{name:"disable_window",selector:{boolean:{}}},{name:"disable_autoStartStop",selector:{boolean:{}}},{name:"disable_overpowering",selector:{boolean:{}}},{name:"disable_heat",selector:{boolean:{}}},{name:"disable_cool",selector:{boolean:{}}},{name:"disable_heat_cool",selector:{boolean:{}}},{name:"disable_auto",selector:{boolean:{}}},{name:"disable_dry",selector:{boolean:{}}},{name:"disable_fan_only",selector:{boolean:{}}},{name:"disable_off",selector:{boolean:{}}},{name:"disable_sleep",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"disable_safety_warning",selector:{boolean:{}}},{name:"disable_buttons",selector:{boolean:{}}},{name:"set_current_as_main",selector:{boolean:{}}},{name:"disable_power_infos",selector:{boolean:{}}},{name:"disable_auto_fan_infos",selector:{boolean:{}}},{name:"disable_target_icon",selector:{boolean:{}}},{name:"allow_lock_toggle",selector:{boolean:{}}},{name:"lock_relock_delay",selector:{number:{min:0,max:3600,unit_of_measurement:"s",mode:"box"}}},{name:"disable_presets",selector:{boolean:{}}},{name:"disable_timed_preset",selector:{boolean:{}}},{name:"use_manual_duration_input",selector:{boolean:{}}}]}]));let wr=class extends re{constructor(){super(...arguments),this._computeLabel=e=>{const t=ma(this.hass);return vr.includes(e.name)?t(`editor.card.generic.${e.name}`):br.includes(e.name)?t(`editor.card.climate.${e.name}`):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)}}connectedCallback(){super.connectedCallback(),fr(this.hass.connection.haVersion)}setConfig(e){Va(e,gr),this._config=e}render(){if(!this.hass||!this._config)return B``;const e=ma(this.hass),t=[{value:"classic",label:e("editor.card.climate.theme_classic")||"Classic"},{value:"vtherm",label:e("editor.card.climate.theme_vtherm")||"VTherm"},{value:"uncolored",label:e("editor.card.climate.theme_uncolored")||"Uncolored"},{value:"gunmalmg",label:e("editor.card.climate.theme_gunmalmg")||"Gunmalmg"}],i=yr(t);return B`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${i}
            ...
            ></ha-form>
        `}_valueChanged(e){const t=e.detail.value;if(!t.theme){const e=!!t.disable_circle,i=!!t.disable_background_color;e?e&&!i?t.theme="vtherm":e&&i&&(t.theme="uncolored"):t.theme="classic"}ya(this,"config-changed",{config:t}),ya(this,"hass",{config:t})}};e([me()],wr.prototype,"_config",void 0),e([ue({attribute:!1})],wr.prototype,"hass",void 0),wr=e([ce("versatile-thermostat-ui-card-editor")],wr);var kr=Object.freeze({__proto__:null,get ClimateCardEditor(){return wr}});export{pr as VersatileThermostatUi,ur as registerCustomCard};
