 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;function mt(t,e){return(i,o,n)=>{const a=e=>e.renderRoot?.querySelector(t)??null;if(e){const{get:t,set:s}="object"==typeof o?i:n??(()=>{const t=Symbol();return{get(){return this[t]},set(e){this[t]=e}}})();return pt(i,o,{get(){if(e){let e=t.call(this);return void 0===e&&(e=a(this),s.call(this,e)),e}return a(this)}})}return pt(i,o,{get(){return a(this)}})}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;const uo=([[t,e],[i,o]],[n,a])=>[t*n+e*a,i*n+o*a],ho=([t,e],[i,o])=>[t+i,e+o],_o=t=>t/180*Math.PI,po=t=>{const{x:e,y:i,r:o,start:n,end:a,rotate:s=0}=t,r=e,l=i,c=o,d=o,u=_o(n),h=(_o(a)-u)%(2*Math.PI),_=_o(s),p=(t=>[[Math.cos(t),-Math.sin(t)],[Math.sin(t),Math.cos(t)]])(_),[m,v]=ho(uo(p,[c*Math.cos(u),d*Math.sin(u)]),[r,l]),[f,g]=ho(uo(p,[c*Math.cos(u+h),d*Math.sin(u+h)]),[r,l]),y=h>Math.PI?1:0,b=h>0?1:0;return["M",m,v,"A",c,d,_/(2*Math.PI)*360,y,b,f,g].join(" ")};function mo(){return mo=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var i=arguments[e];for(var o in i)Object.prototype.hasOwnProperty.call(i,o)&&(t[o]=i[o])}return t},mo.apply(this,arguments)}function vo(t,e){t.prototype=Object.create(e.prototype),t.prototype.constructor=t,t.__proto__=e}function fo(t){if(void 0===t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return t}var go,yo="function"!=typeof Object.assign?function(t){if(null==t)throw new TypeError("Cannot convert undefined or null to object");for(var e=Object(t),i=1;i<arguments.length;i++){var o=arguments[i];if(null!=o)for(var n in o)o.hasOwnProperty(n)&&(e[n]=o[n])}return e}:Object.assign,bo=["","webkit","Moz","MS","ms","o"],wo="undefined"==typeof document?{style:{}}:document.createElement("div"),ko=Math.round,$o=Math.abs,Ao=Date.now;function Co(t,e){for(var i,o,n=e[0].toUpperCase()+e.slice(1),a=0;a<bo.length;){if((o=(i=bo[a])?i+n:e)in t)return o;a++}}go="undefined"==typeof window?{}:window;var xo=Co(wo.style,"touchAction"),So=void 0!==xo;var Lo="compute",Mo="auto",Eo="manipulation",To="none",Vo="pan-x",zo="pan-y",Ho=function(){if(!So)return!1;var t={},e=go.CSS&&go.CSS.supports;return["auto","manipulation","pan-y","pan-x","pan-x pan-y","none"].forEach((function(i){return t[i]=!e||go.CSS.supports("touch-action",i)})),t}(),Po="ontouchstart"in go,Do=void 0!==Co(go,"PointerEvent"),Oo=Po&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),No="touch",jo="mouse",Io=25,Ro=1,Bo=4,Uo=8,Wo=1,Fo=2,Zo=4,qo=8,Ko=16,Yo=Fo|Zo,Xo=qo|Ko,Go=Yo|Xo,Jo=["x","y"],Qo=["clientX","clientY"];function tn(t,e,i){var o;if(t)if(t.forEach)t.forEach(e,i);else if(void 0!==t.length)for(o=0;o<t.length;)e.call(i,t[o],o,t),o++;else for(o in t)t.hasOwnProperty(o)&&e.call(i,t[o],o,t)}function en(t,e){return"function"==typeof t?t.apply(e&&e[0]||void 0,e):t}function on(t,e){return t.indexOf(e)>-1}var nn=function(){function t(t,e){this.manager=t,this.set(e)}var e=t.prototype;return e.set=function(t){t===Lo&&(t=this.compute()),So&&this.manager.element.style&&Ho[t]&&(this.manager.element.style[xo]=t),this.actions=t.toLowerCase().trim()},e.update=function(){this.set(this.manager.options.touchAction)},e.compute=function(){var t=[];return tn(this.manager.recognizers,(function(e){en(e.options.enable,[e])&&(t=t.concat(e.getTouchAction()))})),function(t){if(on(t,To))return To;var e=on(t,Vo),i=on(t,zo);return e&&i?To:e||i?e?Vo:zo:on(t,Eo)?Eo:Mo}(t.join(" "))},e.preventDefaults=function(t){var e=t.srcEvent,i=t.offsetDirection;if(this.manager.session.prevented)e.preventDefault();else{var o=this.actions,n=on(o,To)&&!Ho[To],a=on(o,zo)&&!Ho[zo],s=on(o,Vo)&&!Ho[Vo];if(n){var r=1===t.pointers.length,l=t.distance<2,c=t.deltaTime<250;if(r&&l&&c)return}if(!s||!a)return n||a&&i&Yo||s&&i&Xo?this.preventSrc(e):void 0}},e.preventSrc=function(t){this.manager.session.prevented=!0,t.preventDefault()},t}();function an(t,e){for(;t;){if(t===e)return!0;t=t.parentNode}return!1}function sn(t){var e=t.length;if(1===e)return{x:ko(t[0].clientX),y:ko(t[0].clientY)};for(var i=0,o=0,n=0;n<e;)i+=t[n].clientX,o+=t[n].clientY,n++;return{x:ko(i/e),y:ko(o/e)}}function rn(t){for(var e=[],i=0;i<t.pointers.length;)e[i]={clientX:ko(t.pointers[i].clientX),clientY:ko(t.pointers[i].clientY)},i++;return{timeStamp:Ao(),pointers:e,center:sn(e),deltaX:t.deltaX,deltaY:t.deltaY}}function ln(t,e,i){i||(i=Jo);var o=e[i[0]]-t[i[0]],n=e[i[1]]-t[i[1]];return Math.sqrt(o*o+n*n)}function cn(t,e,i){i||(i=Jo);var o=e[i[0]]-t[i[0]],n=e[i[1]]-t[i[1]];return 180*Math.atan2(n,o)/Math.PI}function dn(t,e){return t===e?Wo:$o(t)>=$o(e)?t<0?Fo:Zo:e<0?qo:Ko}function un(t,e,i){return{x:e/t||0,y:i/t||0}}function hn(t,e){var i=t.session,o=e.pointers,n=o.length;i.firstInput||(i.firstInput=rn(e)),n>1&&!i.firstMultiple?i.firstMultiple=rn(e):1===n&&(i.firstMultiple=!1);var a=i.firstInput,s=i.firstMultiple,r=s?s.center:a.center,l=e.center=sn(o);e.timeStamp=Ao(),e.deltaTime=e.timeStamp-a.timeStamp,e.angle=cn(r,l),e.distance=ln(r,l),function(t,e){var i=e.center,o=t.offsetDelta||{},n=t.prevDelta||{},a=t.prevInput||{};e.eventType!==Ro&&a.eventType!==Bo||(n=t.prevDelta={x:a.deltaX||0,y:a.deltaY||0},o=t.offsetDelta={x:i.x,y:i.y}),e.deltaX=n.x+(i.x-o.x),e.deltaY=n.y+(i.y-o.y)}(i,e),e.offsetDirection=dn(e.deltaX,e.deltaY);var c,d,u=un(e.deltaTime,e.deltaX,e.deltaY);e.overallVelocityX=u.x,e.overallVelocityY=u.y,e.overallVelocity=$o(u.x)>$o(u.y)?u.x:u.y,e.scale=s?(c=s.pointers,ln((d=o)[0],d[1],Qo)/ln(c[0],c[1],Qo)):1,e.rotation=s?function(t,e){return cn(e[1],e[0],Qo)+cn(t[1],t[0],Qo)}(s.pointers,o):0,e.maxPointers=i.prevInput?e.pointers.length>i.prevInput.maxPointers?e.pointers.length:i.prevInput.maxPointers:e.pointers.length,function(t,e){var i,o,n,a,s=t.lastInterval||e,r=e.timeStamp-s.timeStamp;if(e.eventType!==Uo&&(r>Io||void 0===s.velocity)){var l=e.deltaX-s.deltaX,c=e.deltaY-s.deltaY,d=un(r,l,c);o=d.x,n=d.y,i=$o(d.x)>$o(d.y)?d.x:d.y,a=dn(l,c),t.lastInterval=e}else i=s.velocity,o=s.velocityX,n=s.velocityY,a=s.direction;e.velocity=i,e.velocityX=o,e.velocityY=n,e.direction=a}(i,e);var h,_=t.element,p=e.srcEvent;an(h=p.composedPath?p.composedPath()[0]:p.path?p.path[0]:p.target,_)&&(_=h),e.target=_}function _n(t,e,i){var o=i.pointers.length,n=i.changedPointers.length,a=e&Ro&&o-n==0,s=e&(Bo|Uo)&&o-n==0;i.isFirst=!!a,i.isFinal=!!s,a&&(t.session={}),i.eventType=e,hn(t,i),t.emit("hammer.input",i),t.recognize(i),t.session.prevInput=i}function pn(t){return t.trim().split(/\s+/g)}function mn(t,e,i){tn(pn(e),(function(e){t.addEventListener(e,i,!1)}))}function vn(t,e,i){tn(pn(e),(function(e){t.removeEventListener(e,i,!1)}))}function fn(t){var e=t.ownerDocument||t;return e.defaultView||e.parentWindow||window}var gn=function(){function t(t,e){var i=this;this.manager=t,this.callback=e,this.element=t.element,this.target=t.options.inputTarget,this.domHandler=function(e){en(t.options.enable,[t])&&i.handler(e)},this.init()}var e=t.prototype;return e.handler=function(){},e.init=function(){this.evEl&&mn(this.element,this.evEl,this.domHandler),this.evTarget&&mn(this.target,this.evTarget,this.domHandler),this.evWin&&mn(fn(this.element),this.evWin,this.domHandler)},e.destroy=function(){this.evEl&&vn(this.element,this.evEl,this.domHandler),this.evTarget&&vn(this.target,this.evTarget,this.domHandler),this.evWin&&vn(fn(this.element),this.evWin,this.domHandler)},t}();function yn(t,e,i){if(t.indexOf&&!i)return t.indexOf(e);for(var o=0;o<t.length;){if(i&&t[o][i]==e||!i&&t[o]===e)return o;o++}return-1}var bn={pointerdown:Ro,pointermove:2,pointerup:Bo,pointercancel:Uo,pointerout:Uo},wn={2:No,3:"pen",4:jo,5:"kinect"},kn="pointerdown",$n="pointermove pointerup pointercancel";go.MSPointerEvent&&!go.PointerEvent&&(kn="MSPointerDown",$n="MSPointerMove MSPointerUp MSPointerCancel");var An=function(t){function e(){var i,o=e.prototype;return o.evEl=kn,o.evWin=$n,(i=t.apply(this,arguments)||this).store=i.manager.session.pointerEvents=[],i}return vo(e,t),e.prototype.handler=function(t){var e=this.store,i=!1,o=t.type.toLowerCase().replace("ms",""),n=bn[o],a=wn[t.pointerType]||t.pointerType,s=a===No,r=yn(e,t.pointerId,"pointerId");n&Ro&&(0===t.button||s)?r<0&&(e.push(t),r=e.length-1):n&(Bo|Uo)&&(i=!0),r<0||(e[r]=t,this.callback(this.manager,n,{pointers:e,changedPointers:[t],pointerType:a,srcEvent:t}),i&&e.splice(r,1))},e}(gn);function Cn(t){return Array.prototype.slice.call(t,0)}function xn(t,e,i){for(var o=[],n=[],a=0;a<t.length;){var s=e?t[a][e]:t[a];yn(n,s)<0&&o.push(t[a]),n[a]=s,a++}return i&&(o=e?o.sort((function(t,i){return t[e]>i[e]})):o.sort()),o}var Sn={touchstart:Ro,touchmove:2,touchend:Bo,touchcancel:Uo},Ln=function(t){function e(){var i;return e.prototype.evTarget="touchstart touchmove touchend touchcancel",(i=t.apply(this,arguments)||this).targetIds={},i}return vo(e,t),e.prototype.handler=function(t){var e=Sn[t.type],i=Mn.call(this,t,e);i&&this.callback(this.manager,e,{pointers:i[0],changedPointers:i[1],pointerType:No,srcEvent:t})},e}(gn);function Mn(t,e){var i,o,n=Cn(t.touches),a=this.targetIds;if(e&(2|Ro)&&1===n.length)return a[n[0].identifier]=!0,[n,n];var s=Cn(t.changedTouches),r=[],l=this.target;if(o=n.filter((function(t){return an(t.target,l)})),e===Ro)for(i=0;i<o.length;)a[o[i].identifier]=!0,i++;for(i=0;i<s.length;)a[s[i].identifier]&&r.push(s[i]),e&(Bo|Uo)&&delete a[s[i].identifier],i++;return r.length?[xn(o.concat(r),"identifier",!0),r]:void 0}var En={mousedown:Ro,mousemove:2,mouseup:Bo},Tn=function(t){function e(){var i,o=e.prototype;return o.evEl="mousedown",o.evWin="mousemove mouseup",(i=t.apply(this,arguments)||this).pressed=!1,i}return vo(e,t),e.prototype.handler=function(t){var e=En[t.type];e&Ro&&0===t.button&&(this.pressed=!0),2&e&&1!==t.which&&(e=Bo),this.pressed&&(e&Bo&&(this.pressed=!1),this.callback(this.manager,e,{pointers:[t],changedPointers:[t],pointerType:jo,srcEvent:t}))},e}(gn),Vn=2500;function zn(t){var e=t.changedPointers[0];if(e.identifier===this.primaryTouch){var i={x:e.clientX,y:e.clientY},o=this.lastTouches;this.lastTouches.push(i);setTimeout((function(){var t=o.indexOf(i);t>-1&&o.splice(t,1)}),Vn)}}function Hn(t,e){t&Ro?(this.primaryTouch=e.changedPointers[0].identifier,zn.call(this,e)):t&(Bo|Uo)&&zn.call(this,e)}function Pn(t){for(var e=t.srcEvent.clientX,i=t.srcEvent.clientY,o=0;o<this.lastTouches.length;o++){var n=this.lastTouches[o],a=Math.abs(e-n.x),s=Math.abs(i-n.y);if(a<=25&&s<=25)return!0}return!1}var Dn=function(){return function(t){function e(e,i){var o;return(o=t.call(this,e,i)||this).handler=function(t,e,i){var n=i.pointerType===No,a=i.pointerType===jo;if(!(a&&i.sourceCapabilities&&i.sourceCapabilities.firesTouchEvents)){if(n)Hn.call(fo(fo(o)),e,i);else if(a&&Pn.call(fo(fo(o)),i))return;o.callback(t,e,i)}},o.touch=new Ln(o.manager,o.handler),o.mouse=new Tn(o.manager,o.handler),o.primaryTouch=null,o.lastTouches=[],o}return vo(e,t),e.prototype.destroy=function(){this.touch.destroy(),this.mouse.destroy()},e}(gn)}();function On(t,e,i){return!!Array.isArray(t)&&(tn(t,i[e],i),!0)}var Nn=32,jn=1;function In(t,e){var i=e.manager;return i?i.get(t):t}function Rn(t){return 16&t?"cancel":8&t?"end":4&t?"move":2&t?"start":""}var Bn=function(){function t(t){void 0===t&&(t={}),this.options=mo({enable:!0},t),this.id=jn++,this.manager=null,this.state=1,this.simultaneous={},this.requireFail=[]}var e=t.prototype;return e.set=function(t){return yo(this.options,t),this.manager&&this.manager.touchAction.update(),this},e.recognizeWith=function(t){if(On(t,"recognizeWith",this))return this;var e=this.simultaneous;return e[(t=In(t,this)).id]||(e[t.id]=t,t.recognizeWith(this)),this},e.dropRecognizeWith=function(t){return On(t,"dropRecognizeWith",this)||(t=In(t,this),delete this.simultaneous[t.id]),this},e.requireFailure=function(t){if(On(t,"requireFailure",this))return this;var e=this.requireFail;return-1===yn(e,t=In(t,this))&&(e.push(t),t.requireFailure(this)),this},e.dropRequireFailure=function(t){if(On(t,"dropRequireFailure",this))return this;t=In(t,this);var e=yn(this.requireFail,t);return e>-1&&this.requireFail.splice(e,1),this},e.hasRequireFailures=function(){return this.requireFail.length>0},e.canRecognizeWith=function(t){return!!this.simultaneous[t.id]},e.emit=function(t){var e=this,i=this.state;function o(i){e.manager.emit(i,t)}i<8&&o(e.options.event+Rn(i)),o(e.options.event),t.additionalEvent&&o(t.additionalEvent),i>=8&&o(e.options.event+Rn(i))},e.tryEmit=function(t){if(this.canEmit())return this.emit(t);this.state=Nn},e.canEmit=function(){for(var t=0;t<this.requireFail.length;){if(!(33&this.requireFail[t].state))return!1;t++}return!0},e.recognize=function(t){var e=yo({},t);if(!en(this.options.enable,[this,e]))return this.reset(),void(this.state=Nn);56&this.state&&(this.state=1),this.state=this.process(e),30&this.state&&this.tryEmit(e)},e.process=function(t){},e.getTouchAction=function(){},e.reset=function(){},t}(),Un=function(t){function e(e){var i;return void 0===e&&(e={}),(i=t.call(this,mo({event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},e))||this).pTime=!1,i.pCenter=!1,i._timer=null,i._input=null,i.count=0,i}vo(e,t);var i=e.prototype;return i.getTouchAction=function(){return[Eo]},i.process=function(t){var e=this,i=this.options,o=t.pointers.length===i.pointers,n=t.distance<i.threshold,a=t.deltaTime<i.time;if(this.reset(),t.eventType&Ro&&0===this.count)return this.failTimeout();if(n&&a&&o){if(t.eventType!==Bo)return this.failTimeout();var s=!this.pTime||t.timeStamp-this.pTime<i.interval,r=!this.pCenter||ln(this.pCenter,t.center)<i.posThreshold;if(this.pTime=t.timeStamp,this.pCenter=t.center,r&&s?this.count+=1:this.count=1,this._input=t,0===this.count%i.taps)return this.hasRequireFailures()?(this._timer=setTimeout((function(){e.state=8,e.tryEmit()}),i.interval),2):8}return Nn},i.failTimeout=function(){var t=this;return this._timer=setTimeout((function(){t.state=Nn}),this.options.interval),Nn},i.reset=function(){clearTimeout(this._timer)},i.emit=function(){8===this.state&&(this._input.tapCount=this.count,this.manager.emit(this.options.event,this._input))},e}(Bn),Wn=function(t){function e(e){return void 0===e&&(e={}),t.call(this,mo({pointers:1},e))||this}vo(e,t);var i=e.prototype;return i.attrTest=function(t){var e=this.options.pointers;return 0===e||t.pointers.length===e},i.process=function(t){var e=this.state,i=t.eventType,o=6&e,n=this.attrTest(t);return o&&(i&Uo||!n)?16|e:o||n?i&Bo?8|e:2&e?4|e:2:Nn},e}(Bn);function Fn(t){return t===Ko?"down":t===qo?"up":t===Fo?"left":t===Zo?"right":""}var Zn=function(t){function e(e){var i;return void 0===e&&(e={}),(i=t.call(this,mo({event:"pan",threshold:10,pointers:1,direction:Go},e))||this).pX=null,i.pY=null,i}vo(e,t);var i=e.prototype;return i.getTouchAction=function(){var t=this.options.direction,e=[];return t&Yo&&e.push(zo),t&Xo&&e.push(Vo),e},i.directionTest=function(t){var e=this.options,i=!0,o=t.distance,n=t.direction,a=t.deltaX,s=t.deltaY;return n&e.direction||(e.direction&Yo?(n=0===a?Wo:a<0?Fo:Zo,i=a!==this.pX,o=Math.abs(t.deltaX)):(n=0===s?Wo:s<0?qo:Ko,i=s!==this.pY,o=Math.abs(t.deltaY))),t.direction=n,i&&o>e.threshold&&n&e.direction},i.attrTest=function(t){return Wn.prototype.attrTest.call(this,t)&&(2&this.state||!(2&this.state)&&this.directionTest(t))},i.emit=function(e){this.pX=e.deltaX,this.pY=e.deltaY;var i=Fn(e.direction);i&&(e.additionalEvent=this.options.event+i),t.prototype.emit.call(this,e)},e}(Wn),qn=function(t){function e(e){return void 0===e&&(e={}),t.call(this,mo({event:"swipe",threshold:10,velocity:.3,direction:Yo|Xo,pointers:1},e))||this}vo(e,t);var i=e.prototype;return i.getTouchAction=function(){return Zn.prototype.getTouchAction.call(this)},i.attrTest=function(e){var i,o=this.options.direction;return o&(Yo|Xo)?i=e.overallVelocity:o&Yo?i=e.overallVelocityX:o&Xo&&(i=e.overallVelocityY),t.prototype.attrTest.call(this,e)&&o&e.offsetDirection&&e.distance>this.options.threshold&&e.maxPointers===this.options.pointers&&$o(i)>this.options.velocity&&e.eventType&Bo},i.emit=function(t){var e=Fn(t.offsetDirection);e&&this.manager.emit(this.options.event+e,t),this.manager.emit(this.options.event,t)},e}(Wn),Kn=function(t){function e(e){return void 0===e&&(e={}),t.call(this,mo({event:"pinch",threshold:0,pointers:2},e))||this}vo(e,t);var i=e.prototype;return i.getTouchAction=function(){return[To]},i.attrTest=function(e){return t.prototype.attrTest.call(this,e)&&(Math.abs(e.scale-1)>this.options.threshold||2&this.state)},i.emit=function(e){if(1!==e.scale){var i=e.scale<1?"in":"out";e.additionalEvent=this.options.event+i}t.prototype.emit.call(this,e)},e}(Wn),Yn=function(t){function e(e){return void 0===e&&(e={}),t.call(this,mo({event:"rotate",threshold:0,pointers:2},e))||this}vo(e,t);var i=e.prototype;return i.getTouchAction=function(){return[To]},i.attrTest=function(e){return t.prototype.attrTest.call(this,e)&&(Math.abs(e.rotation)>this.options.threshold||2&this.state)},e}(Wn),Xn=function(t){function e(e){var i;return void 0===e&&(e={}),(i=t.call(this,mo({event:"press",pointers:1,time:251,threshold:9},e))||this)._timer=null,i._input=null,i}vo(e,t);var i=e.prototype;return i.getTouchAction=function(){return[Mo]},i.process=function(t){var e=this,i=this.options,o=t.pointers.length===i.pointers,n=t.distance<i.threshold,a=t.deltaTime>i.time;if(this._input=t,!n||!o||t.eventType&(Bo|Uo)&&!a)this.reset();else if(t.eventType&Ro)this.reset(),this._timer=setTimeout((function(){e.state=8,e.tryEmit()}),i.time);else if(t.eventType&Bo)return 8;return Nn},i.reset=function(){clearTimeout(this._timer)},i.emit=function(t){8===this.state&&(t&&t.eventType&Bo?this.manager.emit(this.options.event+"up",t):(this._input.timeStamp=Ao(),this.manager.emit(this.options.event,this._input)))},e}(Bn),Gn={domEvents:!1,touchAction:Lo,enable:!0,inputTarget:null,inputClass:null,cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}},Jn=[[Yn,{enable:!1}],[Kn,{enable:!1},["rotate"]],[qn,{direction:Yo}],[Zn,{direction:Yo},["swipe"]],[Un],[Un,{event:"doubletap",taps:2},["tap"]],[Xn]];function Qn(t,e){var i,o=t.element;o.style&&(tn(t.options.cssProps,(function(n,a){i=Co(o.style,a),e?(t.oldCssProps[i]=o.style[i],o.style[i]=n):o.style[i]=t.oldCssProps[i]||""})),e||(t.oldCssProps={}))}var ta=function(){function t(t,e){var i,o=this;this.options=yo({},Gn,e||{}),this.options.inputTarget=this.options.inputTarget||t,this.handlers={},this.session={},this.recognizers=[],this.oldCssProps={},this.element=t,this.input=new((i=this).options.inputClass||(Do?An:Oo?Ln:Po?Dn:Tn))(i,_n),this.touchAction=new nn(this,this.options.touchAction),Qn(this,!0),tn(this.options.recognizers,(function(t){var e=o.add(new t[0](t[1]));t[2]&&e.recognizeWith(t[2]),t[3]&&e.requireFailure(t[3])}),this)}var e=t.prototype;return e.set=function(t){return yo(this.options,t),t.touchAction&&this.touchAction.update(),t.inputTarget&&(this.input.destroy(),this.input.target=t.inputTarget,this.input.init()),this},e.stop=function(t){this.session.stopped=t?2:1},e.recognize=function(t){var e=this.session;if(!e.stopped){var i;this.touchAction.preventDefaults(t);var o=this.recognizers,n=e.curRecognizer;(!n||n&&8&n.state)&&(e.curRecognizer=null,n=null);for(var a=0;a<o.length;)i=o[a],2===e.stopped||n&&i!==n&&!i.canRecognizeWith(n)?i.reset():i.recognize(t),!n&&14&i.state&&(e.curRecognizer=i,n=i),a++}},e.get=function(t){if(t instanceof Bn)return t;for(var e=this.recognizers,i=0;i<e.length;i++)if(e[i].options.event===t)return e[i];return null},e.add=function(t){if(On(t,"add",this))return this;var e=this.get(t.options.event);return e&&this.remove(e),this.recognizers.push(t),t.manager=this,this.touchAction.update(),t},e.remove=function(t){if(On(t,"remove",this))return this;var e=this.get(t);if(t){var i=this.recognizers,o=yn(i,e);-1!==o&&(i.splice(o,1),this.touchAction.update())}return this},e.on=function(t,e){if(void 0===t||void 0===e)return this;var i=this.handlers;return tn(pn(t),(function(t){i[t]=i[t]||[],i[t].push(e)})),this},e.off=function(t,e){if(void 0===t)return this;var i=this.handlers;return tn(pn(t),(function(t){e?i[t]&&i[t].splice(yn(i[t],e),1):delete i[t]})),this},e.emit=function(t,e){this.options.domEvents&&function(t,e){var i=document.createEvent("Event");i.initEvent(t,!0,!0),i.gesture=e,e.target.dispatchEvent(i)}(t,e);var i=this.handlers[t]&&this.handlers[t].slice();if(i&&i.length){e.type=t,e.preventDefault=function(){e.srcEvent.preventDefault()};for(var o=0;o<i.length;)i[o](e),o++}},e.destroy=function(){this.element&&Qn(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null},t}(),ea={touchstart:Ro,touchmove:2,touchend:Bo,touchcancel:Uo},ia=function(t){function e(){var i,o=e.prototype;return o.evTarget="touchstart",o.evWin="touchstart touchmove touchend touchcancel",(i=t.apply(this,arguments)||this).started=!1,i}return vo(e,t),e.prototype.handler=function(t){var e=ea[t.type];if(e===Ro&&(this.started=!0),this.started){var i=oa.call(this,t,e);e&(Bo|Uo)&&i[0].length-i[1].length==0&&(this.started=!1),this.callback(this.manager,e,{pointers:i[0],changedPointers:i[1],pointerType:No,srcEvent:t})}},e}(gn);function oa(t,e){var i=Cn(t.touches),o=Cn(t.changedTouches);return e&(Bo|Uo)&&(i=xn(i.concat(o),"identifier",!0)),[i,o]}function na(t,e,i){var o="DEPRECATED METHOD: "+e+"\n"+i+" AT \n";return function(){var e=new Error("get-stack-trace"),i=e&&e.stack?e.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,"{anonymous}()@"):"Unknown Stack Trace",n=window.console&&(window.console.warn||window.console.log);return n&&n.call(window.console,o,i),t.apply(this,arguments)}}var aa=na((function(t,e,i){for(var o=Object.keys(e),n=0;n<o.length;)(!i||i&&void 0===t[o[n]])&&(t[o[n]]=e[o[n]]),n++;return t}),"extend","Use `assign`."),sa=na((function(t,e){return aa(t,e,!0)}),"merge","Use `assign`.");function ra(t,e,i){var o,n=e.prototype;(o=t.prototype=Object.create(n)).constructor=t,o._super=n,i&&yo(o,i)}function la(t,e){return function(){return t.apply(e,arguments)}}(function(){var t=function(t,e){return void 0===e&&(e={}),new ta(t,mo({recognizers:Jn.concat()},e))};return t.VERSION="2.0.17-rc",t.DIRECTION_ALL=Go,t.DIRECTION_DOWN=Ko,t.DIRECTION_LEFT=Fo,t.DIRECTION_RIGHT=Zo,t.DIRECTION_UP=qo,t.DIRECTION_HORIZONTAL=Yo,t.DIRECTION_VERTICAL=Xo,t.DIRECTION_NONE=Wo,t.DIRECTION_DOWN=Ko,t.INPUT_START=Ro,t.INPUT_MOVE=2,t.INPUT_END=Bo,t.INPUT_CANCEL=Uo,t.STATE_POSSIBLE=1,t.STATE_BEGAN=2,t.STATE_CHANGED=4,t.STATE_ENDED=8,t.STATE_RECOGNIZED=8,t.STATE_CANCELLED=16,t.STATE_FAILED=Nn,t.Manager=ta,t.Input=gn,t.TouchAction=nn,t.TouchInput=Ln,t.MouseInput=Tn,t.PointerEventInput=An,t.TouchMouseInput=Dn,t.SingleTouchInput=ia,t.Recognizer=Bn,t.AttrRecognizer=Wn,t.Tap=Un,t.Pan=Zn,t.Swipe=qn,t.Pinch=Kn,t.Rotate=Yn,t.Press=Xn,t.on=mn,t.off=vn,t.each=tn,t.merge=sa,t.extend=aa,t.bindFn=la,t.assign=yo,t.inherit=ra,t.bindFn=la,t.prefixed=Co,t.toArray=Cn,t.inArray=yn,t.uniqueArray=xn,t.splitStr=pn,t.boolOrFn=en,t.hasParent=an,t.addEventListeners=mn,t.removeEventListeners=vn,t.defaults=yo({},Gn,{preset:Jn}),t})().defaults;
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ca=270;const da=new Set(["ArrowRight","ArrowUp","ArrowLeft","ArrowDown","PageUp","PageDown","Home","End"]);let ua=class extends rt{constructor(){super(...arguments),this.disabled=!1,this.step=1,this.min=0,this.max=100,this._localValue=this.value,this._localLow=this.low,this._localHigh=this.high,this._getPercentageFromEvent=t=>{const e=this._slider.getBoundingClientRect(),i=2*(t.center.x-e.left-e.width/2)/e.width,o=2*(t.center.y-e.top-e.height/2)/e.height,[,n]=function(t,e){return[Math.sqrt(t*t+e*e),Math.atan2(e,t)]}(i,o),a=(n/(2*Math.PI)*360+45-135+360)%360-45;return Math.max(Math.min(a/ca,1),0)}}_valueToPercentage(t){return(Hi(t,this.min,this.max)-this.min)/(this.max-this.min)}_percentageToValue(t){return(this.max-this.min)*t+this.min}_steppedValue(t){return Math.round(t/this.step)*this.step}_boundedValue(t){var e,i;const o="high"===this._activeSlider?Math.min(null!==(e=this._localLow)&&void 0!==e?e:this.max):this.min,n="low"===this._activeSlider?Math.max(null!==(i=this._localHigh)&&void 0!==i?i:this.min):this.max;return Math.min(Math.max(t,o),n)}firstUpdated(t){super.firstUpdated(t),this._setupListeners()}updated(t){super.updated(t),this._activeSlider||(t.has("value")&&(this._localValue=this.value),t.has("low")&&(this._localLow=this.low),t.has("high")&&(this._localHigh=this.high))}connectedCallback(){super.connectedCallback(),this._setupListeners()}disconnectedCallback(){super.disconnectedCallback()}_findActiveSlider(t){var e,i;if(!this.dual)return"value";const o=Math.max(null!==(e=this._localLow)&&void 0!==e?e:this.min,this.min),n=Math.min(null!==(i=this._localHigh)&&void 0!==i?i:this.max,this.max);if(o>=t)return"low";if(n<=t)return"high";return Math.abs(t-o)<=Math.abs(t-n)?"low":"high"}_setActiveValue(t){switch(this._activeSlider){case"high":this._localHigh=t;break;case"low":this._localLow=t;break;case"value":this._localValue=t}}_getActiveValue(){switch(this._activeSlider){case"high":return this._localHigh;case"low":return this._localLow;case"value":return this._localValue}}_setupListeners(){this._interaction&&!this._mc&&(this._mc=new ta(this._interaction,{inputClass:Dn}),this._mc.add(new Zn({direction:Go,enable:!0,threshold:0})),this._mc.add(new Un({event:"singletap"})),this._mc.on("pan",(t=>{t.srcEvent.stopPropagation(),t.srcEvent.preventDefault()})),this._mc.on("panstart",(t=>{var e,i;if(this.disabled)return;const o=this._getPercentageFromEvent(t),n=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(n),this._lastSlider=this._activeSlider,null===(i=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("#slider"))||void 0===i||i.focus()})),this._mc.on("pancancel",(()=>{this.disabled||(this._activeSlider=void 0)})),this._mc.on("panmove",(t=>{if(this.disabled)return;const e=this._getPercentageFromEvent(t),i=this._percentageToValue(e),o=this._boundedValue(i);this._setActiveValue(o);const n=this._steppedValue(o);this._activeSlider&&zi(this,`${this._activeSlider}-changing`,{value:n})})),this._mc.on("panend",(t=>{if(this.disabled)return;const e=this._getPercentageFromEvent(t),i=this._percentageToValue(e),o=this._boundedValue(i),n=this._steppedValue(o);this._setActiveValue(n),this._activeSlider&&(zi(this,`${this._activeSlider}-changing`,{value:void 0}),zi(this,`${this._activeSlider}-changed`,{value:n})),this._activeSlider=void 0})),this._mc.on("singletap",(t=>{var e,i;if(this.disabled)return;const o=this._getPercentageFromEvent(t),n=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(n);const a=this._boundedValue(n),s=this._steppedValue(a);this._setActiveValue(s),this._activeSlider&&(zi(this,`${this._activeSlider}-changing`,{value:void 0}),zi(this,`${this._activeSlider}-changed`,{value:s})),this._lastSlider=this._activeSlider,null===(i=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("#slider"))||void 0===i||i.focus(),this._activeSlider=void 0})))}get _tenPercentStep(){return Math.max(this.step,(this.max-this.min)/10)}_handleKeyDown(t){var e,i,o;if(!da.has(t.code))return;t.preventDefault(),this._lastSlider&&(null===(i=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById(this._lastSlider))||void 0===i||i.focus()),this._activeSlider=null!==(o=this._lastSlider)&&void 0!==o?o:t.currentTarget.id,this._lastSlider=void 0;const n=this._getActiveValue();switch(t.code){case"ArrowRight":case"ArrowUp":this._setActiveValue(this._boundedValue((null!=n?n:this.min)+this.step));break;case"ArrowLeft":case"ArrowDown":this._setActiveValue(this._boundedValue((null!=n?n:this.min)-this.step));break;case"PageUp":this._setActiveValue(this._steppedValue(this._boundedValue((null!=n?n:this.min)+this._tenPercentStep)));break;case"PageDown":this._setActiveValue(this._steppedValue(this._boundedValue((null!=n?n:this.min)-this._tenPercentStep)));break;case"Home":this._setActiveValue(this._boundedValue(this.min));break;case"End":this._setActiveValue(this._boundedValue(this.max))}zi(this,`${this._activeSlider}-changing`,{value:this._getActiveValue()}),this._activeSlider=void 0}_handleKeyUp(t){da.has(t.code)&&(this._activeSlider=t.currentTarget.id,t.preventDefault(),zi(this,`${this._activeSlider}-changing`,{value:void 0}),zi(this,`${this._activeSlider}-changed`,{value:this._getActiveValue()}),this._activeSlider=void 0)}destroyListeners(){this._mc&&(this._mc.destroy(),this._mc=void 0)}_strokeCircleDashArc(t){return this._strokeDashArc(t,t)}_strokeDashArc(t,e){const i=this._valueToPercentage(t),o=this._valueToPercentage(e),n=290*Math.PI*ca/360,a=Math.max((o-i)*n,0);return[`${a} ${n-a}`,`-${i*n-.5}`]}renderArc(t,e,i){var o,n;if(this.disabled)return Z;const a=po({x:0,y:0,start:0,end:ca,r:145}),s="end"===i?this.max:this.min,r=null!==(o=this.current)&&void 0!==o?o:s,l=null!=e?e:s,c="end"===i?l<=r:"start"===i&&r<=l,d=c?"end"===i?this._strokeDashArc(l,r):this._strokeDashArc(r,l):this._strokeCircleDashArc(l),u="full"===i?this._strokeDashArc(this.min,this.max):"end"===i?this._strokeDashArc(l,s):this._strokeDashArc(s,l),h=this._strokeCircleDashArc(l),_=null!=this.current&&this.current<=this.max&&this.current>=this.min&&(c||"full"===this.mode)?this._strokeCircleDashArc(this.current):void 0;return W`
      ...
      `}render(){const t=po({x:0,y:0,start:0,end:ca,r:145}),e=this.dual?this._localLow:this._localValue,i=this._localHigh,o=this.current,n=o?this._strokeCircleDashArc(o):void 0;return U`
        <svg
          id="slider"
          viewBox="0 0 320 320"
          overflow="visible"
    ...
    `}_renderAutoStartStopEnable(){const t=Ci({hass:this.hass,string:"extra_states.auto_start_stop_enable"}),e=Ci({hass:this.hass,string:"extra_states.auto_start_stop_label"}),i=this._isAutoStartStopEnabled?"checked":"";return console.log(`checked=${i}`),U`
   ...
   >
    ${(null===(t=this._config)||void 0===t?void 0:t.disable_menu)?"":U`
      ...
      <div id="modes" class="${null!==this.safety_state||this.displayMessages?"security_msg":""}">
        ${W`
          ${this.modes.map((t=>{var e,i,o,n,a,s,r,l;return(null===(e=this._config)||void 0===e?void 0:e.disable_heat)&&"heat"===t||(null===(i=this._config)||void 0===i?void 0:i.disable_auto)&&"auto"===t||(null===(o=this._config)||void 0===o?void 0:o.disable_cool)&&"cool"===t||(null===(n=this._config)||void 0===n?void 0:n.disable_heat_cool)&&"heat_cool"===t||(null===(a=this._config)||void 0===a?void 0:a.disable_dry)&&"dry"===t||(null===(s=this._config)||void 0===s?void 0:s.disable_fan_only)&&"fan_only"===t||(null===(r=this._config)||void 0===r?void 0:r.disable_off)&&"off"===t||(null===(l=this._config)||void 0===l?void 0:l.disable_sleep)&&"sleep"===t?U``:this._renderIcon(t,this.hvacMode)}))}
        `}
      </div>
  ...
  `}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._handleKeyDown)}static async getConfigElement(){return await Promise.resolve().then((function(){return Ea})),document.createElement("versatile-thermostat-ui-card-editor")}static async getStubConfig(t){const e=Object.keys(t.states).filter((t=>["climate"].includes(t.split(".")[0]))),i=e.filter((e=>{var i;return null===(i=t.states[e].attributes)||void 0===i?void 0:i.specific_states}));return{type:"custom:versatile-thermostat-ui-card",entity:i[0]||e[0]}}};$a.styles=s`
      :host {
          display: block;
  ...
  `,t([ht({attribute:!1})],$a.prototype,"hass",void 0),t([ht({type:Number})],$a.prototype,"value",void 0),t([_t()],$a.prototype,"_selectTargetTemperature",void 0),t([ht({type:Number})],$a.prototype,"current",void 0),t([ht({type:Number})],$a.prototype,"humidity",void 0),t([ht({type:Number})],$a.prototype,"temperature",void 0),t([ht({type:Number})],$a.prototype,"min",void 0),t([ht({type:Number})],$a.prototype,"max",void 0),t([ht({type:Number})],$a.prototype,"step",void 0),t([ht({type:Number})],$a.prototype,"powerPercent",void 0),t([ht({type:Number})],$a.prototype,"meanCyclePower",void 0),t([ht({type:Number})],$a.prototype,"valveOpenPercent",void 0),t([ht({type:Number})],$a.prototype,"devicePower",void 0),t([ht({type:Number})],$a.prototype,"regulatedTargetTemperature",void 0),t([ht({type:Boolean})],$a.prototype,"isOn",void 0),t([ht({type:Boolean})],$a.prototype,"window",void 0),t([ht({type:Boolean})],$a.prototype,"windowByPass",void 0),t([ht({type:Boolean})],$a.prototype,"presence",void 0),t([ht({type:Boolean})],$a.prototype,"motion",void 0),t([ht({type:Boolean})],$a.prototype,"overpowering",void 0),t([ht({type:Boolean})],$a.prototype,"isDeviceActive",void 0),t([ht({type:Boolean})],$a.prototype,"isSleeping",void 0),t([ht({type:Boolean})],$a.prototype,"isRegulated",void 0),t([ht({type:Boolean})],$a.prototype,"isRecalculateScheduled",void 0),t([ht({type:String})],$a.prototype,"windowState",void 0),t([ht({type:String})],$a.prototype,"windowAutoState",void 0),t([ht({type:String})],$a.prototype,"overpoweringState",void 0),t([ht({type:String})],$a.prototype,"presenceState",void 0),t([ht({type:String})],$a.prototype,"motionState",void 0),t([ht({type:String})],$a.prototype,"safetyState",void 0),t([ht({type:String})],$a.prototype,"status",void 0),t([ht({type:String})],$a.prototype,"hvacMode",void 0),t([ht({type:String})],$a.prototype,"hvacAction",void 0),t([ht({type:String})],$a.prototype,"preset",void 0),t([ht({type:String})],$a.prototype,"autoRegulationMode",void 0),t([ht({type:String})],$a.prototype,"currentAutoFanMode",void 0),t([ht({type:String})],$a.prototype,"autoFanMode",void 0),t([ht({type:String})],$a.prototype,"fanMode",void 0),t([ht({type:String})],$a.prototype,"hvacOffReason",void 0),t([ht({type:Boolean,reflect:!0})],$a.prototype,"dragging",void 0),t([ht({type:String})],$a.prototype,"name",void 0),t([_t()],$a.prototype,"changingHigh",void 0),t([_t()],$a.prototype,"_config",void 0),t([_t()],$a.prototype,"isLocked",void 0),t([_t()],$a.prototype,"isUserLocked",void 0),t([_t()],$a.prototype,"isAutomationLocked",void 0),t([_t()],$a.prototype,"showDigicodeModal",void 0),t([_t()],$a.prototype,"enteredCode",void 0),t([_t()],$a.prototype,"codeError",void 0),t([_t()],$a.prototype,"isLocking",void 0),$a=t([ct("versatile-thermostat-ui-card")],$a);const Aa=function(...t){const e="type"===t[0].type,i=t.map((t=>t.schema)),o=Object.assign({},...i);return e?to(o):Gi(o)}(Gi({index:Ji(Xi()),view_index:Ji(Xi()),view_layout:Zi("any",(()=>!0)),type:Qi()}),Gi({entity:Ji(Qi()),name:Ji(Qi()),icon:Ji(Qi()),autoStartStopEnableEntity:Ji(Qi()),powerEntity:Ji(Qi())}),Gi({disable_name:Ji(Ki()),disable_circle:Ji(Ki()),disable_window:Ji(Ki()),disable_autoStartStop:Ji(Ki()),disable_overpowering:Ji(Ki()),disable_heat:Ji(Ki()),disable_cool:Ji(Ki()),disable_heat_cool:Ji(Ki()),disable_auto:Ji(Ki()),disable_dry:Ji(Ki()),disable_fan_only:Ji(Ki()),disable_off:Ji(Ki()),disable_sleep:Ji(Ki()),disable_safety_warning:Ji(Ki()),disable_power_infos:Ji(Ki()),disable_auto_fan_infos:Ji(Ki()),disable_target_icon:Ji(Ki()),set_current_as_main:Ji(Ki()),eco_temperature:Ji(Xi()),disable_menu:Ji(Ki()),disable_buttons:Ji(Ki()),allow_lock_toggle:Ji(Ki())})),Ca=["icon_color","layout","fill_container","primary_info","secondary_info","icon_type","content_info","use_entity_picture","collapsible_controls","icon_animation"],xa=t=>{var e,i;customElements.get("ha-form")&&(customElements.get("hui-action-editor")||((t,e,i,o)=>{const[n,a,s]=t.split(".",3);return Number(n)>e||Number(n)===e&&(void 0===o?Number(a)>=i:Number(a)>i)||void 0!==o&&Number(n)===e&&Number(a)===i&&Number(s)>=o})(t,2022,11))||null===(e=customElements.get("hui-button-card"))||void 0===e||e.getConfigElement(),customElements.get("ha-entity-picker")||null===(i=customElements.get("hui-entities-card"))||void 0===i||i.getConfigElement()},Sa=["autoStartStopEnableEntity","powerEntity","disable_name","disable_circle","disable_window","disable_autoStartStop","disable_overpowering","disable_heat","disable_cool","disable_heat_cool","disable_auto","disable_dry","disable_fan_only","disable_off","disable_sleep","disable_menu","disable_safety_warning","disable_buttons","set_current_as_main","disable_power_infos","disable_auto_fan_infos","disable_target_icon","allow_lock_toggle"],La=Ti((()=>[{name:"entity",selector:{entity:{domain:["climate"]}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"autoStartStopEnableEntity",selector:{entity:{domain:["switch"]}}},{name:"powerEntity",selector:{entity:{domain:["sensor","input_number"]}}}]},{type:"grid",name:"",schema:[{name:"disable_name",selector:{boolean:{}}},{name:"disable_circle",selector:{boolean:{}}},{name:"disable_window",selector:{boolean:{}}},{name:"disable_autoStartStop",selector:{boolean:{}}},{name:"disable_overpowering",selector:{boolean:{}}},{name:"disable_heat",selector:{boolean:{}}},{name:"disable_cool",selector:{boolean:{}}},{name:"disable_heat_cool",selector:{boolean:{}}},{name:"disable_auto",selector:{boolean:{}}},{name:"disable_dry",selector:{boolean:{}}},{name:"disable_fan_only",selector:{boolean:{}}},{name:"disable_off",selector:{boolean:{}}},{name:"disable_sleep",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"disable_safety_warning",selector:{boolean:{}}},{name:"disable_buttons",selector:{boolean:{}}},{name:"set_current_as_main",selector:{boolean:{}}},{name:"disable_power_infos",selector:{boolean:{}}},{name:"disable_auto_fan_infos",selector:{boolean:{}}},{name:"disable_target_icon",selector:{boolean:{}}},{name:"allow_lock_toggle",selector:{boolean:{}}}]}]));let Ma=class extends rt{constructor(){super(...arguments),this._computeLabel=t=>{const e=(i=this.hass,function(t){var e;let o=xi(t,null!==(e=null==i?void 0:i.locale.language)&&void 0!==e?e:Ai);return o||(o=xi(t,Ai)),null!=o?o:t});var i;return Ca.includes(t.name)?e(`editor.card.generic.${t.name}`):Sa.includes(t.name)?e(`editor.card.climate.${t.name}`):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}connectedCallback(){super.connectedCallback(),xa(this.hass.connection.haVersion)}setConfig(t){Wi(t,Aa),this._config=t}render(){if(!this.hass||!this._config)return U``;const t=La();return U`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${t}
            ...
            ></ha-form>
        `}_valueChanged(t){zi(this,"config-changed",{config:t.detail.value}),zi(this,"hass",{config:t.detail.value})}};t([_t()],Ma.prototype,"_config",void 0),t([ht({attribute:!1})],Ma.prototype,"hass",void 0),Ma=t([ct("versatile-thermostat-ui-card-editor")],Ma);var Ea=Object.freeze({__proto__:null,get ClimateCardEditor(){return Ma}});export{$a as VersatileThermostatUi,ba as registerCustomCard};
