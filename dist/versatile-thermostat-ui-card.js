...
const ds=270;const us=new Set(["ArrowRight","ArrowUp","ArrowLeft","ArrowDown","PageUp","PageDown","Home","End"]);let hs=class extends re{constructor(){super(...arguments),this.disabled=!1,this.step=1,this.min=0,this.max=100,this._localValue=this.value,this._localLow=this.low,this._localHigh=this.high,this._getPercentageFromEvent=e=>{const t=this._slider.getBoundingClientRect(),i=2*(e.center.x-t.left-t.width/2)/t.width,o=2*(e.center.y-t.top-t.height/2)/t.height,[,a]=function(e,t){return[Math.sqrt(e*e+t*t),Math.atan2(t,e)]}(i,o),s=(a/(2*Math.PI)*360+45-135+360)%360-45;return Math.max(Math.min(s/ds,1),0)}}_valueToPercentage(e){return(Di(e,this.min,this.max)-this.min)/(this.max-this.min)}_percentageToValue(e){return(this.max-this.min)*e+this.min}_steppedValue(e){return Math.round(e/this.step)*this.step}_boundedValue(e){var t,i;const o="high"===this._activeSlider?Math.min(null!==(t=this._localLow)&&void 0!==t?t:this.max):this.min,a="low"===this._activeSlider?Math.max(null!==(i=this._localHigh)&&void 0!==i?i:this.min):this.max;return Math.min(Math.max(e,o),a)}firstUpdated(e){super.firstUpdated(e),this._setupListeners()}updated(e){super.updated(e),this._activeSlider||(e.has("value")&&(this._localValue=this.value),e.has("low")&&(this._localLow=this.low),e.has("high")&&(this._localHigh=this.high))}connectedCallback(){super.connectedCallback(),this._setupListeners()}disconnectedCallback(){super.disconnectedCallback()}_findActiveSlider(e){var t,i;if(!this.dual)return"value";const o=Math.max(null!==(t=this._localLow)&&void 0!==t?t:this.min,this.min),a=Math.min(null!==(i=this._localHigh)&&void 0!==i?i:this.max,this.max);if(o>=e)return"low";if(a<=e)return"high";return Math.abs(e-o)<=Math.abs(e-a)?"low":"high"}_setActiveValue(e){switch(this._activeSlider){case"high":this._localHigh=e;break;case"low":this._localLow=e;break;case"value":this._localValue=e}}_getActiveValue(){switch(this._activeSlider){case"high":return this._localHigh;case"low":return this._localLow;case"value":return this._localValue}}_setupListeners(){this._interaction&&!this._mc&&(this._mc=new ts(this._interaction,{inputClass:Oa}),this._mc.add(new qa({direction:Qo,enable:!0,threshold:0})),this._mc.add(new Wa({event:"singletap"})),this._mc.on("pan",(e=>{e.srcEvent.stopPropagation(),e.srcEvent.preventDefault()})),this._mc.on("panstart",(e=>{var t,i;if(this.disabled)return;const o=this._getPercentageFromEvent(e),a=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(a),this._lastSlider=this._activeSlider,null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("#slider"))||void 0===i||i.focus()})),this._mc.on("pancancel",(()=>{this.disabled||(this._activeSlider=void 0)})),this._mc.on("panmove",(e=>{if(this.disabled)return;const t=this._getPercentageFromEvent(e),i=this._percentageToValue(t),o=this._boundedValue(i);this._setActiveValue(o);const a=this._steppedValue(o);this._activeSlider&&Hi(this,`${this._activeSlider}-changing`,{value:a})})),this._mc.on("panend",(e=>{if(this.disabled)return;const t=this._getPercentageFromEvent(e),i=this._percentageToValue(t),o=this._boundedValue(i),a=this._steppedValue(o);this._setActiveValue(a),this._activeSlider&&(Hi(this,`${this._activeSlider}-changing`,{value:void 0}),Hi(this,`${this._activeSlider}-changed`,{value:a})),this._activeSlider=void 0})),this._mc.on("singletap",(e=>{var t,i;if(this.disabled)return;const o=this._getPercentageFromEvent(e),a=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(a);const s=this._boundedValue(a),n=this._steppedValue(s);this._setActiveValue(n),this._activeSlider&&(Hi(this,`${this._activeSlider}-changing`,{value:void 0}),Hi(this,`${this._activeSlider}-changed`,{value:n})),this._lastSlider=this._activeSlider,null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById("#slider"))||void 0===i||i.focus(),this._activeSlider=void 0})))}get _tenPercentStep(){return Math.max(this.step,(this.max-this.min)/10)}_handleKeyDown(e){var t,i,o;if(!us.has(e.code))return;e.preventDefault(),this._lastSlider&&(null===(i=null===(t=this.shadowRoot)||void 0===t?void 0:t.getElementById(this._lastSlider))||void 0===i||i.focus()),this._activeSlider=null!==(o=this._lastSlider)&&void 0!==o?o:e.currentTarget.id,this._lastSlider=void 0;const a=this._getActiveValue();switch(e.code){case"ArrowRight":case"ArrowUp":this._setActiveValue(this._boundedValue((null!=a?a:this.min)+this.step));break;case"ArrowLeft":case"ArrowDown":this._setActiveValue(this._boundedValue((null!=a?a:this.min)-this.step));break;case"PageUp":this._setActiveValue(this._steppedValue(this._boundedValue((null!=a?a:this.min)+this._tenPercentStep)));break;case"PageDown":this._setActiveValue(this._steppedValue(this._boundedValue((null!=a?a:this.min)-this._tenPercentStep)));break;case"Home":this._setActiveValue(this._boundedValue(this.min));break;case"End":this._setActiveValue(this._boundedValue(this.max))}Hi(this,`${this._activeSlider}-changing`,{value:this._getActiveValue()}),this._activeSlider=void 0}_handleKeyUp(e){us.has(e.code)&&(this._activeSlider=e.currentTarget.id,e.preventDefault(),Hi(this,`${this._activeSlider}-changing`,{value:void 0}),Hi(this,`${this._activeSlider}-changed`,{value:this._getActiveValue()}),this._activeSlider=void 0)}destroyListeners(){this._mc&&(this._mc.destroy(),this._mc=void 0)}_strokeCircleDashArc(e){return this._strokeDashArc(e,e)}_strokeDashArc(e,t){const i=this._valueToPercentage(e),o=this._valueToPercentage(t),a=290*Math.PI*ds/360,s=Math.max((o-i)*a,0);return[`${s} ${a-s}`,`-${i*a-.5}`]}renderArc(e,t,i){var o,a;if(this.disabled)return Z;const s=vo({x:0,y:0,start:0,end:ds,r:145}),n="end"===i?this.max:this.min,r=null!==(o=this.current)&&void 0!==o?o:n,l=null!=t?t:n,c="end"===i?l<=r:"start"===i&&r<=l,d=c?"end"===i?this._strokeDashArc(l,r):this._strokeDashArc(r,l):this._strokeCircleDashArc(l),u="full"===i?this._strokeDashArc(this.min,this.max):"end"===i?this._strokeDashArc(l,n):this._strokeDashArc(n,l),h=this._strokeCircleDashArc(l),_=null!=this.current&&this.current<=this.max&&this.current>=this.min&&(c||"full"===this.mode)?this._strokeCircleDashArc(this.current):void 0;return W`
      ...
      `}render(){const e=vo({x:0,y:0,start:0,end:ds,r:145}),t=this.dual?this._localLow:this._localValue,i=this._localHigh,o=this.current,a=o?this._strokeCircleDashArc(o):void 0;return B`
        <svg
          id="slider"
          viewBox="0 0 320 320"
          overflow="visible"
    ...
    `}_renderMessagesButton(){const e=Si({hass:this.hass,string:"extra_states.messages-button"});return B`
      <ha-icon-button
        title="${e}"
    ...
    `}_renderRecalculateScheduledButton(){const e=Si({hass:this.hass,string:"extra_states.recalculation_scheduled"});return B`
      <ha-icon-button
        title="${e}"
    ...
    `}_renderWindowByPassButton(){const e=Si({hass:this.hass,string:"extra_states.window-bypass-button"});return B`
      <ha-icon-button
        title="${e}"
    ...
    `}_renderPowerInfo(e){const t=this.hass.localize(`component.climate.state._.${e.name}`)||Si({hass:this.hass,string:`extra_states.${e.name}`});return B`
    ...
    `}_renderAutoStartStopEnable(){const e=Si({hass:this.hass,string:"extra_states.auto_start_stop_enable"}),t=Si({hass:this.hass,string:"extra_states.auto_start_stop_label"});return this._isAutoStartStopEnabled,B`
   ...
   >
    ${(null===(e=this._config)||void 0===e?void 0:e.disable_menu)?"":B`
      ...
      ${(null===(t=this.safety_state)||void 0===t?void 0:t.length)>0&&!this.displayMessages?B`
        <div class="security">
      ...
      <div title="${this.buildTitle()}" class="${(null===(i=this._config)||void 0===i?void 0:i.disable_circle)?"disabled-circle-container":""} ${(null===(o=this._config)||void 0===o?void 0:o.disable_background_color)?"no-background-color":""}  ${this.hvacMode}_${this.hvacAction} ${this._hasWindow?"window_open":""}  ${this.overpowering?"overpowering":""}">
        ${(null===(a=this._config)||void 0===a?void 0:a.disable_circle)?B`
            <!-- No cicle configured -->
          ...
          <div class="content${(null===(s=this._config)||void 0===s?void 0:s.disable_presets)?" no-presets":""} ${0==this.name.length?" noname":""} ${null!==this.safety_state||this.displayMessages?" security_msg":""} ${this._hasWindow?" window_open":""}  ${this.overpowering?" overpowering":""} ${this.presence?" presence":""} ${this.motion?" motion":""}  ${this._hasWindowByPass?" windowByPass":""} " >
            <svg id="main" viewbox="0 0 125 100">
              <g transform="translate(57.5,37) scale(0.35)">
                ...
                `}
                ${this._hasOverpowering&&!(null===(l=this._config)||void 0===l?void 0:l.disable_overpowering)?W`
                  <path class="overpowering ${this.overpowering?"active":""}" transform="${this._hasOverpowering&&!(null===(c=this._config)||void 0===c?void 0:c.disable_overpowering)?"translate(-25.25,0)":""}" id="overpowering" d=${$e} />
                `:""}
                ${this._hasPresence?W`
                  <path class="presence ${this.presence?"active":""}" transform="${this._hasPresence?"translate(0.25,0)":""}" id="overpowering" d=${Ae} />
                `:""}
                ${this._hasAutoStartStop&&!(null===(d=this._config)||void 0===d?void 0:d.disable_autoStartStop)?W`
                  <path class="auto-start-stop" transform="${this._hasAutoStartStop&&!(null===(u=this._config)||void 0===u?void 0:u.disable_autoStartStop)?"translate(25.25,0)":""}" id="autoStartStop" d=${Le}/>
                `:""}
                ${this._hasMotion?W`
              ...
              ${(null===(h=this._config)||void 0===h?void 0:h.disable_circle)?W`
                  ${this._renderTemperature(this._display_top,!0,"55","60%",!(null===(_=null==this?void 0:this._config)||void 0===_?void 0:_.set_current_as_main))}
                  ${this._renderTemperature(this._display_bottom,!1,"90","60%",1==(null===(p=null==this?void 0:this._config)||void 0===p?void 0:p.set_current_as_main))}
                ...
                `:W`
                  ...
                  <g class="current-info" transform="translate(62.5,80)">
                    ${this._renderTemperature(this._display_bottom,!1,"-5%","0%",1==(null===(v=null==this?void 0:this._config)||void 0===v?void 0:v.set_current_as_main))}
                  ${this._renderHVACAction()}
                </g>
              `}              
          </svg>
          </div>
          ${(null===(f=this._config)||void 0===f?void 0:f.disable_window)?B``:B`
          </vt-ha-control-circular-slider>`}
        </div>
      ...
      <div id="left-infos" class="${(null===(A=this._config)||void 0===A?void 0:A.disable_presets)?"no-presets":""}">
  ...
  `}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._handleKeyDown),this._clearRelockTimeout()}static async getConfigElement(){return await Promise.resolve().then((function(){return Es})),document.createElement("versatile-thermostat-ui-card-editor")}static async getStubConfig(e){const t=Object.keys(e.states).filter((e=>["climate"].includes(e.split(".")[0]))),i=t.filter((t=>{var i;return null===(i=e.states[t].attributes)||void 0===i?void 0:i.specific_states}));return{type:"custom:versatile-thermostat-ui-card",entity:i[0]||t[0]}}};As.styles=n`
      :host {
          display: block;
  ...
  `,e([he({attribute:!1})],As.prototype,"hass",void 0),e([he({type:Number})],As.prototype,"value",void 0),e([_e()],As.prototype,"_selectTargetTemperature",void 0),e([he({type:Number})],As.prototype,"current",void 0),e([he({type:Number})],As.prototype,"humidity",void 0),e([he({type:Number})],As.prototype,"temperature",void 0),e([he({type:Number})],As.prototype,"min",void 0),e([he({type:Number})],As.prototype,"max",void 0),e([he({type:Number})],As.prototype,"step",void 0),e([he({type:Number})],As.prototype,"powerPercent",void 0),e([he({type:Number})],As.prototype,"meanCyclePower",void 0),e([he({type:Number})],As.prototype,"valveOpenPercent",void 0),e([he({type:Number})],As.prototype,"devicePower",void 0),e([he({type:Number})],As.prototype,"regulatedTargetTemperature",void 0),e([he({type:Boolean})],As.prototype,"isOn",void 0),e([he({type:Boolean})],As.prototype,"window",void 0),e([he({type:Boolean})],As.prototype,"windowByPass",void 0),e([he({type:Boolean})],As.prototype,"presence",void 0),e([he({type:Boolean})],As.prototype,"motion",void 0),e([he({type:Boolean})],As.prototype,"overpowering",void 0),e([he({type:Boolean})],As.prototype,"isDeviceActive",void 0),e([he({type:Boolean})],As.prototype,"isSleeping",void 0),e([he({type:Boolean})],As.prototype,"isRegulated",void 0),e([he({type:Boolean})],As.prototype,"isRecalculateScheduled",void 0),e([he({type:String})],As.prototype,"windowState",void 0),e([he({type:String})],As.prototype,"windowAutoState",void 0),e([he({type:String})],As.prototype,"overpoweringState",void 0),e([he({type:String})],As.prototype,"presenceState",void 0),e([he({type:String})],As.prototype,"motionState",void 0),e([he({type:String})],As.prototype,"safetyState",void 0),e([he({type:String})],As.prototype,"status",void 0),e([he({type:String})],As.prototype,"hvacMode",void 0),e([he({type:String})],As.prototype,"hvacAction",void 0),e([he({type:String})],As.prototype,"preset",void 0),e([he({type:String})],As.prototype,"autoRegulationMode",void 0),e([he({type:String})],As.prototype,"currentAutoFanMode",void 0),e([he({type:String})],As.prototype,"autoFanMode",void 0),e([he({type:String})],As.prototype,"fanMode",void 0),e([he({type:String})],As.prototype,"hvacOffReason",void 0),e([he({type:Boolean,reflect:!0})],As.prototype,"dragging",void 0),e([he({type:String})],As.prototype,"name",void 0),e([_e()],As.prototype,"changingHigh",void 0),e([_e()],As.prototype,"_hasError",void 0),e([_e()],As.prototype,"_config",void 0),e([_e()],As.prototype,"isLocked",void 0),e([_e()],As.prototype,"isUserLocked",void 0),e([_e()],As.prototype,"isAutomationLocked",void 0),e([_e()],As.prototype,"showDigicodeModal",void 0),e([_e()],As.prototype,"enteredCode",void 0),e([_e()],As.prototype,"codeError",void 0),e([_e()],As.prototype,"isLocking",void 0),e([_e()],As.prototype,"timedPresetDuration",void 0),e([_e()],As.prototype,"timedPresetActive",void 0),e([_e()],As.prototype,"timedPresetRemainingTime",void 0),e([_e()],As.prototype,"timedPresetPreset",void 0),As=e([ce("versatile-thermostat-ui-card")],As);const Cs=function(...e){const t="type"===e[0].type,i=e.map((e=>e.schema)),o=Object.assign({},...i);return t?io(o):Qi(o)}(Qi({index:eo(Ji()),view_index:eo(Ji()),view_layout:Ki("any",(()=>!0)),type:to()}),Qi({entity:eo(to()),name:eo(to()),icon:eo(to()),autoStartStopEnableEntity:eo(to()),powerEntity:eo(to())}),Qi({disable_name:eo(Xi()),disable_circle:eo(Xi()),disable_background_color:eo(Xi()),disable_window:eo(Xi()),disable_autoStartStop:eo(Xi()),disable_overpowering:eo(Xi()),disable_heat:eo(Xi()),disable_cool:eo(Xi()),disable_heat_cool:eo(Xi()),disable_auto:eo(Xi()),disable_dry:eo(Xi()),disable_fan_only:eo(Xi()),disable_off:eo(Xi()),disable_sleep:eo(Xi()),disable_safety_warning:eo(Xi()),disable_power_infos:eo(Xi()),disable_auto_fan_infos:eo(Xi()),disable_target_icon:eo(Xi()),set_current_as_main:eo(Xi()),eco_temperature:eo(Ji()),disable_menu:eo(Xi()),disable_buttons:eo(Xi()),allow_lock_toggle:eo(Xi()),lock_relock_delay:eo(Ji()),disable_presets:eo(Xi()),disable_timed_preset:eo(Xi()),use_manual_duration_input:eo(Xi())})),xs=["icon_color","layout","fill_container","primary_info","secondary_info","icon_type","content_info","use_entity_picture","collapsible_controls","icon_animation"],Ss=e=>{var t,i;customElements.get("ha-form")&&(customElements.get("hui-action-editor")||((e,t,i,o)=>{const[a,s,n]=e.split(".",3);return Number(a)>t||Number(a)===t&&(void 0===o?Number(s)>=i:Number(s)>i)||void 0!==o&&Number(a)===t&&Number(s)===i&&Number(n)>=o})(e,2022,11))||null===(t=customElements.get("hui-button-card"))||void 0===t||t.getConfigElement(),customElements.get("ha-entity-picker")||null===(i=customElements.get("hui-entities-card"))||void 0===i||i.getConfigElement()},Ls=["autoStartStopEnableEntity","powerEntity","disable_name","disable_circle","disable_background_color","disable_window","disable_autoStartStop","disable_overpowering","disable_heat","disable_cool","disable_heat_cool","disable_auto","disable_dry","disable_fan_only","disable_off","disable_sleep","disable_menu","disable_safety_warning","disable_buttons","set_current_as_main","disable_power_infos","disable_auto_fan_infos","disable_target_icon","allow_lock_toggle","lock_relock_delay","disable_presets","disable_timed_preset","use_manual_duration_input"],Ts=zi((()=>[{name:"entity",selector:{entity:{domain:["climate"]}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"autoStartStopEnableEntity",selector:{entity:{domain:["switch"]}}},{name:"powerEntity",selector:{entity:{domain:["sensor","input_number"]}}}]},{type:"grid",name:"",schema:[{name:"disable_name",selector:{boolean:{}}},{name:"disable_circle",selector:{boolean:{}}},{name:"disable_background_color",selector:{boolean:{}}},{name:"disable_window",selector:{boolean:{}}},{name:"disable_autoStartStop",selector:{boolean:{}}},{name:"disable_overpowering",selector:{boolean:{}}},{name:"disable_heat",selector:{boolean:{}}},{name:"disable_cool",selector:{boolean:{}}},{name:"disable_heat_cool",selector:{boolean:{}}},{name:"disable_auto",selector:{boolean:{}}},{name:"disable_dry",selector:{boolean:{}}},{name:"disable_fan_only",selector:{boolean:{}}},{name:"disable_off",selector:{boolean:{}}},{name:"disable_sleep",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"disable_safety_warning",selector:{boolean:{}}},{name:"disable_buttons",selector:{boolean:{}}},{name:"set_current_as_main",selector:{boolean:{}}},{name:"disable_power_infos",selector:{boolean:{}}},{name:"disable_auto_fan_infos",selector:{boolean:{}}},{name:"disable_target_icon",selector:{boolean:{}}},{name:"allow_lock_toggle",selector:{boolean:{}}},{name:"lock_relock_delay",selector:{number:{min:0,max:3600,unit_of_measurement:"s",mode:"box"}}},{name:"disable_presets",selector:{boolean:{}}},{name:"disable_timed_preset",selector:{boolean:{}}},{name:"use_manual_duration_input",selector:{boolean:{}}}]}]));let Ms=class extends re{constructor(){super(...arguments),this._computeLabel=e=>{const t=(i=this.hass,function(e){var t;let o=Li(e,null!==(t=null==i?void 0:i.locale.language)&&void 0!==t?t:xi);return o||(o=Li(e,xi)),null!=o?o:e});var i;return xs.includes(e.name)?t(`editor.card.generic.${e.name}`):Ls.includes(e.name)?t(`editor.card.climate.${e.name}`):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${e.name}`)}}connectedCallback(){super.connectedCallback(),Ss(this.hass.connection.haVersion)}setConfig(e){Zi(e,Cs),this._config=e}render(){if(!this.hass||!this._config)return B``;const e=Ts();return B`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${e}
            ...
            ></ha-form>
        `}_valueChanged(e){Hi(this,"config-changed",{config:e.detail.value}),Hi(this,"hass",{config:e.detail.value})}};e([_e()],Ms.prototype,"_config",void 0),e([he({attribute:!1})],Ms.prototype,"hass",void 0),Ms=e([ce("versatile-thermostat-ui-card-editor")],Ms);var Es=Object.freeze({__proto__:null,get ClimateCardEditor(){return Ms}});export{As as VersatileThermostatUi,ws as registerCustomCard};
