...
const Yn=270;const Xn=new Set(["ArrowRight","ArrowUp","ArrowLeft","ArrowDown","PageUp","PageDown","Home","End"]);let Kn=class extends rt{constructor(){super(...arguments),this.disabled=!1,this.step=1,this.min=0,this.max=100,this._localValue=this.value,this._localLow=this.low,this._localHigh=this.high,this._getPercentageFromEvent=t=>{const e=this._slider.getBoundingClientRect(),i=2*(t.center.x-e.left-e.width/2)/e.width,o=2*(t.center.y-e.top-e.height/2)/e.height,[,n]=function(t,e){return[Math.sqrt(t*t+e*e),Math.atan2(e,t)]}(i,o),s=(n/(2*Math.PI)*360+45-135+360)%360-45;return Math.max(Math.min(s/Yn,1),0)}}_valueToPercentage(t){return(bi(t,this.min,this.max)-this.min)/(this.max-this.min)}_percentageToValue(t){return(this.max-this.min)*t+this.min}_steppedValue(t){return Math.round(t/this.step)*this.step}_boundedValue(t){var e,i;const o="high"===this._activeSlider?Math.min(null!==(e=this._localLow)&&void 0!==e?e:this.max):this.min,n="low"===this._activeSlider?Math.max(null!==(i=this._localHigh)&&void 0!==i?i:this.min):this.max;return Math.min(Math.max(t,o),n)}firstUpdated(t){super.firstUpdated(t),this._setupListeners()}updated(t){super.updated(t),this._activeSlider||(t.has("value")&&(this._localValue=this.value),t.has("low")&&(this._localLow=this.low),t.has("high")&&(this._localHigh=this.high))}connectedCallback(){super.connectedCallback(),this._setupListeners()}disconnectedCallback(){super.disconnectedCallback()}_findActiveSlider(t){var e,i;if(!this.dual)return"value";const o=Math.max(null!==(e=this._localLow)&&void 0!==e?e:this.min,this.min),n=Math.min(null!==(i=this._localHigh)&&void 0!==i?i:this.max,this.max);if(o>=t)return"low";if(n<=t)return"high";return Math.abs(t-o)<=Math.abs(t-n)?"low":"high"}_setActiveValue(t){switch(this._activeSlider){case"high":this._localHigh=t;break;case"low":this._localLow=t;break;case"value":this._localValue=t}}_getActiveValue(){switch(this._activeSlider){case"high":return this._localHigh;case"low":return this._localLow;case"value":return this._localValue}}_setupListeners(){this._interaction&&!this._mc&&(this._mc=new In(this._interaction,{inputClass:wn}),this._mc.add(new Vn({direction:Oo,enable:!0,threshold:0})),this._mc.add(new Ln({event:"singletap"})),this._mc.on("pan",(t=>{t.srcEvent.stopPropagation(),t.srcEvent.preventDefault()})),this._mc.on("panstart",(t=>{var e,i;if(this.disabled)return;const o=this._getPercentageFromEvent(t),n=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(n),this._lastSlider=this._activeSlider,null===(i=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("#slider"))||void 0===i||i.focus()})),this._mc.on("pancancel",(()=>{this.disabled||(this._activeSlider=void 0)})),this._mc.on("panmove",(t=>{if(this.disabled)return;const e=this._getPercentageFromEvent(t),i=this._percentageToValue(e),o=this._boundedValue(i);this._setActiveValue(o);const n=this._steppedValue(o);this._activeSlider&&gi(this,`${this._activeSlider}-changing`,{value:n})})),this._mc.on("panend",(t=>{if(this.disabled)return;const e=this._getPercentageFromEvent(t),i=this._percentageToValue(e),o=this._boundedValue(i),n=this._steppedValue(o);this._setActiveValue(n),this._activeSlider&&(gi(this,`${this._activeSlider}-changing`,{value:void 0}),gi(this,`${this._activeSlider}-changed`,{value:n})),this._activeSlider=void 0})),this._mc.on("singletap",(t=>{var e,i;if(this.disabled)return;const o=this._getPercentageFromEvent(t),n=this._percentageToValue(o);this._activeSlider=this._findActiveSlider(n);const s=this._boundedValue(n),a=this._steppedValue(s);this._setActiveValue(a),this._activeSlider&&(gi(this,`${this._activeSlider}-changing`,{value:void 0}),gi(this,`${this._activeSlider}-changed`,{value:a})),this._lastSlider=this._activeSlider,null===(i=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById("#slider"))||void 0===i||i.focus(),this._activeSlider=void 0})))}get _tenPercentStep(){return Math.max(this.step,(this.max-this.min)/10)}_handleKeyDown(t){var e,i,o;if(!Xn.has(t.code))return;t.preventDefault(),this._lastSlider&&(null===(i=null===(e=this.shadowRoot)||void 0===e?void 0:e.getElementById(this._lastSlider))||void 0===i||i.focus()),this._activeSlider=null!==(o=this._lastSlider)&&void 0!==o?o:t.currentTarget.id,this._lastSlider=void 0;const n=this._getActiveValue();switch(t.code){case"ArrowRight":case"ArrowUp":this._setActiveValue(this._boundedValue((null!=n?n:this.min)+this.step));break;case"ArrowLeft":case"ArrowDown":this._setActiveValue(this._boundedValue((null!=n?n:this.min)-this.step));break;case"PageUp":this._setActiveValue(this._steppedValue(this._boundedValue((null!=n?n:this.min)+this._tenPercentStep)));break;case"PageDown":this._setActiveValue(this._steppedValue(this._boundedValue((null!=n?n:this.min)-this._tenPercentStep)));break;case"Home":this._setActiveValue(this._boundedValue(this.min));break;case"End":this._setActiveValue(this._boundedValue(this.max))}gi(this,`${this._activeSlider}-changing`,{value:this._getActiveValue()}),this._activeSlider=void 0}_handleKeyUp(t){Xn.has(t.code)&&(this._activeSlider=t.currentTarget.id,t.preventDefault(),gi(this,`${this._activeSlider}-changing`,{value:void 0}),gi(this,`${this._activeSlider}-changed`,{value:this._getActiveValue()}),this._activeSlider=void 0)}destroyListeners(){this._mc&&(this._mc.destroy(),this._mc=void 0)}_strokeCircleDashArc(t){return this._strokeDashArc(t,t)}_strokeDashArc(t,e){const i=this._valueToPercentage(t),o=this._valueToPercentage(e),n=290*Math.PI*Yn/360,s=Math.max((o-i)*n,0);return[`${s} ${n-s}`,`-${i*n-.5}`]}renderArc(t,e,i){var o,n;if(this.disabled)return W;const s=Gi({x:0,y:0,start:0,end:Yn,r:145}),a="end"===i?this.max:this.min,r=null!==(o=this.current)&&void 0!==o?o:a,l=null!=e?e:a,c="end"===i?l<=r:"start"===i&&r<=l,h=c?"end"===i?this._strokeDashArc(l,r):this._strokeDashArc(r,l):this._strokeCircleDashArc(l),u="full"===i?this._strokeDashArc(this.min,this.max):"end"===i?this._strokeDashArc(l,a):this._strokeDashArc(a,l),d=this._strokeCircleDashArc(l),p=null!=this.current&&this.current<=this.max&&this.current>=this.min&&(c||"full"===this.mode)?this._strokeCircleDashArc(this.current):void 0;return U`
      ...
      `}render(){const t=Gi({x:0,y:0,start:0,end:Yn,r:145}),e=this.dual?this._localLow:this._localValue,i=this._localHigh,o=this.current,n=o?this._strokeCircleDashArc(o):void 0;return B`
        <svg
          id="slider"
          viewBox="0 0 320 320"
          overflow="visible"
    ...
    `}_renderPowerInfo(t){const e=this.hass.localize(`component.climate.state._.${t.name}`)||hi({hass:this.hass,string:`extra_states.${t.name}`});return B`
    ...
    `}_renderAutoStartStopEnable(){const t=hi({hass:this.hass,string:"extra_states.auto_start_stop_enable"}),e=hi({hass:this.hass,string:"extra_states.auto_start_stop_label"}),i=this._isAutoStartStopEnabled?"checked":"";return console.log(`checked=${i}`),B`
    ...
    ${(null===(t=this._config)||void 0===t?void 0:t.disable_menu)?"":B`
      ...
      ${(null===(e=this.safety_state)||void 0===e?void 0:e.length)>0?B`
        <div class="security">
          <ha-icon-button class="alert" .path=${xt}>
          </ha-icon-button>
          ${B`
        ...
        ${(null===(o=this._config)||void 0===o?void 0:o.disable_circle)?B`
          ...
          `:null!=this.value.low&&null!=this.value.high&&"unavailable"!==this.stateObj.state?B`
            <vt-ha-control-circular-slider
              class="${null!==this.safety_state||this.error.length>0?"security_msg":""} ${this.window?"window_open":""}  ${this.overpowering?"overpowering":""} ${this.presence?"presence":""} ${this.motion?"motion":""}  ${this.windowByPass?"windowByPass":""} "
            ...
            >
            `}
          <div class="content ${0==this.name.length?"noname":""} ${null!==this.safety_state||this.error.length>0?"security_msg":""} ${this.window?"window_open":""}  ${this.overpowering?"overpowering":""} ${this.presence?"presence":""} ${this.motion?"motion":""}  ${this.windowByPass?"windowByPass":""} " >
            <svg id="main" viewbox="0 0 125 100">
              <g transform="translate(57.5,37) scale(0.35)">
                ...
                ${this._hasWindowByPass||!this._hasWindow||(null===(n=this._config)||void 0===n?void 0:n.disable_window)?"":U`
                  <path class="window ${this.window?"active":""}" fill="none" transform="${this._hasWindow&&!(null===(s=this._config)||void 0===s?void 0:s.disable_window)?"translate(-50.25,0)":""}" id="window" d=${Lt} />
                `}
                ...
                ${this._hasAutoStartStop&&!(null===(l=this._config)||void 0===l?void 0:l.disable_autoStartStop)?U`
                  <path class="auto-start-stop" fill="none" transform="${this._hasAutoStartStop&&!(null===(c=this._config)||void 0===c?void 0:c.disable_autoStartStop)?"translate(25.25,0)":""}" id="autoStartStop" d=${St}/>
                `:""}
                ${this._hasMotion?U`
  ...
  `}}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback()}static async getConfigElement(){return await Promise.resolve().then((function(){return ms})),document.createElement("versatile-thermostat-ui-card-editor")}static async getStubConfig(t){const e=Object.keys(t.states).filter((t=>["climate"].includes(t.split(".")[0]))),i=e.filter((e=>{var i;return null===(i=t.states[e].attributes)||void 0===i?void 0:i.specific_states}));return{type:"custom:versatile-thermostat-ui-card",entity:i[0]||e[0]}}};ls.styles=a`
      :host {
          display: block;
  ...
  `,t([dt({attribute:!1})],ls.prototype,"hass",void 0),t([dt({type:Number})],ls.prototype,"value",void 0),t([pt()],ls.prototype,"_selectTargetTemperature",void 0),t([dt({type:Number})],ls.prototype,"current",void 0),t([dt({type:Number})],ls.prototype,"humidity",void 0),t([dt({type:Number})],ls.prototype,"temperature",void 0),t([dt({type:Number})],ls.prototype,"min",void 0),t([dt({type:Number})],ls.prototype,"max",void 0),t([dt({type:Number})],ls.prototype,"step",void 0),t([dt({type:Number})],ls.prototype,"powerPercent",void 0),t([dt({type:Number})],ls.prototype,"meanCyclePower",void 0),t([dt({type:Number})],ls.prototype,"valveOpenPercent",void 0),t([dt({type:Number})],ls.prototype,"devicePower",void 0),t([dt({type:Number})],ls.prototype,"regulatedTargetTemperature",void 0),t([dt({type:Boolean})],ls.prototype,"isOn",void 0),t([dt({type:Boolean})],ls.prototype,"window",void 0),t([dt({type:Boolean})],ls.prototype,"windowByPass",void 0),t([dt({type:Boolean})],ls.prototype,"presence",void 0),t([dt({type:Boolean})],ls.prototype,"motion",void 0),t([dt({type:Boolean})],ls.prototype,"overpowering",void 0),t([dt({type:Boolean})],ls.prototype,"isDeviceActive",void 0),t([dt({type:Boolean})],ls.prototype,"isSleeping",void 0),t([dt({type:Boolean})],ls.prototype,"isRegulated",void 0),t([dt({type:String})],ls.prototype,"windowState",void 0),t([dt({type:String})],ls.prototype,"windowAutoState",void 0),t([dt({type:String})],ls.prototype,"overpoweringState",void 0),t([dt({type:String})],ls.prototype,"presenceState",void 0),t([dt({type:String})],ls.prototype,"motionState",void 0),t([dt({type:String})],ls.prototype,"isWindowByPass",void 0),t([dt({type:String})],ls.prototype,"safetyState",void 0),t([dt({type:String})],ls.prototype,"status",void 0),t([dt({type:String})],ls.prototype,"hvacMode",void 0),t([dt({type:String})],ls.prototype,"hvacAction",void 0),t([dt({type:String})],ls.prototype,"preset",void 0),t([dt({type:String})],ls.prototype,"autoRegulationMode",void 0),t([dt({type:String})],ls.prototype,"currentAutoFanMode",void 0),t([dt({type:String})],ls.prototype,"autoFanMode",void 0),t([dt({type:String})],ls.prototype,"fanMode",void 0),t([dt({type:String})],ls.prototype,"hvacOffReason",void 0),t([dt({type:Boolean,reflect:!0})],ls.prototype,"dragging",void 0),t([dt({type:String})],ls.prototype,"name",void 0),t([pt()],ls.prototype,"changingHigh",void 0),t([pt()],ls.prototype,"_config",void 0),ls=t([ct("versatile-thermostat-ui-card")],ls);const cs=function(...t){const e="type"===t[0].type,i=t.map((t=>t.schema)),o=Object.assign({},...i);return e?Ii(o):Oi(o)}(Oi({index:zi(Di()),view_index:zi(Di()),view_layout:Vi("any",(()=>!0)),type:Ni()}),Oi({entity:zi(Ni()),name:zi(Ni()),icon:zi(Ni()),autoStartStopEnableEntity:zi(Ni()),powerEntity:zi(Ni())}),Oi({disable_name:zi(Hi()),disable_circle:zi(Hi()),disable_window:zi(Hi()),disable_autoStartStop:zi(Hi()),disable_overpowering:zi(Hi()),disable_heat:zi(Hi()),disable_cool:zi(Hi()),disable_heat_cool:zi(Hi()),disable_auto:zi(Hi()),disable_dry:zi(Hi()),disable_fan_only:zi(Hi()),disable_off:zi(Hi()),disable_sleep:zi(Hi()),disable_safety_warning:zi(Hi()),disable_power_infos:zi(Hi()),disable_auto_fan_infos:zi(Hi()),disable_target_icon:zi(Hi()),set_current_as_main:zi(Hi()),eco_temperature:zi(Di()),disable_menu:zi(Hi()),disable_buttons:zi(Hi())})),hs=["icon_color","layout","fill_container","primary_info","secondary_info","icon_type","content_info","use_entity_picture","collapsible_controls","icon_animation"],us=t=>{var e,i;customElements.get("ha-form")&&(customElements.get("hui-action-editor")||((t,e,i,o)=>{const[n,s,a]=t.split(".",3);return Number(n)>e||Number(n)===e&&(void 0===o?Number(s)>=i:Number(s)>i)||void 0!==o&&Number(n)===e&&Number(s)===i&&Number(a)>=o})(t,2022,11))||null===(e=customElements.get("hui-button-card"))||void 0===e||e.getConfigElement(),customElements.get("ha-entity-picker")||null===(i=customElements.get("hui-entities-card"))||void 0===i||i.getConfigElement()},ds=["autoStartStopEnableEntity","powerEntity","disable_name","disable_circle","disable_window","disable_autoStartStop","disable_overpowering","disable_heat","disable_cool","disable_heat_cool","disable_auto","disable_dry","disable_fan_only","disable_off","disable_sleep","disable_menu","disable_safety_warning","disable_buttons","set_current_as_main","disable_power_infos","disable_auto_fan_infos","disable_target_icon"],ps=vi((()=>[{name:"entity",selector:{entity:{domain:["climate"]}}},{name:"name",selector:{text:{}}},{type:"grid",name:"",schema:[{name:"autoStartStopEnableEntity",selector:{entity:{domain:["switch"]}}},{name:"powerEntity",selector:{entity:{domain:["sensor","input_number"]}}}]},{type:"grid",name:"",schema:[{name:"disable_name",selector:{boolean:{}}},{name:"disable_circle",selector:{boolean:{}}},{name:"disable_window",selector:{boolean:{}}},{name:"disable_autoStartStop",selector:{boolean:{}}},{name:"disable_overpowering",selector:{boolean:{}}},{name:"disable_heat",selector:{boolean:{}}},{name:"disable_cool",selector:{boolean:{}}},{name:"disable_heat_cool",selector:{boolean:{}}},{name:"disable_auto",selector:{boolean:{}}},{name:"disable_dry",selector:{boolean:{}}},{name:"disable_fan_only",selector:{boolean:{}}},{name:"disable_off",selector:{boolean:{}}},{name:"disable_sleep",selector:{boolean:{}}},{name:"disable_menu",selector:{boolean:{}}},{name:"disable_safety_warning",selector:{boolean:{}}},{name:"disable_buttons",selector:{boolean:{}}},{name:"set_current_as_main",selector:{boolean:{}}},{name:"disable_power_infos",selector:{Boolean:{}}},{name:"disable_auto_fan_infos",selector:{Boolean:{}}},{name:"disable_target_icon",selector:{Boolean:{}}}]}]));let _s=class extends rt{constructor(){super(...arguments),this._computeLabel=t=>{const e=(i=this.hass,function(t){var e;let o=ui(t,null!==(e=null==i?void 0:i.locale.language)&&void 0!==e?e:ci);return o||(o=ui(t,ci)),null!=o?o:t});var i;return hs.includes(t.name)?e(`editor.card.generic.${t.name}`):ds.includes(t.name)?e(`editor.card.climate.${t.name}`):this.hass.localize(`ui.panel.lovelace.editor.card.generic.${t.name}`)}}connectedCallback(){super.connectedCallback(),us(this.hass.connection.haVersion)}setConfig(t){Ei(t,cs),this._config=t}render(){if(!this.hass||!this._config)return B``;const t=ps();return B`
            <ha-form
                .hass=${this.hass}
                .data=${this._config}
                .schema=${t}
            ...
            ></ha-form>
        `}_valueChanged(t){gi(this,"config-changed",{config:t.detail.value}),gi(this,"hass",{config:t.detail.value})}};t([pt()],_s.prototype,"_config",void 0),t([dt({attribute:!1})],_s.prototype,"hass",void 0),_s=t([ct("versatile-thermostat-ui-card-editor")],_s);var ms=Object.freeze({__proto__:null,get ClimateCardEditor(){return _s}});export{ls as VersatileThermostatUi,ss as registerCustomCard};
